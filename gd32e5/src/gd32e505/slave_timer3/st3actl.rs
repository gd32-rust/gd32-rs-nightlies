...
pub type R = crate::R<ST3ACTL_SPEC>;
#[doc = "Register `ST3ACTL` writer"]
pub type W = crate::W<ST3ACTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntckdiv_3(&mut self) -> CNTCKDIV_3_W<ST3ACTL_SPEC, 3> {
        CNTCKDIV_3_W::new(self)
    }
    #[doc = "Bits 9:15 - Rising edge dead-time value configure"]
    #[inline(always)]
    #[must_use]
    pub fn dtrcfg_15_9(&mut self) -> DTRCFG_15_9_W<ST3ACTL_SPEC, 9> {
        DTRCFG_15_9_W::new(self)
    }
    #[doc = "Bits 25:31 - Falling edge dead-time value configure"]
    #[inline(always)]
    #[must_use]
    pub fn dtfcfg_15_9(&mut self) -> DTFCFG_15_9_W<ST3ACTL_SPEC, 25> {
...
#[doc = "SHRTIMER Slave_TIMERx additional control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st3actl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st3actl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST3ACTL_SPEC;
impl crate::RegisterSpec for ST3ACTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3actl::R`](R) reader structure"]
impl crate::Readable for ST3ACTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3actl::W`](W) writer structure"]
impl crate::Writable for ST3ACTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3ACTL to value 0"]
impl crate::Resettable for ST3ACTL_SPEC {
