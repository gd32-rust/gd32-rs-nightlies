...
pub type R = crate::R<ST3CMP1V_SPEC>;
#[doc = "Register `ST3CMP1V` writer"]
pub type W = crate::W<ST3CMP1V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1val(&mut self) -> CMP1VAL_W<ST3CMP1V_SPEC, 0> {
        CMP1VAL_W::new(self)
    }
...
pub struct ST3CMP1V_SPEC;
impl crate::RegisterSpec for ST3CMP1V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3cmp1v::R`](R) reader structure"]
impl crate::Readable for ST3CMP1V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3cmp1v::W`](W) writer structure"]
impl crate::Writable for ST3CMP1V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3CMP1V to value 0"]
impl crate::Resettable for ST3CMP1V_SPEC {
