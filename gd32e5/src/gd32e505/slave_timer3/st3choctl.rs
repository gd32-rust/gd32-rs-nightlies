...
pub type R = crate::R<ST3CHOCTL_SPEC>;
#[doc = "Register `ST3CHOCTL` writer"]
pub type W = crate::W<ST3CHOCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0p(&mut self) -> CH0P_W<ST3CHOCTL_SPEC, 1> {
        CH0P_W::new(self)
    }
    #[doc = "Bit 2 - Channel 0 IDLE state enable in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch0ien(&mut self) -> BMCH0IEN_W<ST3CHOCTL_SPEC, 2> {
        BMCH0IEN_W::new(self)
    }
    #[doc = "Bit 3 - Channel 0 output idle state"]
    #[inline(always)]
    #[must_use]
    pub fn iso0(&mut self) -> ISO0_W<ST3CHOCTL_SPEC, 3> {
        ISO0_W::new(self)
    }
    #[doc = "Bits 4:5 - Channel 0 Fault output state"]
    #[inline(always)]
    #[must_use]
    pub fn ch0fltos(&mut self) -> CH0FLTOS_W<ST3CHOCTL_SPEC, 4> {
        CH0FLTOS_W::new(self)
    }
    #[doc = "Bit 6 - Channel 0 carrier-signal mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0csen(&mut self) -> CH0CSEN_W<ST3CHOCTL_SPEC, 6> {
        CH0CSEN_W::new(self)
    }
    #[doc = "Bit 7 - Channel 0 dead-time insert in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch0dti(&mut self) -> BMCH0DTI_W<ST3CHOCTL_SPEC, 7> {
        BMCH0DTI_W::new(self)
    }
    #[doc = "Bit 8 - Dead time enable"]
    #[inline(always)]
    #[must_use]
    pub fn dten(&mut self) -> DTEN_W<ST3CHOCTL_SPEC, 8> {
        DTEN_W::new(self)
    }
    #[doc = "Bit 9 - Delayed IDLE state mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyismen(&mut self) -> DLYISMEN_W<ST3CHOCTL_SPEC, 9> {
        DLYISMEN_W::new(self)
    }
    #[doc = "Bits 10:12 - Delayed IDLE source and channel"]
    #[inline(always)]
    #[must_use]
    pub fn dlyisch(&mut self) -> DLYISCH_W<ST3CHOCTL_SPEC, 10> {
        DLYISCH_W::new(self)
    }
    #[doc = "Bit 17 - Channel 1 output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ch1p(&mut self) -> CH1P_W<ST3CHOCTL_SPEC, 17> {
        CH1P_W::new(self)
    }
    #[doc = "Bit 18 - Channel 1 IDLE state enable in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch1ien(&mut self) -> BMCH1IEN_W<ST3CHOCTL_SPEC, 18> {
        BMCH1IEN_W::new(self)
    }
    #[doc = "Bit 19 - channel 1 output idle state"]
    #[inline(always)]
    #[must_use]
    pub fn iso1(&mut self) -> ISO1_W<ST3CHOCTL_SPEC, 19> {
        ISO1_W::new(self)
    }
    #[doc = "Bits 20:21 - Channel 1 Fault output state"]
    #[inline(always)]
    #[must_use]
    pub fn ch1fltos(&mut self) -> CH1FLTOS_W<ST3CHOCTL_SPEC, 20> {
        CH1FLTOS_W::new(self)
    }
    #[doc = "Bit 22 - Channel 1 carrier-signal mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1csen(&mut self) -> CH1CSEN_W<ST3CHOCTL_SPEC, 22> {
        CH1CSEN_W::new(self)
    }
    #[doc = "Bit 23 - Channel 1 dead-time insert in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch1dti(&mut self) -> BMCH1DTI_W<ST3CHOCTL_SPEC, 23> {
        BMCH1DTI_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMERx channel output control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st3choctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st3choctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST3CHOCTL_SPEC;
impl crate::RegisterSpec for ST3CHOCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3choctl::R`](R) reader structure"]
impl crate::Readable for ST3CHOCTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3choctl::W`](W) writer structure"]
impl crate::Writable for ST3CHOCTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3CHOCTL to value 0"]
impl crate::Resettable for ST3CHOCTL_SPEC {
