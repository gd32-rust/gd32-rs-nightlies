...
impl R {
    ...
    pub fn scgen(&self) -> SCGEN_R {
        SCGEN_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - PHY is in shallow sleep status"]
    #[inline(always)]
    pub fn ssleep(&self) -> SSLEEP_R {
        SSLEEP_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - PHY is in deep sleep status"]
    #[inline(always)]
    pub fn dsleep(&self) -> DSLEEP_R {
        DSLEEP_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Stop the USB clock"]
