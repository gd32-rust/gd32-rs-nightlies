...
pub type R = crate::R<ST1FLTCTL_SPEC>;
#[doc = "Register `ST1FLTCTL` writer"]
pub type W = crate::W<ST1FLTCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flt0en(&mut self) -> FLT0EN_W<ST1FLTCTL_SPEC, 0> {
        FLT0EN_W::new(self)
    }
    #[doc = "Bit 1 - Fault 1 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt1en(&mut self) -> FLT1EN_W<ST1FLTCTL_SPEC, 1> {
        FLT1EN_W::new(self)
    }
    #[doc = "Bit 2 - Fault 2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt2en(&mut self) -> FLT2EN_W<ST1FLTCTL_SPEC, 2> {
        FLT2EN_W::new(self)
    }
    #[doc = "Bit 3 - Fault 3 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt3en(&mut self) -> FLT3EN_W<ST1FLTCTL_SPEC, 3> {
        FLT3EN_W::new(self)
    }
    #[doc = "Bit 4 - Fault 4 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt4en(&mut self) -> FLT4EN_W<ST1FLTCTL_SPEC, 4> {
        FLT4EN_W::new(self)
    }
    #[doc = "Bit 31 - Protect fault enable"]
    #[inline(always)]
    #[must_use]
    pub fn fltenprot(&mut self) -> FLTENPROT_W<ST1FLTCTL_SPEC, 31> {
...
pub struct ST1FLTCTL_SPEC;
impl crate::RegisterSpec for ST1FLTCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1fltctl::R`](R) reader structure"]
impl crate::Readable for ST1FLTCTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st1fltctl::W`](W) writer structure"]
impl crate::Writable for ST1FLTCTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST1FLTCTL to value 0"]
impl crate::Resettable for ST1FLTCTL_SPEC {
