...
pub type R = crate::R<ST1CAR_SPEC>;
#[doc = "Register `ST1CAR` writer"]
pub type W = crate::W<ST1CAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn carl(&mut self) -> CARL_W<ST1CAR_SPEC, 0> {
        CARL_W::new(self)
    }
...
pub struct ST1CAR_SPEC;
impl crate::RegisterSpec for ST1CAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1car::R`](R) reader structure"]
impl crate::Readable for ST1CAR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st1car::W`](W) writer structure"]
impl crate::Writable for ST1CAR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST1CAR to value 0"]
impl crate::Resettable for ST1CAR_SPEC {
