...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bsw(&mut self) -> Cp1bswW<St1cap1trgSpec> {
        Cp1bswW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture 1 triggered by update event"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bup(&mut self) -> Cp1bupW<St1cap1trgSpec> {
        Cp1bupW::new(self, 1)
    }
    #[doc = "Bit 2 - Capture 1 triggered by external event 0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev0(&mut self) -> Cp1bexev0W<St1cap1trgSpec> {
        Cp1bexev0W::new(self, 2)
    }
    #[doc = "Bit 3 - Capture 1 triggered by external event 1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev1(&mut self) -> Cp1bexev1W<St1cap1trgSpec> {
        Cp1bexev1W::new(self, 3)
    }
    #[doc = "Bit 4 - Capture 1 triggered by external event 2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev2(&mut self) -> Cp1bexev2W<St1cap1trgSpec> {
        Cp1bexev2W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture 1 triggered by external event 3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev3(&mut self) -> Cp1bexev3W<St1cap1trgSpec> {
        Cp1bexev3W::new(self, 5)
    }
    #[doc = "Bit 6 - Capture 1 triggered by external event 4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev4(&mut self) -> Cp1bexev4W<St1cap1trgSpec> {
        Cp1bexev4W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture 1 triggered by external event 5"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev5(&mut self) -> Cp1bexev5W<St1cap1trgSpec> {
        Cp1bexev5W::new(self, 7)
    }
    #[doc = "Bit 8 - Capture 1 triggered by external event 6"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev6(&mut self) -> Cp1bexev6W<St1cap1trgSpec> {
        Cp1bexev6W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture 1 triggered by external event 7"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev7(&mut self) -> Cp1bexev7W<St1cap1trgSpec> {
        Cp1bexev7W::new(self, 9)
    }
    #[doc = "Bit 10 - Capture 1 triggered by external event 8"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev8(&mut self) -> Cp1bexev8W<St1cap1trgSpec> {
        Cp1bexev8W::new(self, 10)
    }
    #[doc = "Bit 11 - Capture 1 triggered by external event 9"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev9(&mut self) -> Cp1bexev9W<St1cap1trgSpec> {
        Cp1bexev9W::new(self, 11)
    }
    #[doc = "Bit 12 - Capture 1 triggered by ST0CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0a(&mut self) -> Cp1bst0aW<St1cap1trgSpec> {
        Cp1bst0aW::new(self, 12)
    }
    #[doc = "Bit 13 - Capture 1 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0na(&mut self) -> Cp1bst0naW<St1cap1trgSpec> {
        Cp1bst0naW::new(self, 13)
    }
    #[doc = "Bit 14 - Capture 1 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp0(&mut self) -> Cp1bst0cmp0W<St1cap1trgSpec> {
        Cp1bst0cmp0W::new(self, 14)
    }
    #[doc = "Bit 15 - Capture 1 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp1(&mut self) -> Cp1bst0cmp1W<St1cap1trgSpec> {
        Cp1bst0cmp1W::new(self, 15)
    }
    #[doc = "Bit 20 - Capture 1 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2a(&mut self) -> Cp1bst2aW<St1cap1trgSpec> {
        Cp1bst2aW::new(self, 20)
    }
    #[doc = "Bit 21 - Capture 1 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2na(&mut self) -> Cp1bst2naW<St1cap1trgSpec> {
        Cp1bst2naW::new(self, 21)
    }
    #[doc = "Bit 22 - Capture 1 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp0(&mut self) -> Cp1bst2cmp0W<St1cap1trgSpec> {
        Cp1bst2cmp0W::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 1 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp1(&mut self) -> Cp1bst2cmp1W<St1cap1trgSpec> {
        Cp1bst2cmp1W::new(self, 23)
    }
    #[doc = "Bit 24 - Capture 1 triggered by ST3CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3a(&mut self) -> Cp1bst3aW<St1cap1trgSpec> {
        Cp1bst3aW::new(self, 24)
    }
    #[doc = "Bit 25 - Capture 1 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3na(&mut self) -> Cp1bst3naW<St1cap1trgSpec> {
        Cp1bst3naW::new(self, 25)
    }
    #[doc = "Bit 26 - Capture 1 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3cmp0(&mut self) -> Cp1bst3cmp0W<St1cap1trgSpec> {
        Cp1bst3cmp0W::new(self, 26)
    }
    #[doc = "Bit 27 - Capture 1 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3cmp1(&mut self) -> Cp1bst3cmp1W<St1cap1trgSpec> {
        Cp1bst3cmp1W::new(self, 27)
    }
    #[doc = "Bit 28 - Capture 1 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4a(&mut self) -> Cp1bst4aW<St1cap1trgSpec> {
        Cp1bst4aW::new(self, 28)
    }
    #[doc = "Bit 29 - Capture 1 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4na(&mut self) -> Cp1bst4naW<St1cap1trgSpec> {
        Cp1bst4naW::new(self, 29)
    }
    #[doc = "Bit 30 - Capture 1 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp0(&mut self) -> Cp1bst4cmp0W<St1cap1trgSpec> {
        Cp1bst4cmp0W::new(self, 30)
    }
    #[doc = "Bit 31 - Capture 1 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp1(&mut self) -> Cp1bst4cmp1W<St1cap1trgSpec> {
