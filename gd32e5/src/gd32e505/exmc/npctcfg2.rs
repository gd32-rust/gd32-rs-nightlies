...
pub type R = crate::R<NPCTCFG2_SPEC>;
#[doc = "Register `NPCTCFG2` writer"]
pub type W = crate::W<NPCTCFG2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn comset(&mut self) -> COMSET_W<NPCTCFG2_SPEC, 0> {
        COMSET_W::new(self)
    }
    #[doc = "Bits 8:15 - Common memory wait time"]
    #[inline(always)]
    #[must_use]
    pub fn comwait(&mut self) -> COMWAIT_W<NPCTCFG2_SPEC, 8> {
        COMWAIT_W::new(self)
    }
    #[doc = "Bits 16:23 - Common memory hold time"]
    #[inline(always)]
    #[must_use]
    pub fn comhld(&mut self) -> COMHLD_W<NPCTCFG2_SPEC, 16> {
        COMHLD_W::new(self)
    }
    #[doc = "Bits 24:31 - Common memory data bus HiZ time"]
    #[inline(always)]
    #[must_use]
    pub fn comhiz(&mut self) -> COMHIZ_W<NPCTCFG2_SPEC, 24> {
        COMHIZ_W::new(self)
    }
