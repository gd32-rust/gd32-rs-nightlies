...
pub use super::chctl0_output::CH0COMCEN_A;
...
pub use super::chctl0_output::CH0COMCEN_W as CH2COMCEN_W;
#[doc = "Field `CH3COMCEN` writer - Channel 3 output compare clear enable"]
pub use super::chctl0_output::CH0COMCEN_W as CH3COMCEN_W;
#[doc = "Channel 2 compare output control"]
pub use super::chctl0_output::CH0COMCTL_A;
...
pub use super::chctl0_output::CH0COMCTL_W as CH2COMCTL_W;
#[doc = "Field `CH3COMCTL` writer - Channel 3 compare output control"]
pub use super::chctl0_output::CH0COMCTL_W as CH3COMCTL_W;
#[doc = "Channel 2 output compare fast enable"]
pub use super::chctl0_output::CH0COMFEN_A;
...
pub use super::chctl0_output::CH0COMFEN_W as CH2COMFEN_W;
#[doc = "Field `CH3COMFEN` writer - Channel 3 output compare fast enable"]
pub use super::chctl0_output::CH0COMFEN_W as CH3COMFEN_W;
#[doc = "Channel 2 compare output shadow enable"]
pub use super::chctl0_output::CH0COMSEN_A;
...
pub use super::chctl0_output::CH0COMSEN_W as CH2COMSEN_W;
#[doc = "Field `CH3COMSEN` writer - Channel 3 output compare shadow enable"]
pub use super::chctl0_output::CH0COMSEN_W as CH3COMSEN_W;
#[doc = "Channel 2 I/O mode selection"]
pub use super::chctl0_output::CH0MS_A;
...
pub use super::chctl0_output::CH0MS_W as CH2MS_W;
#[doc = "Field `CH3MS` writer - Channel 3 mode selection"]
pub use super::chctl0_output::CH0MS_W as CH3MS_W;
impl R {
