...
pub type R = crate::R<DIEP5TFLEN_SPEC>;
#[doc = "Register `DIEP5TFLEN` writer"]
pub type W = crate::W<DIEP5TFLEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ieptxrsar(&mut self) -> IEPTXRSAR_W<DIEP5TFLEN_SPEC, 0> {
        IEPTXRSAR_W::new(self)
    }
    #[doc = "Bits 16:31 - IN endpoint TxFIFO depth"]
    #[inline(always)]
    #[must_use]
    pub fn ieptxfd(&mut self) -> IEPTXFD_W<DIEP5TFLEN_SPEC, 16> {
        IEPTXFD_W::new(self)
    }
...
pub struct DIEP5TFLEN_SPEC;
impl crate::RegisterSpec for DIEP5TFLEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep5tflen::R`](R) reader structure"]
impl crate::Readable for DIEP5TFLEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep5tflen::W`](W) writer structure"]
impl crate::Writable for DIEP5TFLEN_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP5TFLEN to value 0x0200_0400"]
impl crate::Resettable for DIEP5TFLEN_SPEC {
