...
pub type LPMIE_R = crate::BitReader;
#[doc = "Field `LPMIE` writer - LPM interrupt enable"]
pub type LPMIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn lpmie(&self) -> LPMIE_R {
        LPMIE_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpmie(&mut self) -> LPMIE_W<GINTEN_SPEC, 27> {
        LPMIE_W::new(self)
    }
    #[doc = "Bit 28 - ID pin status change interrupt enable"]
    #[inline(always)]
