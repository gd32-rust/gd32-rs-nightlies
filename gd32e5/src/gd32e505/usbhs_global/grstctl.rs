...
pub type DMABSY_R = crate::BitReader;
#[doc = "Field `DMAIDL` reader - DMA Idle state"]
pub type DMAIDL_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 30 - DMA Busy"]
    #[inline(always)]
    pub fn dmabsy(&self) -> DMABSY_R {
        DMABSY_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - DMA Idle state"]
    #[inline(always)]
    pub fn dmaidl(&self) -> DMAIDL_R {
        DMAIDL_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Core soft reset"]
