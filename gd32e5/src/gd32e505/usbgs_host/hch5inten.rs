...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfie(&mut self) -> TFIE_W<HCH5INTEN_SPEC, 0> {
        TFIE_W::new(self)
    }
    #[doc = "Bit 1 - Channel halted interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn chie(&mut self) -> CHIE_W<HCH5INTEN_SPEC, 1> {
        CHIE_W::new(self)
    }
    #[doc = "Bit 3 - STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn stallie(&mut self) -> STALLIE_W<HCH5INTEN_SPEC, 3> {
        STALLIE_W::new(self)
    }
    #[doc = "Bit 4 - NAK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn nakie(&mut self) -> NAKIE_W<HCH5INTEN_SPEC, 4> {
        NAKIE_W::new(self)
    }
    #[doc = "Bit 5 - ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ackie(&mut self) -> ACKIE_W<HCH5INTEN_SPEC, 5> {
        ACKIE_W::new(self)
    }
    #[doc = "Bit 7 - USB bus error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn usberie(&mut self) -> USBERIE_W<HCH5INTEN_SPEC, 7> {
        USBERIE_W::new(self)
    }
    #[doc = "Bit 8 - Babble error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn bberie(&mut self) -> BBERIE_W<HCH5INTEN_SPEC, 8> {
        BBERIE_W::new(self)
    }
    #[doc = "Bit 9 - request queue overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reqovrie(&mut self) -> REQOVRIE_W<HCH5INTEN_SPEC, 9> {
        REQOVRIE_W::new(self)
    }
    #[doc = "Bit 10 - Data toggle error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterie(&mut self) -> DTERIE_W<HCH5INTEN_SPEC, 10> {
        DTERIE_W::new(self)
    }
