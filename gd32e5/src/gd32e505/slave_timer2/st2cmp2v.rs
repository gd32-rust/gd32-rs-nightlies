...
pub type R = crate::R<ST2CMP2V_SPEC>;
#[doc = "Register `ST2CMP2V` writer"]
pub type W = crate::W<ST2CMP2V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp2val(&mut self) -> CMP2VAL_W<ST2CMP2V_SPEC, 0> {
        CMP2VAL_W::new(self)
    }
...
pub struct ST2CMP2V_SPEC;
impl crate::RegisterSpec for ST2CMP2V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2cmp2v::R`](R) reader structure"]
impl crate::Readable for ST2CMP2V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st2cmp2v::W`](W) writer structure"]
impl crate::Writable for ST2CMP2V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2CMP2V to value 0"]
impl crate::Resettable for ST2CMP2V_SPEC {
