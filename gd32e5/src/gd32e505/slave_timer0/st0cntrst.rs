...
pub type R = crate::R<ST0CNTRST_SPEC>;
#[doc = "Register `ST0CNTRST` writer"]
pub type W = crate::W<ST0CNTRST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn uprst(&mut self) -> UPRST_W<ST0CNTRST_SPEC, 1> {
        UPRST_W::new(self)
    }
    #[doc = "Bit 2 - Slave_TIMER0 compare 1 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1rst(&mut self) -> CMP1RST_W<ST0CNTRST_SPEC, 2> {
        CMP1RST_W::new(self)
    }
    #[doc = "Bit 3 - Slave_TIMER0 compare 3 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3rst(&mut self) -> CMP3RST_W<ST0CNTRST_SPEC, 3> {
        CMP3RST_W::new(self)
    }
    #[doc = "Bit 4 - Master_TIMER period event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn mtperrst(&mut self) -> MTPERRST_W<ST0CNTRST_SPEC, 4> {
        MTPERRST_W::new(self)
    }
    #[doc = "Bit 5 - Master_TIMER compare 0 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn mtcmp0rst(&mut self) -> MTCMP0RST_W<ST0CNTRST_SPEC, 5> {
        MTCMP0RST_W::new(self)
    }
    #[doc = "Bit 6 - Master_TIMER compare 1 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn mtcmp1rst(&mut self) -> MTCMP1RST_W<ST0CNTRST_SPEC, 6> {
        MTCMP1RST_W::new(self)
    }
    #[doc = "Bit 7 - Master_TIMER compare 2 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn mtcmp2rst(&mut self) -> MTCMP2RST_W<ST0CNTRST_SPEC, 7> {
        MTCMP2RST_W::new(self)
    }
    #[doc = "Bit 8 - Master_TIMER compare 3 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn mtcmp3rst(&mut self) -> MTCMP3RST_W<ST0CNTRST_SPEC, 8> {
        MTCMP3RST_W::new(self)
    }
    #[doc = "Bit 9 - External event 0 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev0rst(&mut self) -> EXEV0RST_W<ST0CNTRST_SPEC, 9> {
        EXEV0RST_W::new(self)
    }
    #[doc = "Bit 10 - External event 1 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev1rst(&mut self) -> EXEV1RST_W<ST0CNTRST_SPEC, 10> {
        EXEV1RST_W::new(self)
    }
    #[doc = "Bit 11 - External event 2 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev2rst(&mut self) -> EXEV2RST_W<ST0CNTRST_SPEC, 11> {
        EXEV2RST_W::new(self)
    }
    #[doc = "Bit 12 - External event 3 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev3rst(&mut self) -> EXEV3RST_W<ST0CNTRST_SPEC, 12> {
        EXEV3RST_W::new(self)
    }
    #[doc = "Bit 13 - External event 4 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev4rst(&mut self) -> EXEV4RST_W<ST0CNTRST_SPEC, 13> {
        EXEV4RST_W::new(self)
    }
    #[doc = "Bit 14 - External event 5 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev5rst(&mut self) -> EXEV5RST_W<ST0CNTRST_SPEC, 14> {
        EXEV5RST_W::new(self)
    }
    #[doc = "Bit 15 - External event 6 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev6rst(&mut self) -> EXEV6RST_W<ST0CNTRST_SPEC, 15> {
        EXEV6RST_W::new(self)
    }
    #[doc = "Bit 16 - External event 7 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev7rst(&mut self) -> EXEV7RST_W<ST0CNTRST_SPEC, 16> {
        EXEV7RST_W::new(self)
    }
    #[doc = "Bit 17 - External event 8 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev8rst(&mut self) -> EXEV8RST_W<ST0CNTRST_SPEC, 17> {
        EXEV8RST_W::new(self)
    }
    #[doc = "Bit 18 - External event 9 resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn exev9rst(&mut self) -> EXEV9RST_W<ST0CNTRST_SPEC, 18> {
        EXEV9RST_W::new(self)
    }
    #[doc = "Bit 19 - Slave_TIMER1 compare 0 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st1cmp0rst(&mut self) -> ST1CMP0RST_W<ST0CNTRST_SPEC, 19> {
        ST1CMP0RST_W::new(self)
    }
    #[doc = "Bit 20 - Slave_TIMER1 compare 1 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st1cmp1rst(&mut self) -> ST1CMP1RST_W<ST0CNTRST_SPEC, 20> {
        ST1CMP1RST_W::new(self)
    }
    #[doc = "Bit 21 - Slave_TIMER1 compare 3 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st1cmp3rst(&mut self) -> ST1CMP3RST_W<ST0CNTRST_SPEC, 21> {
        ST1CMP3RST_W::new(self)
    }
    #[doc = "Bit 22 - Slave_TIMER2 compare 0 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st2cmp0rst(&mut self) -> ST2CMP0RST_W<ST0CNTRST_SPEC, 22> {
        ST2CMP0RST_W::new(self)
    }
    #[doc = "Bit 23 - Slave_TIMER2 compare 1 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st2cmp1rst(&mut self) -> ST2CMP1RST_W<ST0CNTRST_SPEC, 23> {
        ST2CMP1RST_W::new(self)
    }
    #[doc = "Bit 24 - Slave_TIMER2 compare 3 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st2cmp3rst(&mut self) -> ST2CMP3RST_W<ST0CNTRST_SPEC, 24> {
        ST2CMP3RST_W::new(self)
    }
    #[doc = "Bit 25 - Slave_TIMER3 compare 0 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st3cmp0rst(&mut self) -> ST3CMP0RST_W<ST0CNTRST_SPEC, 25> {
        ST3CMP0RST_W::new(self)
    }
    #[doc = "Bit 26 - Slave_TIMER3 compare 1 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st3cmp1rst(&mut self) -> ST3CMP1RST_W<ST0CNTRST_SPEC, 26> {
        ST3CMP1RST_W::new(self)
    }
    #[doc = "Bit 27 - Slave_TIMER3 compare 3 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st3cmp3rst(&mut self) -> ST3CMP3RST_W<ST0CNTRST_SPEC, 27> {
        ST3CMP3RST_W::new(self)
    }
    #[doc = "Bit 28 - Slave_TIMER4 compare 0 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st4cmp0rst(&mut self) -> ST4CMP0RST_W<ST0CNTRST_SPEC, 28> {
        ST4CMP0RST_W::new(self)
    }
    #[doc = "Bit 29 - Slave_TIMER4 compare 1 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st4cmp1rst(&mut self) -> ST4CMP1RST_W<ST0CNTRST_SPEC, 29> {
        ST4CMP1RST_W::new(self)
    }
    #[doc = "Bit 30 - Slave_TIMER4 compare 3 event resets counter"]
    #[inline(always)]
    #[must_use]
    pub fn st4cmp3rst(&mut self) -> ST4CMP3RST_W<ST0CNTRST_SPEC, 30> {
...
pub struct ST0CNTRST_SPEC;
impl crate::RegisterSpec for ST0CNTRST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0cntrst::R`](R) reader structure"]
impl crate::Readable for ST0CNTRST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st0cntrst::W`](W) writer structure"]
impl crate::Writable for ST0CNTRST_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST0CNTRST to value 0"]
impl crate::Resettable for ST0CNTRST_SPEC {
