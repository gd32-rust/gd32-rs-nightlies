...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntckdiv(&mut self) -> CntckdivW<St0ctl0Spec> {
        CntckdivW::new(self, 0)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    #[must_use]
    pub fn ctnm(&mut self) -> CtnmW<St0ctl0Spec> {
        CtnmW::new(self, 3)
    }
    #[doc = "Bit 4 - Counter reset mode"]
    #[inline(always)]
    #[must_use]
    pub fn cntrstm(&mut self) -> CntrstmW<St0ctl0Spec> {
        CntrstmW::new(self, 4)
    }
    #[doc = "Bit 5 - Half mode"]
    #[inline(always)]
    #[must_use]
    pub fn halfm(&mut self) -> HalfmW<St0ctl0Spec> {
        HalfmW::new(self, 5)
    }
    #[doc = "Bit 6 - Balanced mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn blnmen(&mut self) -> BlnmenW<St0ctl0Spec> {
        BlnmenW::new(self, 6)
    }
    #[doc = "Bit 10 - Synchronization input reset counter"]
    #[inline(always)]
    #[must_use]
    pub fn synirst(&mut self) -> SynirstW<St0ctl0Spec> {
        SynirstW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronization input start counter"]
    #[inline(always)]
    #[must_use]
    pub fn synistrt(&mut self) -> SynistrtW<St0ctl0Spec> {
        SynistrtW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Compare 1 delayed mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp1m(&mut self) -> Delcmp1mW<St0ctl0Spec> {
        Delcmp1mW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Compare 3 delayed mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp3m(&mut self) -> Delcmp3mW<St0ctl0Spec> {
        Delcmp3mW::new(self, 14)
    }
    #[doc = "Bit 17 - Update event generated by repetition event"]
    #[inline(always)]
    #[must_use]
    pub fn uprep(&mut self) -> UprepW<St0ctl0Spec> {
        UprepW::new(self, 17)
    }
    #[doc = "Bit 18 - Update event generated by reset event"]
    #[inline(always)]
    #[must_use]
    pub fn uprst(&mut self) -> UprstW<St0ctl0Spec> {
        UprstW::new(self, 18)
    }
    #[doc = "Bit 20 - Update by Slave_TIMER1 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst1(&mut self) -> Upbst1W<St0ctl0Spec> {
        Upbst1W::new(self, 20)
    }
    #[doc = "Bit 21 - Update by Slave_TIMER2 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst2(&mut self) -> Upbst2W<St0ctl0Spec> {
        Upbst2W::new(self, 21)
    }
    #[doc = "Bit 22 - Update by Slave_TIMER3 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst3(&mut self) -> Upbst3W<St0ctl0Spec> {
        Upbst3W::new(self, 22)
    }
    #[doc = "Bit 23 - Update by Slave_TIMER4 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst4(&mut self) -> Upbst4W<St0ctl0Spec> {
        Upbst4W::new(self, 23)
    }
    #[doc = "Bit 24 - Update by Master_TIMER update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbmt(&mut self) -> UpbmtW<St0ctl0Spec> {
        UpbmtW::new(self, 24)
    }
    #[doc = "Bits 25:26 - Trigger source to DAC"]
    #[inline(always)]
    #[must_use]
    pub fn dactrgs(&mut self) -> DactrgsW<St0ctl0Spec> {
        DactrgsW::new(self, 25)
    }
    #[doc = "Bit 27 - Shadow registers enable"]
    #[inline(always)]
    #[must_use]
    pub fn shwen(&mut self) -> ShwenW<St0ctl0Spec> {
        ShwenW::new(self, 27)
    }
    #[doc = "Bits 28:31 - Update event selection"]
    #[inline(always)]
    #[must_use]
    pub fn upsel(&mut self) -> UpselW<St0ctl0Spec> {
        UpselW::new(self, 28)
    }
}
