...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flt0en(&mut self) -> Flt0enW<St0fltctlSpec> {
        Flt0enW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 1 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt1en(&mut self) -> Flt1enW<St0fltctlSpec> {
        Flt1enW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt2en(&mut self) -> Flt2enW<St0fltctlSpec> {
        Flt2enW::new(self, 2)
    }
    #[doc = "Bit 3 - Fault 3 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt3en(&mut self) -> Flt3enW<St0fltctlSpec> {
        Flt3enW::new(self, 3)
    }
    #[doc = "Bit 4 - Fault 4 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt4en(&mut self) -> Flt4enW<St0fltctlSpec> {
        Flt4enW::new(self, 4)
    }
    #[doc = "Bit 31 - Protect fault enable"]
    #[inline(always)]
    #[must_use]
    pub fn fltenprot(&mut self) -> FltenprotW<St0fltctlSpec> {
