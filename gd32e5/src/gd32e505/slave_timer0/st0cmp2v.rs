...
pub type R = crate::R<ST0CMP2V_SPEC>;
#[doc = "Register `ST0CMP2V` writer"]
pub type W = crate::W<ST0CMP2V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp2val(&mut self) -> CMP2VAL_W<ST0CMP2V_SPEC, 0> {
        CMP2VAL_W::new(self)
    }
...
pub struct ST0CMP2V_SPEC;
impl crate::RegisterSpec for ST0CMP2V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0cmp2v::R`](R) reader structure"]
impl crate::Readable for ST0CMP2V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st0cmp2v::W`](W) writer structure"]
impl crate::Writable for ST0CMP2V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST0CMP2V to value 0"]
impl crate::Resettable for ST0CMP2V_SPEC {
