...
pub type R = crate::R<DIEP1DMAADDR_SPEC>;
#[doc = "Register `DIEP1DMAADDR` writer"]
pub type W = crate::W<DIEP1DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DIEP1DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct DIEP1DMAADDR_SPEC;
impl crate::RegisterSpec for DIEP1DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep1dmaaddr::R`](R) reader structure"]
impl crate::Readable for DIEP1DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep1dmaaddr::W`](W) writer structure"]
impl crate::Writable for DIEP1DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP1DMAADDR to value 0"]
impl crate::Resettable for DIEP1DMAADDR_SPEC {
