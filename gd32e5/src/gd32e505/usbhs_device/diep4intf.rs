...
pub type R = crate::R<DIEP4INTF_SPEC>;
#[doc = "Register `DIEP4INTF` writer"]
pub type W = crate::W<DIEP4INTF_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<DIEP4INTF_SPEC, 0> {
        TF_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint finished"]
    #[inline(always)]
    #[must_use]
    pub fn epdis(&mut self) -> EPDIS_W<DIEP4INTF_SPEC, 1> {
        EPDIS_W::new(self)
    }
    #[doc = "Bit 3 - Control in timeout interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn cito(&mut self) -> CITO_W<DIEP4INTF_SPEC, 3> {
        CITO_W::new(self)
    }
    #[doc = "Bit 4 - Endpoint Tx FIFO underrun"]
    #[inline(always)]
    #[must_use]
    pub fn eptxfud(&mut self) -> EPTXFUD_W<DIEP4INTF_SPEC, 4> {
        EPTXFUD_W::new(self)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    #[must_use]
    pub fn iepne(&mut self) -> IEPNE_W<DIEP4INTF_SPEC, 6> {
        IEPNE_W::new(self)
    }
    #[doc = "Bit 13 - NAK handshake sent by USBHS"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<DIEP4INTF_SPEC, 13> {
        NAK_W::new(self)
    }
...
#[doc = "device endpoint-4 interrupt register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`diep4intf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`diep4intf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEP4INTF_SPEC;
impl crate::RegisterSpec for DIEP4INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep4intf::R`](R) reader structure"]
impl crate::Readable for DIEP4INTF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep4intf::W`](W) writer structure"]
impl crate::Writable for DIEP4INTF_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP4INTF to value 0x80"]
impl crate::Resettable for DIEP4INTF_SPEC {
