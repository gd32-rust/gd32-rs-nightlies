...
pub type R = crate::R<DIEP4CTL_SPEC>;
#[doc = "Register `DIEP4CTL` writer"]
pub type W = crate::W<DIEP4CTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mpl(&mut self) -> MPL_W<DIEP4CTL_SPEC, 0> {
        MPL_W::new(self)
    }
    #[doc = "Bit 15 - Endpoint active"]
    #[inline(always)]
    #[must_use]
    pub fn epact(&mut self) -> EPACT_W<DIEP4CTL_SPEC, 15> {
        EPACT_W::new(self)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<DIEP4CTL_SPEC, 18> {
        EPTYPE_W::new(self)
    }
    #[doc = "Bit 21 - STALL handshake"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<DIEP4CTL_SPEC, 21> {
        STALL_W::new(self)
    }
    #[doc = "Bits 22:25 - Tx FIFO number"]
    #[inline(always)]
    #[must_use]
    pub fn txfnum(&mut self) -> TXFNUM_W<DIEP4CTL_SPEC, 22> {
        TXFNUM_W::new(self)
    }
    #[doc = "Bit 26 - Clear NAK"]
    #[inline(always)]
    #[must_use]
    pub fn cnak(&mut self) -> CNAK_W<DIEP4CTL_SPEC, 26> {
        CNAK_W::new(self)
    }
    #[doc = "Bit 27 - Set NAK"]
    #[inline(always)]
    #[must_use]
    pub fn snak(&mut self) -> SNAK_W<DIEP4CTL_SPEC, 27> {
        SNAK_W::new(self)
    }
    #[doc = "Bit 28 - SD0PID/SEVNFRM"]
    #[inline(always)]
    #[must_use]
    pub fn sd0pid_sevenfrm(&mut self) -> SD0PID_SEVENFRM_W<DIEP4CTL_SPEC, 28> {
        SD0PID_SEVENFRM_W::new(self)
    }
    #[doc = "Bit 29 - Set DATA1 PID/Set odd frame"]
    #[inline(always)]
    #[must_use]
    pub fn sd1pid_soddfrm(&mut self) -> SD1PID_SODDFRM_W<DIEP4CTL_SPEC, 29> {
        SD1PID_SODDFRM_W::new(self)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    #[must_use]
    pub fn epd(&mut self) -> EPD_W<DIEP4CTL_SPEC, 30> {
        EPD_W::new(self)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    #[must_use]
    pub fn epen(&mut self) -> EPEN_W<DIEP4CTL_SPEC, 31> {
        EPEN_W::new(self)
    }
...
#[doc = "device endpoint-4 control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`diep4ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`diep4ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DIEP4CTL_SPEC;
impl crate::RegisterSpec for DIEP4CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep4ctl::R`](R) reader structure"]
impl crate::Readable for DIEP4CTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep4ctl::W`](W) writer structure"]
impl crate::Writable for DIEP4CTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP4CTL to value 0"]
impl crate::Resettable for DIEP4CTL_SPEC {
