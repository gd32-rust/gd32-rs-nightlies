...
pub type R = crate::R<DOEP4LEN_SPEC>;
#[doc = "Register `DOEP4LEN` writer"]
pub type W = crate::W<DOEP4LEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tlen(&mut self) -> TLEN_W<DOEP4LEN_SPEC, 0> {
        TLEN_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt(&mut self) -> PCNT_W<DOEP4LEN_SPEC, 19> {
        PCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - SETUP packet count/Received data PID"]
    #[inline(always)]
    #[must_use]
    pub fn stpcnt_rxdpid(&mut self) -> STPCNT_RXDPID_W<DOEP4LEN_SPEC, 29> {
...
pub struct DOEP4LEN_SPEC;
impl crate::RegisterSpec for DOEP4LEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep4len::R`](R) reader structure"]
impl crate::Readable for DOEP4LEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep4len::W`](W) writer structure"]
impl crate::Writable for DOEP4LEN_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP4LEN to value 0"]
impl crate::Resettable for DOEP4LEN_SPEC {
