...
pub type R = crate::R<DIEP3DMAADDR_SPEC>;
#[doc = "Register `DIEP3DMAADDR` writer"]
pub type W = crate::W<DIEP3DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DIEP3DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct DIEP3DMAADDR_SPEC;
impl crate::RegisterSpec for DIEP3DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep3dmaaddr::R`](R) reader structure"]
impl crate::Readable for DIEP3DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep3dmaaddr::W`](W) writer structure"]
impl crate::Writable for DIEP3DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP3DMAADDR to value 0"]
impl crate::Resettable for DIEP3DMAADDR_SPEC {
