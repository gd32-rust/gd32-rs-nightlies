...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<DIEP2INTF_SPEC, 0> {
        TF_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint finished"]
    #[inline(always)]
    #[must_use]
    pub fn epdis(&mut self) -> EPDIS_W<DIEP2INTF_SPEC, 1> {
        EPDIS_W::new(self)
    }
    #[doc = "Bit 3 - Control in timeout interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn cito(&mut self) -> CITO_W<DIEP2INTF_SPEC, 3> {
        CITO_W::new(self)
    }
    #[doc = "Bit 4 - Endpoint Tx FIFO underrun"]
    #[inline(always)]
    #[must_use]
    pub fn eptxfud(&mut self) -> EPTXFUD_W<DIEP2INTF_SPEC, 4> {
        EPTXFUD_W::new(self)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    #[must_use]
    pub fn iepne(&mut self) -> IEPNE_W<DIEP2INTF_SPEC, 6> {
        IEPNE_W::new(self)
    }
    #[doc = "Bit 13 - NAK handshake sent by USBHS"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<DIEP2INTF_SPEC, 13> {
        NAK_W::new(self)
    }
