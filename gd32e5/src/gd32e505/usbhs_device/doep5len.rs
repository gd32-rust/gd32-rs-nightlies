...
pub type R = crate::R<DOEP5LEN_SPEC>;
#[doc = "Register `DOEP5LEN` writer"]
pub type W = crate::W<DOEP5LEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tlen(&mut self) -> TLEN_W<DOEP5LEN_SPEC, 0> {
        TLEN_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt(&mut self) -> PCNT_W<DOEP5LEN_SPEC, 19> {
        PCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - SETUP packet count/Received data PID"]
    #[inline(always)]
    #[must_use]
    pub fn stpcnt_rxdpid(&mut self) -> STPCNT_RXDPID_W<DOEP5LEN_SPEC, 29> {
...
pub struct DOEP5LEN_SPEC;
impl crate::RegisterSpec for DOEP5LEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep5len::R`](R) reader structure"]
impl crate::Readable for DOEP5LEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep5len::W`](W) writer structure"]
impl crate::Writable for DOEP5LEN_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP5LEN to value 0"]
impl crate::Resettable for DOEP5LEN_SPEC {
