...
pub type R = crate::R<ST4CNT_SPEC>;
#[doc = "Register `ST4CNT` writer"]
pub type W = crate::W<ST4CNT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cnt(&mut self) -> CNT_W<ST4CNT_SPEC, 0> {
        CNT_W::new(self)
    }
...
pub struct ST4CNT_SPEC;
impl crate::RegisterSpec for ST4CNT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4cnt::R`](R) reader structure"]
impl crate::Readable for ST4CNT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st4cnt::W`](W) writer structure"]
impl crate::Writable for ST4CNT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST4CNT to value 0"]
impl crate::Resettable for ST4CNT_SPEC {
