...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn exev5meen(&mut self) -> Exev5meenW<St4exevfcfg1Spec> {
        Exev5meenW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External event 5 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev5fm(&mut self) -> Exev5fmW<St4exevfcfg1Spec> {
        Exev5fmW::new(self, 1)
    }
    #[doc = "Bit 6 - External event 6 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev6meen(&mut self) -> Exev6meenW<St4exevfcfg1Spec> {
        Exev6meenW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External event 6 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev6fm(&mut self) -> Exev6fmW<St4exevfcfg1Spec> {
        Exev6fmW::new(self, 7)
    }
    #[doc = "Bit 12 - External event 7 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev7meen(&mut self) -> Exev7meenW<St4exevfcfg1Spec> {
        Exev7meenW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External event 7 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev7fm(&mut self) -> Exev7fmW<St4exevfcfg1Spec> {
        Exev7fmW::new(self, 13)
    }
    #[doc = "Bit 18 - External event 8 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev8meen(&mut self) -> Exev8meenW<St4exevfcfg1Spec> {
        Exev8meenW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External event 8 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev8fm(&mut self) -> Exev8fmW<St4exevfcfg1Spec> {
        Exev8fmW::new(self, 19)
    }
    #[doc = "Bit 24 - External event 9 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev9meen(&mut self) -> Exev9meenW<St4exevfcfg1Spec> {
        Exev9meenW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External event 9 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev9fm(&mut self) -> Exev9fmW<St4exevfcfg1Spec> {
