...
pub type R = crate::R<DMA_RPEN_SPEC>;
#[doc = "Register `DMA_RPEN` writer"]
pub type W = crate::W<DMA_RPEN_SPEC>;
#[doc = "Field `RPE` reader - Receive poll enable"]
pub type RPE_R = crate::FieldReader<u32>;
#[doc = "Field `RPE` writer - Receive poll enable"]
pub type RPE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rpe(&mut self) -> RPE_W<DMA_RPEN_SPEC, 0> {
        RPE_W::new(self)
    }
