...
pub type R = crate::R<MTCMP3V_SPEC>;
#[doc = "Register `MTCMP3V` writer"]
pub type W = crate::W<MTCMP3V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp3val(&mut self) -> CMP3VAL_W<MTCMP3V_SPEC, 0> {
        CMP3VAL_W::new(self)
    }
...
pub struct MTCMP3V_SPEC;
impl crate::RegisterSpec for MTCMP3V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mtcmp3v::R`](R) reader structure"]
impl crate::Readable for MTCMP3V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mtcmp3v::W`](W) writer structure"]
impl crate::Writable for MTCMP3V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MTCMP3V to value 0"]
impl crate::Resettable for MTCMP3V_SPEC {
