...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sbrsten(&mut self) -> SBRSTEN_W<SNCTL0_SPEC, 8> {
        SBRSTEN_W::new(self)
    }
    #[doc = "Bit 9 - NWAIT signal polarity"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn wrapen(&mut self) -> WRAPEN_W<SNCTL0_SPEC, 10> {
        WRAPEN_W::new(self)
    }
    #[doc = "Bit 11 - NWAIT signal configuration, only work in synchronous mode"]
    #[inline(always)]
    #[must_use]
    pub fn nrwtcfg(&mut self) -> NRWTCFG_W<SNCTL0_SPEC, 11> {
        NRWTCFG_W::new(self)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn exmoden(&mut self) -> EXMODEN_W<SNCTL0_SPEC, 14> {
        EXMODEN_W::new(self)
    }
    #[doc = "Bit 15 - Asynchronous wait"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn cps(&mut self) -> CPS_W<SNCTL0_SPEC, 16> {
        CPS_W::new(self)
    }
    #[doc = "Bit 19 - Synchronous write"]
    #[inline(always)]
    #[must_use]
    pub fn syncwr(&mut self) -> SYNCWR_W<SNCTL0_SPEC, 19> {
        SYNCWR_W::new(self)
    }
