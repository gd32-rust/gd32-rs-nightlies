...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn db0(&mut self) -> DB0_W<TMDATA02_SPEC, 0> {
        DB0_W::new(self)
    }
    #[doc = "Bits 8:15 - Data byte 1"]
    #[inline(always)]
    #[must_use]
    pub fn db1(&mut self) -> DB1_W<TMDATA02_SPEC, 8> {
        DB1_W::new(self)
    }
    #[doc = "Bits 16:23 - Data byte 2"]
    #[inline(always)]
    #[must_use]
    pub fn db2(&mut self) -> DB2_W<TMDATA02_SPEC, 16> {
        DB2_W::new(self)
    }
    #[doc = "Bits 24:31 - Data byte 3"]
    #[inline(always)]
    #[must_use]
    pub fn db3(&mut self) -> DB3_W<TMDATA02_SPEC, 24> {
        DB3_W::new(self)
    }
