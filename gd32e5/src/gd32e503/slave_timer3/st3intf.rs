...
pub type R = crate::R<ST3INTF_SPEC>;
...
#[doc = "SHRTIMER Slave_TIMERx interrupt flag register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st3intf::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST3INTF_SPEC;
impl crate::RegisterSpec for ST3INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3intf::R`](R) reader structure"]
impl crate::Readable for ST3INTF_SPEC {}
#[doc = "`reset()` method sets ST3INTF to value 0"]
impl crate::Resettable for ST3INTF_SPEC {
