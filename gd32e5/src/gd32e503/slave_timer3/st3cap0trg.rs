...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3a(&mut self) -> CP0BST3A_W<ST3CAP0TRG_SPEC, 24> {
        CP0BST3A_W::new(self)
    }
    #[doc = "Bit 25 - Capture 0 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3na(&mut self) -> CP0BST3NA_W<ST3CAP0TRG_SPEC, 25> {
        CP0BST3NA_W::new(self)
    }
    #[doc = "Bit 26 - Capture 0 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp0(&mut self) -> CP0BST3CMP0_W<ST3CAP0TRG_SPEC, 26> {
        CP0BST3CMP0_W::new(self)
    }
    #[doc = "Bit 27 - Capture 0 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp1(&mut self) -> CP0BST3CMP1_W<ST3CAP0TRG_SPEC, 27> {
