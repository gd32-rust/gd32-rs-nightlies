...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntckdiv_3(&mut self) -> Cntckdiv3W<St3actlSpec> {
        Cntckdiv3W::new(self, 3)
    }
    #[doc = "Bits 9:15 - Rising edge dead-time value configure"]
    #[inline(always)]
    #[must_use]
    pub fn dtrcfg_15_9(&mut self) -> Dtrcfg15_9W<St3actlSpec> {
        Dtrcfg15_9W::new(self, 9)
    }
    #[doc = "Bits 25:31 - Falling edge dead-time value configure"]
    #[inline(always)]
    #[must_use]
    pub fn dtfcfg_15_9(&mut self) -> Dtfcfg15_9W<St3actlSpec> {
