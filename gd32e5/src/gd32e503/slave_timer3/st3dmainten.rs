...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0ie(&mut self) -> Cmp0ieW<St3dmaintenSpec> {
        Cmp0ieW::new(self, 0)
    }
    #[doc = "Bit 1 - Compare 1 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1ie(&mut self) -> Cmp1ieW<St3dmaintenSpec> {
        Cmp1ieW::new(self, 1)
    }
    #[doc = "Bit 2 - Compare 2 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2ie(&mut self) -> Cmp2ieW<St3dmaintenSpec> {
        Cmp2ieW::new(self, 2)
    }
    #[doc = "Bit 3 - Compare 3 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3ie(&mut self) -> Cmp3ieW<St3dmaintenSpec> {
        Cmp3ieW::new(self, 3)
    }
    #[doc = "Bit 4 - Repetition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn repie(&mut self) -> RepieW<St3dmaintenSpec> {
        RepieW::new(self, 4)
    }
    #[doc = "Bit 6 - Update interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn upie(&mut self) -> UpieW<St3dmaintenSpec> {
        UpieW::new(self, 6)
    }
    #[doc = "Bit 7 - Capture 0 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap0ie(&mut self) -> Cap0ieW<St3dmaintenSpec> {
        Cap0ieW::new(self, 7)
    }
    #[doc = "Bit 8 - Capture 1 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap1ie(&mut self) -> Cap1ieW<St3dmaintenSpec> {
        Cap1ieW::new(self, 8)
    }
    #[doc = "Bit 9 - Channel 0 output active interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0oaie(&mut self) -> Ch0oaieW<St3dmaintenSpec> {
        Ch0oaieW::new(self, 9)
    }
    #[doc = "Bit 10 - Channel 0 output inactive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0onaie(&mut self) -> Ch0onaieW<St3dmaintenSpec> {
        Ch0onaieW::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 1 output active interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1oaie(&mut self) -> Ch1oaieW<St3dmaintenSpec> {
        Ch1oaieW::new(self, 11)
    }
    #[doc = "Bit 12 - Channel 1 output inactive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1onaie(&mut self) -> Ch1onaieW<St3dmaintenSpec> {
        Ch1onaieW::new(self, 12)
    }
    #[doc = "Bit 13 - Counter reset interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rstie(&mut self) -> RstieW<St3dmaintenSpec> {
        RstieW::new(self, 13)
    }
    #[doc = "Bit 14 - Delayed IDLE mode entry interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyiie(&mut self) -> DlyiieW<St3dmaintenSpec> {
        DlyiieW::new(self, 14)
    }
    #[doc = "Bit 16 - Compare 0 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp0den(&mut self) -> Cmp0denW<St3dmaintenSpec> {
        Cmp0denW::new(self, 16)
    }
    #[doc = "Bit 17 - Compare 1 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1den(&mut self) -> Cmp1denW<St3dmaintenSpec> {
        Cmp1denW::new(self, 17)
    }
    #[doc = "Bit 18 - Compare 2 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2den(&mut self) -> Cmp2denW<St3dmaintenSpec> {
        Cmp2denW::new(self, 18)
    }
    #[doc = "Bit 19 - Compare 3 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3den(&mut self) -> Cmp3denW<St3dmaintenSpec> {
        Cmp3denW::new(self, 19)
    }
    #[doc = "Bit 20 - Repetition DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn repden(&mut self) -> RepdenW<St3dmaintenSpec> {
        RepdenW::new(self, 20)
    }
    #[doc = "Bit 22 - Update DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn upden(&mut self) -> UpdenW<St3dmaintenSpec> {
        UpdenW::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 0 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap0den(&mut self) -> Cap0denW<St3dmaintenSpec> {
        Cap0denW::new(self, 23)
    }
    #[doc = "Bit 24 - Capture 1 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap1den(&mut self) -> Cap1denW<St3dmaintenSpec> {
        Cap1denW::new(self, 24)
    }
    #[doc = "Bit 25 - Channel 0 output active DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0aden(&mut self) -> Ch0adenW<St3dmaintenSpec> {
        Ch0adenW::new(self, 25)
    }
    #[doc = "Bit 26 - Channel 0 output inactive DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0onaden(&mut self) -> Ch0onadenW<St3dmaintenSpec> {
        Ch0onadenW::new(self, 26)
    }
    #[doc = "Bit 27 - Channel 1 output active DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1oaden(&mut self) -> Ch1oadenW<St3dmaintenSpec> {
        Ch1oadenW::new(self, 27)
    }
    #[doc = "Bit 28 - Channel 1 output inactive DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1onaden(&mut self) -> Ch1onadenW<St3dmaintenSpec> {
        Ch1onadenW::new(self, 28)
    }
    #[doc = "Bit 29 - Counter reset DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn rstden(&mut self) -> RstdenW<St3dmaintenSpec> {
        RstdenW::new(self, 29)
    }
    #[doc = "Bit 30 - Delayed IDLE mode entry DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyiden(&mut self) -> DlyidenW<St3dmaintenSpec> {
