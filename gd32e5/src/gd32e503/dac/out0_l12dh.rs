...
pub type R = crate::R<OUT0_L12DH_SPEC>;
#[doc = "Register `OUT0_L12DH` writer"]
pub type W = crate::W<OUT0_L12DH_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn out0_dh(&mut self) -> OUT0_DH_W<OUT0_L12DH_SPEC, 4> {
        OUT0_DH_W::new(self)
    }
...
pub struct OUT0_L12DH_SPEC;
impl crate::RegisterSpec for OUT0_L12DH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out0_l12dh::R`](R) reader structure"]
impl crate::Readable for OUT0_L12DH_SPEC {}
#[doc = "`write(|w| ..)` method takes [`out0_l12dh::W`](W) writer structure"]
impl crate::Writable for OUT0_L12DH_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OUT0_L12DH to value 0"]
impl crate::Resettable for OUT0_L12DH_SPEC {
