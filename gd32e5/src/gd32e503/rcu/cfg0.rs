...
pub type USBDPSC_R = crate::FieldReader;
#[doc = "Field `USBDPSC` writer - USBD clock prescaler selection"]
pub type USBDPSC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl R {
    ...
    pub fn pllmf_5(&self) -> PLLMF_5_R {
        PLLMF_5_R::new(((self.bits >> 29) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllmf_5(&mut self) -> PLLMF_5_W<CFG0_SPEC, 29> {
        PLLMF_5_W::new(self)
    }
    #[doc = "Bit 31 - Bit 2 of USBHSPSC"]
    #[inline(always)]
