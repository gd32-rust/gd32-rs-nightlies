...
pub type R = crate::R<EP1CS_SPEC>;
#[doc = "Register `EP1CS` writer"]
pub type W = crate::W<EP1CS_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep_ar(&mut self) -> EP_AR_W<EP1CS_SPEC, 0> {
        EP_AR_W::new(self)
    }
    #[doc = "Bits 4:5 - Status bits, for transmission transfers"]
    #[inline(always)]
    #[must_use]
    pub fn tx_sta(&mut self) -> TX_STA_W<EP1CS_SPEC, 4> {
        TX_STA_W::new(self)
    }
    #[doc = "Bit 6 - Data Toggle, for transmission transfers"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dtg(&mut self) -> TX_DTG_W<EP1CS_SPEC, 6> {
        TX_DTG_W::new(self)
    }
    #[doc = "Bit 7 - Correct Transfer for transmission"]
    #[inline(always)]
    #[must_use]
    pub fn tx_st(&mut self) -> TX_ST_W<EP1CS_SPEC, 7> {
        TX_ST_W::new(self)
    }
    #[doc = "Bit 8 - Endpoint kind"]
    #[inline(always)]
    #[must_use]
    pub fn ep_kctl(&mut self) -> EP_KCTL_W<EP1CS_SPEC, 8> {
        EP_KCTL_W::new(self)
    }
    #[doc = "Bits 9:10 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn ep_ctl(&mut self) -> EP_CTL_W<EP1CS_SPEC, 9> {
        EP_CTL_W::new(self)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    #[must_use]
    pub fn setup(&mut self) -> SETUP_W<EP1CS_SPEC, 11> {
        SETUP_W::new(self)
    }
    #[doc = "Bits 12:13 - Status bits, for reception transfers"]
    #[inline(always)]
    #[must_use]
    pub fn rx_sta(&mut self) -> RX_STA_W<EP1CS_SPEC, 12> {
        RX_STA_W::new(self)
    }
    #[doc = "Bit 14 - Data Toggle, for reception transfers"]
    #[inline(always)]
    #[must_use]
    pub fn rx_dtg(&mut self) -> RX_DTG_W<EP1CS_SPEC, 14> {
        RX_DTG_W::new(self)
    }
    #[doc = "Bit 15 - Correct transfer for reception"]
    #[inline(always)]
    #[must_use]
    pub fn rx_st(&mut self) -> RX_ST_W<EP1CS_SPEC, 15> {
        RX_ST_W::new(self)
    }
