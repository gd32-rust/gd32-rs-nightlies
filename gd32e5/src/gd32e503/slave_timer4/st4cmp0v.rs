...
pub type R = crate::R<ST4CMP0V_SPEC>;
#[doc = "Register `ST4CMP0V` writer"]
pub type W = crate::W<ST4CMP0V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0val(&mut self) -> CMP0VAL_W<ST4CMP0V_SPEC, 0> {
        CMP0VAL_W::new(self)
    }
...
pub struct ST4CMP0V_SPEC;
impl crate::RegisterSpec for ST4CMP0V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4cmp0v::R`](R) reader structure"]
impl crate::Readable for ST4CMP0V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st4cmp0v::W`](W) writer structure"]
impl crate::Writable for ST4CMP0V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST4CMP0V to value 0"]
impl crate::Resettable for ST4CMP0V_SPEC {
