...
pub type R = crate::R<ST4FLTCTL_SPEC>;
#[doc = "Register `ST4FLTCTL` writer"]
pub type W = crate::W<ST4FLTCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn flt0en(&mut self) -> FLT0EN_W<ST4FLTCTL_SPEC, 0> {
        FLT0EN_W::new(self)
    }
    #[doc = "Bit 1 - Fault 1 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt1en(&mut self) -> FLT1EN_W<ST4FLTCTL_SPEC, 1> {
        FLT1EN_W::new(self)
    }
    #[doc = "Bit 2 - Fault 2 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt2en(&mut self) -> FLT2EN_W<ST4FLTCTL_SPEC, 2> {
        FLT2EN_W::new(self)
    }
    #[doc = "Bit 3 - Fault 3 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt3en(&mut self) -> FLT3EN_W<ST4FLTCTL_SPEC, 3> {
        FLT3EN_W::new(self)
    }
    #[doc = "Bit 4 - Fault 4 enable"]
    #[inline(always)]
    #[must_use]
    pub fn flt4en(&mut self) -> FLT4EN_W<ST4FLTCTL_SPEC, 4> {
        FLT4EN_W::new(self)
    }
    #[doc = "Bit 31 - Protect fault enable"]
    #[inline(always)]
    #[must_use]
    pub fn fltenprot(&mut self) -> FLTENPROT_W<ST4FLTCTL_SPEC, 31> {
...
#[doc = "SHRTIMER Slave_TIMERx fault control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st4fltctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st4fltctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST4FLTCTL_SPEC;
impl crate::RegisterSpec for ST4FLTCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4fltctl::R`](R) reader structure"]
impl crate::Readable for ST4FLTCTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st4fltctl::W`](W) writer structure"]
impl crate::Writable for ST4FLTCTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST4FLTCTL to value 0"]
impl crate::Resettable for ST4FLTCTL_SPEC {
