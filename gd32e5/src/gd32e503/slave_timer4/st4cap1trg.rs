...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4a(&mut self) -> CP1BST4A_W<ST4CAP1TRG_SPEC, 28> {
        CP1BST4A_W::new(self)
    }
    #[doc = "Bit 29 - Capture 1 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4na(&mut self) -> CP1BST4NA_W<ST4CAP1TRG_SPEC, 29> {
        CP1BST4NA_W::new(self)
    }
    #[doc = "Bit 30 - Capture 1 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp0(&mut self) -> CP1BST4CMP0_W<ST4CAP1TRG_SPEC, 30> {
        CP1BST4CMP0_W::new(self)
    }
    #[doc = "Bit 31 - Capture 1 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp1(&mut self) -> CP1BST4CMP1_W<ST4CAP1TRG_SPEC, 31> {
