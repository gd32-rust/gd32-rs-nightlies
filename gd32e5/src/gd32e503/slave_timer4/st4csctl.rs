...
pub type R = crate::R<ST4CSCTL_SPEC>;
#[doc = "Register `ST4CSCTL` writer"]
pub type W = crate::W<ST4CSCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csprd(&mut self) -> CSPRD_W<ST4CSCTL_SPEC, 0> {
        CSPRD_W::new(self)
    }
    #[doc = "Bits 4:6 - Carrier signal duty cycle"]
    #[inline(always)]
    #[must_use]
    pub fn csdty(&mut self) -> CSDTY_W<ST4CSCTL_SPEC, 4> {
        CSDTY_W::new(self)
    }
    #[doc = "Bits 7:10 - First carrier-signal pulse width"]
    #[inline(always)]
    #[must_use]
    pub fn csfstpw(&mut self) -> CSFSTPW_W<ST4CSCTL_SPEC, 7> {
        CSFSTPW_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMERx carrier-signal control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st4csctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st4csctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST4CSCTL_SPEC;
impl crate::RegisterSpec for ST4CSCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4csctl::R`](R) reader structure"]
impl crate::Readable for ST4CSCTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st4csctl::W`](W) writer structure"]
impl crate::Writable for ST4CSCTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST4CSCTL to value 0"]
impl crate::Resettable for ST4CSCTL_SPEC {
