...
pub type R = crate::R<ST4DTCTL_SPEC>;
#[doc = "Register `ST4DTCTL` writer"]
pub type W = crate::W<ST4DTCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtrcfg(&mut self) -> DTRCFG_W<ST4DTCTL_SPEC, 0> {
        DTRCFG_W::new(self)
    }
    #[doc = "Bit 9 - The sign of falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtrs(&mut self) -> DTRS_W<ST4DTCTL_SPEC, 9> {
        DTRS_W::new(self)
    }
    #[doc = "Bits 10:13 - Dead time generator clock division"]
    #[inline(always)]
    #[must_use]
    pub fn dtgckdiv(&mut self) -> DTGCKDIV_W<ST4DTCTL_SPEC, 10> {
        DTGCKDIV_W::new(self)
    }
    #[doc = "Bit 14 - Dead-time rising edge protection for sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtrsprot(&mut self) -> DTRSPROT_W<ST4DTCTL_SPEC, 14> {
        DTRSPROT_W::new(self)
    }
    #[doc = "Bit 15 - Dead-time rising edge protection for value and sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtrsvprot(&mut self) -> DTRSVPROT_W<ST4DTCTL_SPEC, 15> {
        DTRSVPROT_W::new(self)
    }
    #[doc = "Bits 16:24 - Falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtfcfg(&mut self) -> DTFCFG_W<ST4DTCTL_SPEC, 16> {
        DTFCFG_W::new(self)
    }
    #[doc = "Bit 25 - The sign of falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtfs(&mut self) -> DTFS_W<ST4DTCTL_SPEC, 25> {
        DTFS_W::new(self)
    }
    #[doc = "Bit 30 - Dead-time falling edge protection for sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtfsprot(&mut self) -> DTFSPROT_W<ST4DTCTL_SPEC, 30> {
        DTFSPROT_W::new(self)
    }
    #[doc = "Bit 31 - Dead-time falling edge protection for value and sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtfsvprot(&mut self) -> DTFSVPROT_W<ST4DTCTL_SPEC, 31> {
...
#[doc = "SHRTIMER Slave_TIMERx dead-time control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st4dtctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st4dtctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST4DTCTL_SPEC;
impl crate::RegisterSpec for ST4DTCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4dtctl::R`](R) reader structure"]
impl crate::Readable for ST4DTCTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st4dtctl::W`](W) writer structure"]
impl crate::Writable for ST4DTCTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST4DTCTL to value 0"]
impl crate::Resettable for ST4DTCTL_SPEC {
