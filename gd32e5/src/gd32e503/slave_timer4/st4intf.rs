...
pub type R = crate::R<ST4INTF_SPEC>;
...
#[doc = "SHRTIMER Slave_TIMERx interrupt flag register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st4intf::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST4INTF_SPEC;
impl crate::RegisterSpec for ST4INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4intf::R`](R) reader structure"]
impl crate::Readable for ST4INTF_SPEC {}
#[doc = "`reset()` method sets ST4INTF to value 0"]
impl crate::Resettable for ST4INTF_SPEC {
