...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4a(&mut self) -> CP0BST4A_W<ST4CAP0TRG_SPEC, 28> {
        CP0BST4A_W::new(self)
    }
    #[doc = "Bit 29 - Capture 0 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4na(&mut self) -> CP0BST4NA_W<ST4CAP0TRG_SPEC, 29> {
        CP0BST4NA_W::new(self)
    }
    #[doc = "Bit 30 - Capture 0 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp0(&mut self) -> CP0BST4CMP0_W<ST4CAP0TRG_SPEC, 30> {
        CP0BST4CMP0_W::new(self)
    }
    #[doc = "Bit 31 - Capture 0 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp1(&mut self) -> CP0BST4CMP1_W<ST4CAP0TRG_SPEC, 31> {
