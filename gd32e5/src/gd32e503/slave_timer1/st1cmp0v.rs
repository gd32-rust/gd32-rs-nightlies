...
pub type R = crate::R<ST1CMP0V_SPEC>;
#[doc = "Register `ST1CMP0V` writer"]
pub type W = crate::W<ST1CMP0V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0val(&mut self) -> CMP0VAL_W<ST1CMP0V_SPEC, 0> {
        CMP0VAL_W::new(self)
    }
...
pub struct ST1CMP0V_SPEC;
impl crate::RegisterSpec for ST1CMP0V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1cmp0v::R`](R) reader structure"]
impl crate::Readable for ST1CMP0V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st1cmp0v::W`](W) writer structure"]
impl crate::Writable for ST1CMP0V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST1CMP0V to value 0"]
impl crate::Resettable for ST1CMP0V_SPEC {
