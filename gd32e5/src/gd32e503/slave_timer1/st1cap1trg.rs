...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1a(&mut self) -> Cp1bst1aW<St1cap1trgSpec> {
        Cp1bst1aW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture 1 triggered by ST1CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1na(&mut self) -> Cp1bst1naW<St1cap1trgSpec> {
        Cp1bst1naW::new(self, 17)
    }
    #[doc = "Bit 18 - Capture 1 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp0(&mut self) -> Cp1bst1cmp0W<St1cap1trgSpec> {
        Cp1bst1cmp0W::new(self, 18)
    }
    #[doc = "Bit 19 - Capture 1 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp1(&mut self) -> Cp1bst1cmp1W<St1cap1trgSpec> {
