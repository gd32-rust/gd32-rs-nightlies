...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn esi(&mut self) -> ESI_W<TMP2_SPEC, 4> {
        ESI_W::new(self)
    }
    #[doc = "Bit 5 - Bit rate of data switch"]
    #[inline(always)]
    #[must_use]
    pub fn brs(&mut self) -> BRS_W<TMP2_SPEC, 5> {
        BRS_W::new(self)
    }
    #[doc = "Bit 7 - CAN FD frame flag"]
    #[inline(always)]
    #[must_use]
    pub fn fdf(&mut self) -> FDF_W<TMP2_SPEC, 7> {
        FDF_W::new(self)
    }
    #[doc = "Bit 8 - Time stamp enable"]
    #[inline(always)]
