...
pub type R = crate::R<ST0CAR_SPEC>;
#[doc = "Register `ST0CAR` writer"]
pub type W = crate::W<ST0CAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn carl(&mut self) -> CARL_W<ST0CAR_SPEC, 0> {
        CARL_W::new(self)
    }
...
pub struct ST0CAR_SPEC;
impl crate::RegisterSpec for ST0CAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0car::R`](R) reader structure"]
impl crate::Readable for ST0CAR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st0car::W`](W) writer structure"]
impl crate::Writable for ST0CAR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST0CAR to value 0"]
impl crate::Resettable for ST0CAR_SPEC {
