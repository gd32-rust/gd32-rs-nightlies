...
pub type R = crate::R<ST0CSCTL_SPEC>;
#[doc = "Register `ST0CSCTL` writer"]
pub type W = crate::W<ST0CSCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn csprd(&mut self) -> CSPRD_W<ST0CSCTL_SPEC, 0> {
        CSPRD_W::new(self)
    }
    #[doc = "Bits 4:6 - Carrier signal duty cycle"]
    #[inline(always)]
    #[must_use]
    pub fn csdty(&mut self) -> CSDTY_W<ST0CSCTL_SPEC, 4> {
        CSDTY_W::new(self)
    }
    #[doc = "Bits 7:10 - First carrier-signal pulse width"]
    #[inline(always)]
    #[must_use]
    pub fn csfstpw(&mut self) -> CSFSTPW_W<ST0CSCTL_SPEC, 7> {
        CSFSTPW_W::new(self)
    }
...
pub struct ST0CSCTL_SPEC;
impl crate::RegisterSpec for ST0CSCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0csctl::R`](R) reader structure"]
impl crate::Readable for ST0CSCTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st0csctl::W`](W) writer structure"]
impl crate::Writable for ST0CSCTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST0CSCTL to value 0"]
impl crate::Resettable for ST0CSCTL_SPEC {
