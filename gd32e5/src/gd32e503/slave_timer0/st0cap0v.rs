...
pub type R = crate::R<ST0CAP0V_SPEC>;
#[doc = "Register `ST0CAP0V` writer"]
pub type W = crate::W<ST0CAP0V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cap0val(&mut self) -> CAP0VAL_W<ST0CAP0V_SPEC, 0> {
        CAP0VAL_W::new(self)
    }
...
pub struct ST0CAP0V_SPEC;
impl crate::RegisterSpec for ST0CAP0V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0cap0v::R`](R) reader structure"]
impl crate::Readable for ST0CAP0V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st0cap0v::W`](W) writer structure"]
impl crate::Writable for ST0CAP0V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST0CAP0V to value 0"]
impl crate::Resettable for ST0CAP0V_SPEC {
