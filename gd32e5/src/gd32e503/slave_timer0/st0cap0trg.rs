...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0a(&mut self) -> CP0BST0A_W<ST0CAP0TRG_SPEC, 12> {
        CP0BST0A_W::new(self)
    }
    #[doc = "Bit 13 - Capture 0 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0na(&mut self) -> CP0BST0NA_W<ST0CAP0TRG_SPEC, 13> {
        CP0BST0NA_W::new(self)
    }
    #[doc = "Bit 14 - Capture 0 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp0(&mut self) -> CP0BST0CMP0_W<ST0CAP0TRG_SPEC, 14> {
        CP0BST0CMP0_W::new(self)
    }
    #[doc = "Bit 15 - Capture 0 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp1(&mut self) -> CP0BST0CMP1_W<ST0CAP0TRG_SPEC, 15> {
