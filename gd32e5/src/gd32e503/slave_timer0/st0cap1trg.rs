...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0a(&mut self) -> CP1BST0A_W<ST0CAP1TRG_SPEC, 12> {
        CP1BST0A_W::new(self)
    }
    #[doc = "Bit 13 - Capture 1 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0na(&mut self) -> CP1BST0NA_W<ST0CAP1TRG_SPEC, 13> {
        CP1BST0NA_W::new(self)
    }
    #[doc = "Bit 14 - Capture 1 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp0(&mut self) -> CP1BST0CMP0_W<ST0CAP1TRG_SPEC, 14> {
        CP1BST0CMP0_W::new(self)
    }
    #[doc = "Bit 15 - Capture 1 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp1(&mut self) -> CP1BST0CMP1_W<ST0CAP1TRG_SPEC, 15> {
