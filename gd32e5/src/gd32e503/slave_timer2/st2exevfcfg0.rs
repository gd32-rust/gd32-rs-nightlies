...
pub type R = crate::R<ST2EXEVFCFG0_SPEC>;
#[doc = "Register `ST2EXEVFCFG0` writer"]
pub type W = crate::W<ST2EXEVFCFG0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn exev0meen(&mut self) -> EXEV0MEEN_W<ST2EXEVFCFG0_SPEC, 0> {
        EXEV0MEEN_W::new(self)
    }
    #[doc = "Bits 1:4 - External event 0 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev0fm(&mut self) -> EXEV0FM_W<ST2EXEVFCFG0_SPEC, 1> {
        EXEV0FM_W::new(self)
    }
    #[doc = "Bit 6 - External event 1 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev1meen(&mut self) -> EXEV1MEEN_W<ST2EXEVFCFG0_SPEC, 6> {
        EXEV1MEEN_W::new(self)
    }
    #[doc = "Bits 7:10 - External event 1 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev1fm(&mut self) -> EXEV1FM_W<ST2EXEVFCFG0_SPEC, 7> {
        EXEV1FM_W::new(self)
    }
    #[doc = "Bit 12 - External event 2 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev2meen(&mut self) -> EXEV2MEEN_W<ST2EXEVFCFG0_SPEC, 12> {
        EXEV2MEEN_W::new(self)
    }
    #[doc = "Bits 13:16 - External event 2 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev2fm(&mut self) -> EXEV2FM_W<ST2EXEVFCFG0_SPEC, 13> {
        EXEV2FM_W::new(self)
    }
    #[doc = "Bit 18 - External event 3 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev3meen(&mut self) -> EXEV3MEEN_W<ST2EXEVFCFG0_SPEC, 18> {
        EXEV3MEEN_W::new(self)
    }
    #[doc = "Bits 19:22 - External event 3 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev3fm(&mut self) -> EXEV3FM_W<ST2EXEVFCFG0_SPEC, 19> {
        EXEV3FM_W::new(self)
    }
    #[doc = "Bit 24 - External event 4 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev4meen(&mut self) -> EXEV4MEEN_W<ST2EXEVFCFG0_SPEC, 24> {
        EXEV4MEEN_W::new(self)
    }
    #[doc = "Bits 25:28 - External event 4 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev4fm(&mut self) -> EXEV4FM_W<ST2EXEVFCFG0_SPEC, 25> {
        EXEV4FM_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMERx external event filter configuration register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st2exevfcfg0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st2exevfcfg0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST2EXEVFCFG0_SPEC;
impl crate::RegisterSpec for ST2EXEVFCFG0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2exevfcfg0::R`](R) reader structure"]
impl crate::Readable for ST2EXEVFCFG0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st2exevfcfg0::W`](W) writer structure"]
impl crate::Writable for ST2EXEVFCFG0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2EXEVFCFG0 to value 0"]
impl crate::Resettable for ST2EXEVFCFG0_SPEC {
