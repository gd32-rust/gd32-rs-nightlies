...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2a(&mut self) -> CP1BST2A_W<ST2CAP1TRG_SPEC, 20> {
        CP1BST2A_W::new(self)
    }
    #[doc = "Bit 21 - Capture 1 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2na(&mut self) -> CP1BST2NA_W<ST2CAP1TRG_SPEC, 21> {
        CP1BST2NA_W::new(self)
    }
    #[doc = "Bit 22 - Capture 1 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp0(&mut self) -> CP1BST2CMP0_W<ST2CAP1TRG_SPEC, 22> {
        CP1BST2CMP0_W::new(self)
    }
    #[doc = "Bit 23 - Capture 1 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp1(&mut self) -> CP1BST2CMP1_W<ST2CAP1TRG_SPEC, 23> {
