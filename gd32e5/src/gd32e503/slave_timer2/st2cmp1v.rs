...
pub type R = crate::R<ST2CMP1V_SPEC>;
#[doc = "Register `ST2CMP1V` writer"]
pub type W = crate::W<ST2CMP1V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp1val(&mut self) -> CMP1VAL_W<ST2CMP1V_SPEC, 0> {
        CMP1VAL_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMERx compare 1 value register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st2cmp1v::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st2cmp1v::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST2CMP1V_SPEC;
impl crate::RegisterSpec for ST2CMP1V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2cmp1v::R`](R) reader structure"]
impl crate::Readable for ST2CMP1V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st2cmp1v::W`](W) writer structure"]
impl crate::Writable for ST2CMP1V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2CMP1V to value 0"]
impl crate::Resettable for ST2CMP1V_SPEC {
