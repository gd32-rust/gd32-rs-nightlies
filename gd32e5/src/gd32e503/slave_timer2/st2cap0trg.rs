...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2a(&mut self) -> Cp0bst2aW<St2cap0trgSpec> {
        Cp0bst2aW::new(self, 20)
    }
    #[doc = "Bit 21 - Capture 0 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2na(&mut self) -> Cp0bst2naW<St2cap0trgSpec> {
        Cp0bst2naW::new(self, 21)
    }
    #[doc = "Bit 22 - Capture 0 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp0(&mut self) -> Cp0bst2cmp0W<St2cap0trgSpec> {
        Cp0bst2cmp0W::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 0 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp1(&mut self) -> Cp0bst2cmp1W<St2cap0trgSpec> {
