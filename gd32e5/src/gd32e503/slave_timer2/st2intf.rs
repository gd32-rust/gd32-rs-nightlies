...
pub type R = crate::R<ST2INTF_SPEC>;
...
pub struct ST2INTF_SPEC;
impl crate::RegisterSpec for ST2INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2intf::R`](R) reader structure"]
impl crate::Readable for ST2INTF_SPEC {}
#[doc = "`reset()` method sets ST2INTF to value 0"]
impl crate::Resettable for ST2INTF_SPEC {
