...
pub type TFCD_R = crate::BitReader;
#[doc = "Field `TFCD` writer - Type Frame CRC Dropping"]
pub type TFCD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    ...
    #[inline(always)]
    pub fn tfcd(&self) -> TFCD_R {
        TFCD_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 2 - Receiver enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfcd(&mut self) -> TFCD_W<MAC_CFG_SPEC, 25> {
        TFCD_W::new(self)
    }
