...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1a(&mut self) -> Cp1bst1aW<St0cap1trgSpec> {
        Cp1bst1aW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture 1 triggered by ST1CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1na(&mut self) -> Cp1bst1naW<St0cap1trgSpec> {
        Cp1bst1naW::new(self, 17)
    }
    #[doc = "Bit 18 - Capture 1 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp0(&mut self) -> Cp1bst1cmp0W<St0cap1trgSpec> {
        Cp1bst1cmp0W::new(self, 18)
    }
    #[doc = "Bit 19 - Capture 1 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp1(&mut self) -> Cp1bst1cmp1W<St0cap1trgSpec> {
        Cp1bst1cmp1W::new(self, 19)
    }
    #[doc = "Bit 20 - Capture 1 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2a(&mut self) -> Cp1bst2aW<St0cap1trgSpec> {
        Cp1bst2aW::new(self, 20)
    }
    #[doc = "Bit 21 - Capture 1 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2na(&mut self) -> Cp1bst2naW<St0cap1trgSpec> {
        Cp1bst2naW::new(self, 21)
    }
    #[doc = "Bit 22 - Capture 1 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp0(&mut self) -> Cp1bst2cmp0W<St0cap1trgSpec> {
        Cp1bst2cmp0W::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 1 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp1(&mut self) -> Cp1bst2cmp1W<St0cap1trgSpec> {
        Cp1bst2cmp1W::new(self, 23)
    }
    #[doc = "Bit 24 - Capture 1 triggered by ST3CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3a(&mut self) -> Cp1bst3aW<St0cap1trgSpec> {
        Cp1bst3aW::new(self, 24)
    }
    #[doc = "Bit 25 - Capture 1 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3na(&mut self) -> Cp1bst3naW<St0cap1trgSpec> {
        Cp1bst3naW::new(self, 25)
    }
    #[doc = "Bit 26 - Capture 1 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3cmp0(&mut self) -> Cp1bst3cmp0W<St0cap1trgSpec> {
        Cp1bst3cmp0W::new(self, 26)
    }
    #[doc = "Bit 27 - Capture 1 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3cmp1(&mut self) -> Cp1bst3cmp1W<St0cap1trgSpec> {
        Cp1bst3cmp1W::new(self, 27)
    }
    #[doc = "Bit 28 - Capture 1 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4a(&mut self) -> Cp1bst4aW<St0cap1trgSpec> {
        Cp1bst4aW::new(self, 28)
    }
    #[doc = "Bit 29 - Capture 1 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4na(&mut self) -> Cp1bst4naW<St0cap1trgSpec> {
        Cp1bst4naW::new(self, 29)
    }
    #[doc = "Bit 30 - Capture 1 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp0(&mut self) -> Cp1bst4cmp0W<St0cap1trgSpec> {
        Cp1bst4cmp0W::new(self, 30)
    }
    #[doc = "Bit 31 - Capture 1 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp1(&mut self) -> Cp1bst4cmp1W<St0cap1trgSpec> {
