...
impl R {
    ...
    #[inline(always)]
    pub fn ften20(&self) -> FTEN20_R {
        FTEN20_R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ften20(&mut self) -> FTEN20_W<FTEN_SPEC, 20> {
        FTEN20_W::new(self)
    }
    #[doc = "Bit 21 - Falling edge trigger enable of line 21"]
    #[inline(always)]
