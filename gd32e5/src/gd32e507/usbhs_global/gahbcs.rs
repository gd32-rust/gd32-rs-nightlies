...
pub type BURST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
impl R {
    ...
    pub fn burst(&self) -> BURST_R {
        BURST_R::new(((self.bits >> 1) & 0x0f) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn burst(&mut self) -> BURST_W<GAHBCS_SPEC, 1> {
        BURST_W::new(self)
    }
    #[doc = "Bit 5 - DMA function Enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaen(&mut self) -> DMAEN_W<GAHBCS_SPEC, 5> {
        DMAEN_W::new(self)
    }
    #[doc = "Bit 7 - Tx FIFO threshold"]
    #[inline(always)]
