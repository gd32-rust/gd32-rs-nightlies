...
pub type PLLUSBSTBIF_R = crate::BitReader;
...
pub type PLLUSBSTBIE_R = crate::BitReader;
#[doc = "Field `PLLUSBSTBIE` writer - PLLUSB stabilization interrupt enable"]
pub type PLLUSBSTBIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PLLUSBSTBIC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    ...
    #[inline(always)]
    pub fn pllusbstbif(&self) -> PLLUSBSTBIF_R {
        PLLUSBSTBIF_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn pllusbstbie(&self) -> PLLUSBSTBIE_R {
        PLLUSBSTBIE_R::new(((self.bits >> 15) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 14 - Internal 48 MHz RC oscillator Stabilization Interrupt Enable"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllusbstbie(&mut self) -> PLLUSBSTBIE_W<ADDINT_SPEC, 15> {
        PLLUSBSTBIE_W::new(self)
    }
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllusbstbic(&mut self) -> PLLUSBSTBIC_W<ADDINT_SPEC, 23> {
        PLLUSBSTBIC_W::new(self)
    }
