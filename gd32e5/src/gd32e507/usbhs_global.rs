...
pub mod cid;
#[doc = "GLPMCFG (rw) register accessor: Global core LPM configuration register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`glpmcfg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`glpmcfg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`glpmcfg`]
module"]
pub type GLPMCFG = crate::Reg<glpmcfg::GLPMCFG_SPEC>;
#[doc = "Global core LPM configuration register"]
pub mod glpmcfg;
#[doc = "PWRD (rw) register accessor: Power down register (USBHS_PWRD)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pwrd::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pwrd::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`pwrd`]
module"]
pub type PWRD = crate::Reg<pwrd::PWRD_SPEC>;
#[doc = "Power down register (USBHS_PWRD)"]
pub mod pwrd;
#[doc = "ADPCTL (rw) register accessor: ADP control andstatus register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`adpctl::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`adpctl::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`adpctl`]
module"]
pub type ADPCTL = crate::Reg<adpctl::ADPCTL_SPEC>;
