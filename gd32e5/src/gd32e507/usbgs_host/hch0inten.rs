...
pub type DMAERIE_R = crate::BitReader;
#[doc = "Field `DMAERIE` writer - DMA Error interrupt enable"]
pub type DMAERIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type NYETIE_R = crate::BitReader;
#[doc = "Field `NYETIE` writer - NYET interrupt enable"]
pub type NYETIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn dmaerie(&self) -> DMAERIE_R {
        DMAERIE_R::new(((self.bits >> 2) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn nyetie(&self) -> NYETIE_R {
        NYETIE_R::new(((self.bits >> 6) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfie(&mut self) -> TFIE_W<HCH0INTEN_SPEC, 0> {
        TFIE_W::new(self)
    }
    #[doc = "Bit 1 - Channel halted interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn chie(&mut self) -> CHIE_W<HCH0INTEN_SPEC, 1> {
        CHIE_W::new(self)
    }
    #[doc = "Bit 2 - DMA Error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dmaerie(&mut self) -> DMAERIE_W<HCH0INTEN_SPEC, 2> {
        DMAERIE_W::new(self)
    }
    #[doc = "Bit 3 - STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn stallie(&mut self) -> STALLIE_W<HCH0INTEN_SPEC, 3> {
        STALLIE_W::new(self)
    }
    #[doc = "Bit 4 - NAK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn nakie(&mut self) -> NAKIE_W<HCH0INTEN_SPEC, 4> {
        NAKIE_W::new(self)
    }
    #[doc = "Bit 5 - ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ackie(&mut self) -> ACKIE_W<HCH0INTEN_SPEC, 5> {
        ACKIE_W::new(self)
    }
    #[doc = "Bit 6 - NYET interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn nyetie(&mut self) -> NYETIE_W<HCH0INTEN_SPEC, 6> {
        NYETIE_W::new(self)
    }
    #[doc = "Bit 7 - USB bus error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn usberie(&mut self) -> USBERIE_W<HCH0INTEN_SPEC, 7> {
        USBERIE_W::new(self)
    }
    #[doc = "Bit 8 - Babble error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn bberie(&mut self) -> BBERIE_W<HCH0INTEN_SPEC, 8> {
        BBERIE_W::new(self)
    }
    #[doc = "Bit 9 - request queue overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reqovrie(&mut self) -> REQOVRIE_W<HCH0INTEN_SPEC, 9> {
        REQOVRIE_W::new(self)
    }
    #[doc = "Bit 10 - Data toggle error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterie(&mut self) -> DTERIE_W<HCH0INTEN_SPEC, 10> {
        DTERIE_W::new(self)
    }
