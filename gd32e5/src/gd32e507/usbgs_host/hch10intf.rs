...
pub type R = crate::R<HCH10INTF_SPEC>;
#[doc = "Register `HCH10INTF` writer"]
pub type W = crate::W<HCH10INTF_SPEC>;
...
pub type DMAER_R = crate::BitReader;
#[doc = "Field `DMAER` writer - DMA Error"]
pub type DMAER_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl R {
    ...
    #[doc = "Bit 2 - DMA Error"]
    #[inline(always)]
    pub fn dmaer(&self) -> DMAER_R {
        DMAER_R::new(((self.bits >> 2) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<HCH10INTF_SPEC, 0> {
        TF_W::new(self)
    }
    #[doc = "Bit 1 - Channel halted"]
    #[inline(always)]
    #[must_use]
    pub fn ch(&mut self) -> CH_W<HCH10INTF_SPEC, 1> {
        CH_W::new(self)
    }
    #[doc = "Bit 2 - DMA Error"]
    #[inline(always)]
    #[must_use]
    pub fn dmaer(&mut self) -> DMAER_W<HCH10INTF_SPEC, 2> {
        DMAER_W::new(self)
    }
    #[doc = "Bit 3 - STALL response received interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<HCH10INTF_SPEC, 3> {
        STALL_W::new(self)
    }
    #[doc = "Bit 4 - NAK response received interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<HCH10INTF_SPEC, 4> {
        NAK_W::new(self)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ack(&mut self) -> ACK_W<HCH10INTF_SPEC, 5> {
        ACK_W::new(self)
    }
    #[doc = "Bit 6 - NYET"]
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<HCH10INTF_SPEC, 6> {
        NYET_W::new(self)
    }
    #[doc = "Bit 7 - USB bus error"]
    #[inline(always)]
    #[must_use]
    pub fn usber(&mut self) -> USBER_W<HCH10INTF_SPEC, 7> {
        USBER_W::new(self)
    }
    #[doc = "Bit 8 - Babble error"]
    #[inline(always)]
    #[must_use]
    pub fn bber(&mut self) -> BBER_W<HCH10INTF_SPEC, 8> {
        BBER_W::new(self)
    }
    #[doc = "Bit 9 - Request queue overrun"]
    #[inline(always)]
    #[must_use]
    pub fn reqovr(&mut self) -> REQOVR_W<HCH10INTF_SPEC, 9> {
        REQOVR_W::new(self)
    }
    #[doc = "Bit 10 - Data toggle error"]
    #[inline(always)]
    #[must_use]
    pub fn dter(&mut self) -> DTER_W<HCH10INTF_SPEC, 10> {
        DTER_W::new(self)
    }
...
#[doc = "host channel-10 interrupt register (HCH10INTF)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hch10intf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hch10intf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCH10INTF_SPEC;
impl crate::RegisterSpec for HCH10INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch10intf::R`](R) reader structure"]
impl crate::Readable for HCH10INTF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch10intf::W`](W) writer structure"]
impl crate::Writable for HCH10INTF_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH10INTF to value 0"]
impl crate::Resettable for HCH10INTF_SPEC {
