...
pub type R = crate::R<HCH10CTL_SPEC>;
#[doc = "Register `HCH10CTL` writer"]
pub type W = crate::W<HCH10CTL_SPEC>;
...
pub type MPC_R = crate::FieldReader;
#[doc = "Field `MPC` writer - Multiple Packet Count"]
pub type MPC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl R {
    ...
    pub fn mpc(&self) -> MPC_R {
        MPC_R::new(((self.bits >> 20) & 3) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mpl(&mut self) -> MPL_W<HCH10CTL_SPEC, 0> {
        MPL_W::new(self)
    }
    #[doc = "Bits 11:14 - Endpoint number"]
    #[inline(always)]
    #[must_use]
    pub fn epnum(&mut self) -> EPNUM_W<HCH10CTL_SPEC, 11> {
        EPNUM_W::new(self)
    }
    #[doc = "Bit 15 - Endpoint direction"]
    #[inline(always)]
    #[must_use]
    pub fn epdir(&mut self) -> EPDIR_W<HCH10CTL_SPEC, 15> {
        EPDIR_W::new(self)
    }
    #[doc = "Bit 17 - Low-speed device"]
    #[inline(always)]
    #[must_use]
    pub fn lsd(&mut self) -> LSD_W<HCH10CTL_SPEC, 17> {
        LSD_W::new(self)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    #[must_use]
    pub fn eptype(&mut self) -> EPTYPE_W<HCH10CTL_SPEC, 18> {
        EPTYPE_W::new(self)
    }
    #[doc = "Bits 20:21 - Multiple Packet Count"]
    #[inline(always)]
    #[must_use]
    pub fn mpc(&mut self) -> MPC_W<HCH10CTL_SPEC, 20> {
        MPC_W::new(self)
    }
    #[doc = "Bits 22:28 - Device address"]
    #[inline(always)]
    #[must_use]
    pub fn dar(&mut self) -> DAR_W<HCH10CTL_SPEC, 22> {
        DAR_W::new(self)
    }
    #[doc = "Bit 29 - Odd frame"]
    #[inline(always)]
    #[must_use]
    pub fn oddfrm(&mut self) -> ODDFRM_W<HCH10CTL_SPEC, 29> {
        ODDFRM_W::new(self)
    }
    #[doc = "Bit 30 - Channel disable"]
    #[inline(always)]
    #[must_use]
    pub fn cdis(&mut self) -> CDIS_W<HCH10CTL_SPEC, 30> {
        CDIS_W::new(self)
    }
    #[doc = "Bit 31 - Channel enable"]
    #[inline(always)]
    #[must_use]
    pub fn cen(&mut self) -> CEN_W<HCH10CTL_SPEC, 31> {
        CEN_W::new(self)
    }
...
#[doc = "host channel-10 characteristics register (HCH10CTL)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hch10ctl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hch10ctl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCH10CTL_SPEC;
impl crate::RegisterSpec for HCH10CTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch10ctl::R`](R) reader structure"]
impl crate::Readable for HCH10CTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch10ctl::W`](W) writer structure"]
impl crate::Writable for HCH10CTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH10CTL to value 0"]
impl crate::Resettable for HCH10CTL_SPEC {
