...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tlen(&mut self) -> TLEN_W<HCH6LEN_SPEC, 0> {
        TLEN_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt(&mut self) -> PCNT_W<HCH6LEN_SPEC, 19> {
        PCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    #[must_use]
    pub fn dpid(&mut self) -> DPID_W<HCH6LEN_SPEC, 29> {
        DPID_W::new(self)
    }
    #[doc = "Bit 31 - PING token request"]
    #[inline(always)]
    #[must_use]
    pub fn ping(&mut self) -> PING_W<HCH6LEN_SPEC, 31> {
        PING_W::new(self)
    }
