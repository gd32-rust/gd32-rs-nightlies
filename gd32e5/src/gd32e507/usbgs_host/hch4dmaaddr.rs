...
pub type R = crate::R<HCH4DMAADDR_SPEC>;
#[doc = "Register `HCH4DMAADDR` writer"]
pub type W = crate::W<HCH4DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<HCH4DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct HCH4DMAADDR_SPEC;
impl crate::RegisterSpec for HCH4DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch4dmaaddr::R`](R) reader structure"]
impl crate::Readable for HCH4DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch4dmaaddr::W`](W) writer structure"]
impl crate::Writable for HCH4DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH4DMAADDR to value 0"]
impl crate::Resettable for HCH4DMAADDR_SPEC {
