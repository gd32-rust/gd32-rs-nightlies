...
pub type R = crate::R<HCH11LEN_SPEC>;
#[doc = "Register `HCH11LEN` writer"]
pub type W = crate::W<HCH11LEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tlen(&mut self) -> TLEN_W<HCH11LEN_SPEC, 0> {
        TLEN_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt(&mut self) -> PCNT_W<HCH11LEN_SPEC, 19> {
        PCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    #[must_use]
    pub fn dpid(&mut self) -> DPID_W<HCH11LEN_SPEC, 29> {
        DPID_W::new(self)
    }
    #[doc = "Bit 31 - PING token request"]
    #[inline(always)]
    #[must_use]
    pub fn ping(&mut self) -> PING_W<HCH11LEN_SPEC, 31> {
        PING_W::new(self)
    }
...
pub struct HCH11LEN_SPEC;
impl crate::RegisterSpec for HCH11LEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch11len::R`](R) reader structure"]
impl crate::Readable for HCH11LEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch11len::W`](W) writer structure"]
impl crate::Writable for HCH11LEN_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH11LEN to value 0"]
impl crate::Resettable for HCH11LEN_SPEC {
