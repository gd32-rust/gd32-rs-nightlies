...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0p(&mut self) -> Ch0pW<St1choctlSpec> {
        Ch0pW::new(self, 1)
    }
    #[doc = "Bit 2 - Channel 0 IDLE state enable in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch0ien(&mut self) -> Bmch0ienW<St1choctlSpec> {
        Bmch0ienW::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 0 output idle state"]
    #[inline(always)]
    #[must_use]
    pub fn iso0(&mut self) -> Iso0W<St1choctlSpec> {
        Iso0W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Channel 0 Fault output state"]
    #[inline(always)]
    #[must_use]
    pub fn ch0fltos(&mut self) -> Ch0fltosW<St1choctlSpec> {
        Ch0fltosW::new(self, 4)
    }
    #[doc = "Bit 6 - Channel 0 carrier-signal mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0csen(&mut self) -> Ch0csenW<St1choctlSpec> {
        Ch0csenW::new(self, 6)
    }
    #[doc = "Bit 7 - Channel 0 dead-time insert in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch0dti(&mut self) -> Bmch0dtiW<St1choctlSpec> {
        Bmch0dtiW::new(self, 7)
    }
    #[doc = "Bit 8 - Dead time enable"]
    #[inline(always)]
    #[must_use]
    pub fn dten(&mut self) -> DtenW<St1choctlSpec> {
        DtenW::new(self, 8)
    }
    #[doc = "Bit 9 - Delayed IDLE state mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyismen(&mut self) -> DlyismenW<St1choctlSpec> {
        DlyismenW::new(self, 9)
    }
    #[doc = "Bits 10:12 - Delayed IDLE source and channel"]
    #[inline(always)]
    #[must_use]
    pub fn dlyisch(&mut self) -> DlyischW<St1choctlSpec> {
        DlyischW::new(self, 10)
    }
    #[doc = "Bit 17 - Channel 1 output polarity"]
    #[inline(always)]
    #[must_use]
    pub fn ch1p(&mut self) -> Ch1pW<St1choctlSpec> {
        Ch1pW::new(self, 17)
    }
    #[doc = "Bit 18 - Channel 1 IDLE state enable in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch1ien(&mut self) -> Bmch1ienW<St1choctlSpec> {
        Bmch1ienW::new(self, 18)
    }
    #[doc = "Bit 19 - channel 1 output idle state"]
    #[inline(always)]
    #[must_use]
    pub fn iso1(&mut self) -> Iso1W<St1choctlSpec> {
        Iso1W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Channel 1 Fault output state"]
    #[inline(always)]
    #[must_use]
    pub fn ch1fltos(&mut self) -> Ch1fltosW<St1choctlSpec> {
        Ch1fltosW::new(self, 20)
    }
    #[doc = "Bit 22 - Channel 1 carrier-signal mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1csen(&mut self) -> Ch1csenW<St1choctlSpec> {
        Ch1csenW::new(self, 22)
    }
    #[doc = "Bit 23 - Channel 1 dead-time insert in bunch mode"]
    #[inline(always)]
    #[must_use]
    pub fn bmch1dti(&mut self) -> Bmch1dtiW<St1choctlSpec> {
