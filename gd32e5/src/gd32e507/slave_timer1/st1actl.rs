...
pub type R = crate::R<ST1ACTL_SPEC>;
#[doc = "Register `ST1ACTL` writer"]
pub type W = crate::W<ST1ACTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntckdiv_3(&mut self) -> CNTCKDIV_3_W<ST1ACTL_SPEC, 3> {
        CNTCKDIV_3_W::new(self)
    }
    #[doc = "Bits 9:15 - Rising edge dead-time value configure"]
    #[inline(always)]
    #[must_use]
    pub fn dtrcfg_15_9(&mut self) -> DTRCFG_15_9_W<ST1ACTL_SPEC, 9> {
        DTRCFG_15_9_W::new(self)
    }
    #[doc = "Bits 25:31 - Falling edge dead-time value configure"]
    #[inline(always)]
    #[must_use]
    pub fn dtfcfg_15_9(&mut self) -> DTFCFG_15_9_W<ST1ACTL_SPEC, 25> {
...
pub struct ST1ACTL_SPEC;
impl crate::RegisterSpec for ST1ACTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1actl::R`](R) reader structure"]
impl crate::Readable for ST1ACTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st1actl::W`](W) writer structure"]
impl crate::Writable for ST1ACTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST1ACTL to value 0"]
impl crate::Resettable for ST1ACTL_SPEC {
