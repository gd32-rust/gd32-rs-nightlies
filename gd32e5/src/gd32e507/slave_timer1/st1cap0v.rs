...
pub type R = crate::R<ST1CAP0V_SPEC>;
#[doc = "Register `ST1CAP0V` writer"]
pub type W = crate::W<ST1CAP0V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cap0val(&mut self) -> CAP0VAL_W<ST1CAP0V_SPEC, 0> {
        CAP0VAL_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMER1 capture 0 value register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st1cap0v::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st1cap0v::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST1CAP0V_SPEC;
impl crate::RegisterSpec for ST1CAP0V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1cap0v::R`](R) reader structure"]
impl crate::Readable for ST1CAP0V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st1cap0v::W`](W) writer structure"]
impl crate::Writable for ST1CAP0V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST1CAP0V to value 0"]
impl crate::Resettable for ST1CAP0V_SPEC {
