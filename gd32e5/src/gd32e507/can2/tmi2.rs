...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ten(&mut self) -> TEN_W<TMI2_SPEC, 0> {
        TEN_W::new(self)
    }
    #[doc = "Bit 1 - Frame type"]
    #[inline(always)]
    #[must_use]
    pub fn ft(&mut self) -> FT_W<TMI2_SPEC, 1> {
        FT_W::new(self)
    }
    #[doc = "Bit 2 - Frame format"]
    #[inline(always)]
    #[must_use]
    pub fn ff(&mut self) -> FF_W<TMI2_SPEC, 2> {
        FF_W::new(self)
    }
    #[doc = "Bits 3:20 - The frame identifier"]
    #[inline(always)]
    #[must_use]
    pub fn efid(&mut self) -> EFID_W<TMI2_SPEC, 3> {
        EFID_W::new(self)
    }
    #[doc = "Bits 21:31 - The frame identifier"]
    #[inline(always)]
    #[must_use]
    pub fn sfid_efid(&mut self) -> SFID_EFID_W<TMI2_SPEC, 21> {
