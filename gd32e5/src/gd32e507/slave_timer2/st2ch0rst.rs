...
pub type R = crate::R<ST2CH0RST_SPEC>;
#[doc = "Register `ST2CH0RST` writer"]
pub type W = crate::W<ST2CH0RST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0rssev(&mut self) -> CH0RSSEV_W<ST2CH0RST_SPEC, 0> {
        CH0RSSEV_W::new(self)
    }
    #[doc = "Bit 1 - Slave_TIMERx reset event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsrst(&mut self) -> CH0RSRST_W<ST2CH0RST_SPEC, 1> {
        CH0RSRST_W::new(self)
    }
    #[doc = "Bit 2 - Slave_TIMERx period event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsper(&mut self) -> CH0RSPER_W<ST2CH0RST_SPEC, 2> {
        CH0RSPER_W::new(self)
    }
    #[doc = "Bit 3 - Slave_TIMERx compare 0 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp0(&mut self) -> CH0RSCMP0_W<ST2CH0RST_SPEC, 3> {
        CH0RSCMP0_W::new(self)
    }
    #[doc = "Bit 4 - Slave_TIMERx compare 1 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp1(&mut self) -> CH0RSCMP1_W<ST2CH0RST_SPEC, 4> {
        CH0RSCMP1_W::new(self)
    }
    #[doc = "Bit 5 - Slave_TIMER1 compare 2 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp2(&mut self) -> CH0RSCMP2_W<ST2CH0RST_SPEC, 5> {
        CH0RSCMP2_W::new(self)
    }
    #[doc = "Bit 6 - Slave_TIMERx compare 3 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp3(&mut self) -> CH0RSCMP3_W<ST2CH0RST_SPEC, 6> {
        CH0RSCMP3_W::new(self)
    }
    #[doc = "Bit 7 - Master_TIMER period event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtper(&mut self) -> CH0RSMTPER_W<ST2CH0RST_SPEC, 7> {
        CH0RSMTPER_W::new(self)
    }
    #[doc = "Bit 8 - Master_TIMER compare 0 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp0(&mut self) -> CH0RSMTCMP0_W<ST2CH0RST_SPEC, 8> {
        CH0RSMTCMP0_W::new(self)
    }
    #[doc = "Bit 9 - Master_TIMER compare 1 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp1(&mut self) -> CH0RSMTCMP1_W<ST2CH0RST_SPEC, 9> {
        CH0RSMTCMP1_W::new(self)
    }
    #[doc = "Bit 10 - Master_TIMER compare 2 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp2(&mut self) -> CH0RSMTCMP2_W<ST2CH0RST_SPEC, 10> {
        CH0RSMTCMP2_W::new(self)
    }
    #[doc = "Bit 11 - Master_TIMER compare 3 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp3(&mut self) -> CH0RSMTCMP3_W<ST2CH0RST_SPEC, 11> {
        CH0RSMTCMP3_W::new(self)
    }
    #[doc = "Bit 12 - Slave_TIMER1 interconnection event 0 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev0(&mut self) -> CH0RSSTEV0_W<ST2CH0RST_SPEC, 12> {
        CH0RSSTEV0_W::new(self)
    }
    #[doc = "Bit 13 - Slave_TIMERx interconnection event 1 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev1(&mut self) -> CH0RSSTEV1_W<ST2CH0RST_SPEC, 13> {
        CH0RSSTEV1_W::new(self)
    }
    #[doc = "Bit 14 - Slave_TIMERx interconnection event 2 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev2(&mut self) -> CH0RSSTEV2_W<ST2CH0RST_SPEC, 14> {
        CH0RSSTEV2_W::new(self)
    }
    #[doc = "Bit 15 - Slave_TIMERx interconnection event 3 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev3(&mut self) -> CH0RSSTEV3_W<ST2CH0RST_SPEC, 15> {
        CH0RSSTEV3_W::new(self)
    }
    #[doc = "Bit 16 - Slave_TIMER1 interconnection event 4 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev4(&mut self) -> CH0RSSTEV4_W<ST2CH0RST_SPEC, 16> {
        CH0RSSTEV4_W::new(self)
    }
    #[doc = "Bit 17 - Slave_TIMERx interconnection event 5 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev5(&mut self) -> CH0RSSTEV5_W<ST2CH0RST_SPEC, 17> {
        CH0RSSTEV5_W::new(self)
    }
    #[doc = "Bit 18 - Slave_TIMERx interconnection event 6 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev6(&mut self) -> CH0RSSTEV6_W<ST2CH0RST_SPEC, 18> {
        CH0RSSTEV6_W::new(self)
    }
    #[doc = "Bit 19 - Slave_TIMERx interconnection event 7 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev7(&mut self) -> CH0RSSTEV7_W<ST2CH0RST_SPEC, 19> {
        CH0RSSTEV7_W::new(self)
    }
    #[doc = "Bit 20 - Slave_TIMERx interconnection event 8 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev8(&mut self) -> CH0RSSTEV8_W<ST2CH0RST_SPEC, 20> {
        CH0RSSTEV8_W::new(self)
    }
    #[doc = "Bit 21 - External event 0 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev0(&mut self) -> CH0RSEXEV0_W<ST2CH0RST_SPEC, 21> {
        CH0RSEXEV0_W::new(self)
    }
    #[doc = "Bit 22 - External event 1 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev1(&mut self) -> CH0RSEXEV1_W<ST2CH0RST_SPEC, 22> {
        CH0RSEXEV1_W::new(self)
    }
    #[doc = "Bit 23 - External event 2 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev2(&mut self) -> CH0RSEXEV2_W<ST2CH0RST_SPEC, 23> {
        CH0RSEXEV2_W::new(self)
    }
    #[doc = "Bit 24 - External event 3 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev3(&mut self) -> CH0RSEXEV3_W<ST2CH0RST_SPEC, 24> {
        CH0RSEXEV3_W::new(self)
    }
    #[doc = "Bit 25 - External event 4 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev4(&mut self) -> CH0RSEXEV4_W<ST2CH0RST_SPEC, 25> {
        CH0RSEXEV4_W::new(self)
    }
    #[doc = "Bit 26 - External event 5 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev5(&mut self) -> CH0RSEXEV5_W<ST2CH0RST_SPEC, 26> {
        CH0RSEXEV5_W::new(self)
    }
    #[doc = "Bit 27 - External event 6 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev6(&mut self) -> CH0RSEXEV6_W<ST2CH0RST_SPEC, 27> {
        CH0RSEXEV6_W::new(self)
    }
    #[doc = "Bit 28 - External event 7 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev7(&mut self) -> CH0RSEXEV7_W<ST2CH0RST_SPEC, 28> {
        CH0RSEXEV7_W::new(self)
    }
    #[doc = "Bit 29 - External event 8 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev8(&mut self) -> CH0RSEXEV8_W<ST2CH0RST_SPEC, 29> {
        CH0RSEXEV8_W::new(self)
    }
    #[doc = "Bit 30 - External event 9 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev9(&mut self) -> CH0RSEXEV9_W<ST2CH0RST_SPEC, 30> {
        CH0RSEXEV9_W::new(self)
    }
    #[doc = "Bit 31 - Update event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsup(&mut self) -> CH0RSUP_W<ST2CH0RST_SPEC, 31> {
        CH0RSUP_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMERx channel 0 reset request register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st2ch0rst::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st2ch0rst::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST2CH0RST_SPEC;
impl crate::RegisterSpec for ST2CH0RST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2ch0rst::R`](R) reader structure"]
impl crate::Readable for ST2CH0RST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st2ch0rst::W`](W) writer structure"]
impl crate::Writable for ST2CH0RST_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2CH0RST to value 0"]
impl crate::Resettable for ST2CH0RST_SPEC {
