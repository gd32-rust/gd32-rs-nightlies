...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bsw(&mut self) -> Cp0bswW<St2cap0trgSpec> {
        Cp0bswW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture 0 triggered by update event"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bup(&mut self) -> Cp0bupW<St2cap0trgSpec> {
        Cp0bupW::new(self, 1)
    }
    #[doc = "Bit 2 - Capture 0 triggered by external event 0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev0(&mut self) -> Cp0bexev0W<St2cap0trgSpec> {
        Cp0bexev0W::new(self, 2)
    }
    #[doc = "Bit 3 - Capture 0 triggered by external event 1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev1(&mut self) -> Cp0bexev1W<St2cap0trgSpec> {
        Cp0bexev1W::new(self, 3)
    }
    #[doc = "Bit 4 - Capture 0 triggered by external event 2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev2(&mut self) -> Cp0bexev2W<St2cap0trgSpec> {
        Cp0bexev2W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture 0 triggered by external event 3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev3(&mut self) -> Cp0bexev3W<St2cap0trgSpec> {
        Cp0bexev3W::new(self, 5)
    }
    #[doc = "Bit 6 - Capture 0 triggered by external event 4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev4(&mut self) -> Cp0bexev4W<St2cap0trgSpec> {
        Cp0bexev4W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture 0 triggered by external event 5"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev5(&mut self) -> Cp0bexev5W<St2cap0trgSpec> {
        Cp0bexev5W::new(self, 7)
    }
    #[doc = "Bit 8 - Capture 0 triggered by external event 6"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev6(&mut self) -> Cp0bexev6W<St2cap0trgSpec> {
        Cp0bexev6W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture 0 triggered by external event 7"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev7(&mut self) -> Cp0bexev7W<St2cap0trgSpec> {
        Cp0bexev7W::new(self, 9)
    }
    #[doc = "Bit 10 - Capture 0 triggered by external event 8"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev8(&mut self) -> Cp0bexev8W<St2cap0trgSpec> {
        Cp0bexev8W::new(self, 10)
    }
    #[doc = "Bit 11 - Capture 0 triggered by external event 9"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev9(&mut self) -> Cp0bexev9W<St2cap0trgSpec> {
        Cp0bexev9W::new(self, 11)
    }
    #[doc = "Bit 12 - Capture 0 triggered by ST0CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0a(&mut self) -> Cp0bst0aW<St2cap0trgSpec> {
        Cp0bst0aW::new(self, 12)
    }
    #[doc = "Bit 13 - Capture 0 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0na(&mut self) -> Cp0bst0naW<St2cap0trgSpec> {
        Cp0bst0naW::new(self, 13)
    }
    #[doc = "Bit 14 - Capture 0 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp0(&mut self) -> Cp0bst0cmp0W<St2cap0trgSpec> {
        Cp0bst0cmp0W::new(self, 14)
    }
    #[doc = "Bit 15 - Capture 0 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp1(&mut self) -> Cp0bst0cmp1W<St2cap0trgSpec> {
        Cp0bst0cmp1W::new(self, 15)
    }
    #[doc = "Bit 16 - Capture 0 triggered by ST2CH1_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1a(&mut self) -> Cp0bst1aW<St2cap0trgSpec> {
        Cp0bst1aW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture 0 triggered by ST2CH1_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1na(&mut self) -> Cp0bst1naW<St2cap0trgSpec> {
        Cp0bst1naW::new(self, 17)
    }
    #[doc = "Bit 18 - Capture 0 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1cmp0(&mut self) -> Cp0bst1cmp0W<St2cap0trgSpec> {
        Cp0bst1cmp0W::new(self, 18)
    }
    #[doc = "Bit 19 - Capture 0 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1cmp1(&mut self) -> Cp0bst1cmp1W<St2cap0trgSpec> {
        Cp0bst1cmp1W::new(self, 19)
    }
    #[doc = "Bit 24 - Capture 0 triggered by ST3CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3a(&mut self) -> Cp0bst3aW<St2cap0trgSpec> {
        Cp0bst3aW::new(self, 24)
    }
    #[doc = "Bit 25 - Capture 0 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3na(&mut self) -> Cp0bst3naW<St2cap0trgSpec> {
        Cp0bst3naW::new(self, 25)
    }
    #[doc = "Bit 26 - Capture 0 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp0(&mut self) -> Cp0bst3cmp0W<St2cap0trgSpec> {
        Cp0bst3cmp0W::new(self, 26)
    }
    #[doc = "Bit 27 - Capture 0 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp1(&mut self) -> Cp0bst3cmp1W<St2cap0trgSpec> {
        Cp0bst3cmp1W::new(self, 27)
    }
    #[doc = "Bit 28 - Capture 0 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4a(&mut self) -> Cp0bst4aW<St2cap0trgSpec> {
        Cp0bst4aW::new(self, 28)
    }
    #[doc = "Bit 29 - Capture 0 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4na(&mut self) -> Cp0bst4naW<St2cap0trgSpec> {
        Cp0bst4naW::new(self, 29)
    }
    #[doc = "Bit 30 - Capture 0 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp0(&mut self) -> Cp0bst4cmp0W<St2cap0trgSpec> {
        Cp0bst4cmp0W::new(self, 30)
    }
    #[doc = "Bit 31 - Capture 0 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp1(&mut self) -> Cp0bst4cmp1W<St2cap0trgSpec> {
