...
pub type W = crate::W<ST2INTC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0ifc(&mut self) -> CMP0IFC_W<ST2INTC_SPEC, 0> {
        CMP0IFC_W::new(self)
    }
    #[doc = "Bit 1 - Clear compare 1 interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1ifc(&mut self) -> CMP1IFC_W<ST2INTC_SPEC, 1> {
        CMP1IFC_W::new(self)
    }
    #[doc = "Bit 2 - Clear compare 2 interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2ifc(&mut self) -> CMP2IFC_W<ST2INTC_SPEC, 2> {
        CMP2IFC_W::new(self)
    }
    #[doc = "Bit 3 - Clear compare 3 interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3ifc(&mut self) -> CMP3IFC_W<ST2INTC_SPEC, 3> {
        CMP3IFC_W::new(self)
    }
    #[doc = "Bit 4 - Clear repetition interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn repifc(&mut self) -> REPIFC_W<ST2INTC_SPEC, 4> {
        REPIFC_W::new(self)
    }
    #[doc = "Bit 6 - Clear update interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn upifc(&mut self) -> UPIFC_W<ST2INTC_SPEC, 6> {
        UPIFC_W::new(self)
    }
    #[doc = "Bit 7 - Clear capture 0 interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn cap0ifc(&mut self) -> CAP0IFC_W<ST2INTC_SPEC, 7> {
        CAP0IFC_W::new(self)
    }
    #[doc = "Bit 8 - Clear capture 1 interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn cap1ifc(&mut self) -> CAP1IFC_W<ST2INTC_SPEC, 8> {
        CAP1IFC_W::new(self)
    }
    #[doc = "Bit 9 - Clear channel 0 output active interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ch0oaifc(&mut self) -> CH0OAIFC_W<ST2INTC_SPEC, 9> {
        CH0OAIFC_W::new(self)
    }
    #[doc = "Bit 10 - Clear channel 0 output inactive interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ch0onaifc(&mut self) -> CH0ONAIFC_W<ST2INTC_SPEC, 10> {
        CH0ONAIFC_W::new(self)
    }
    #[doc = "Bit 11 - Clear channel 1 output active interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ch1oaifc(&mut self) -> CH1OAIFC_W<ST2INTC_SPEC, 11> {
        CH1OAIFC_W::new(self)
    }
    #[doc = "Bit 12 - Clear channel 1 output inactive interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn ch1onaifc(&mut self) -> CH1ONAIFC_W<ST2INTC_SPEC, 12> {
        CH1ONAIFC_W::new(self)
    }
    #[doc = "Bit 13 - Clear counter reset interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn rstifc(&mut self) -> RSTIFC_W<ST2INTC_SPEC, 13> {
        RSTIFC_W::new(self)
    }
    #[doc = "Bit 14 - Clear delayed IDLE mode entry interrupt flag"]
    #[inline(always)]
    #[must_use]
    pub fn dlyiifc(&mut self) -> DLYIIFC_W<ST2INTC_SPEC, 14> {
        DLYIIFC_W::new(self)
    }
...
pub struct ST2INTC_SPEC;
impl crate::RegisterSpec for ST2INTC_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [`st2intc::W`](W) writer structure"]
impl crate::Writable for ST2INTC_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2INTC to value 0"]
impl crate::Resettable for ST2INTC_SPEC {
