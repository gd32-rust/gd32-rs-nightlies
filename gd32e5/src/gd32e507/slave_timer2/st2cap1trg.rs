...
pub type R = crate::R<ST2CAP1TRG_SPEC>;
#[doc = "Register `ST2CAP1TRG` writer"]
pub type W = crate::W<ST2CAP1TRG_SPEC>;
...
impl R {
    ...
    #[inline(always)]
    pub fn cp1bst0a(&self) -> CP1BST0A_R {
        CP1BST0A_R::new(((self.bits >> 12) & 1) != 0)
    }
    #[doc = "Bit 13 - Capture 1 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    pub fn cp1bst0na(&self) -> CP1BST0NA_R {
        CP1BST0NA_R::new(((self.bits >> 13) & 1) != 0)
    }
    #[doc = "Bit 14 - Capture 1 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    pub fn cp1bst0cmp0(&self) -> CP1BST0CMP0_R {
        CP1BST0CMP0_R::new(((self.bits >> 14) & 1) != 0)
    }
    #[doc = "Bit 15 - Capture 1 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    pub fn cp1bst0cmp1(&self) -> CP1BST0CMP1_R {
        CP1BST0CMP1_R::new(((self.bits >> 15) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bsw(&mut self) -> CP1BSW_W<ST2CAP1TRG_SPEC, 0> {
        CP1BSW_W::new(self)
    }
    #[doc = "Bit 1 - Capture 1 triggered by update event"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bup(&mut self) -> CP1BUP_W<ST2CAP1TRG_SPEC, 1> {
        CP1BUP_W::new(self)
    }
    #[doc = "Bit 2 - Capture 1 triggered by external event 0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev0(&mut self) -> CP1BEXEV0_W<ST2CAP1TRG_SPEC, 2> {
        CP1BEXEV0_W::new(self)
    }
    #[doc = "Bit 3 - Capture 1 triggered by external event 1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev1(&mut self) -> CP1BEXEV1_W<ST2CAP1TRG_SPEC, 3> {
        CP1BEXEV1_W::new(self)
    }
    #[doc = "Bit 4 - Capture 1 triggered by external event 2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev2(&mut self) -> CP1BEXEV2_W<ST2CAP1TRG_SPEC, 4> {
        CP1BEXEV2_W::new(self)
    }
    #[doc = "Bit 5 - Capture 1 triggered by external event 3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev3(&mut self) -> CP1BEXEV3_W<ST2CAP1TRG_SPEC, 5> {
        CP1BEXEV3_W::new(self)
    }
    #[doc = "Bit 6 - Capture 1 triggered by external event 4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev4(&mut self) -> CP1BEXEV4_W<ST2CAP1TRG_SPEC, 6> {
        CP1BEXEV4_W::new(self)
    }
    #[doc = "Bit 7 - Capture 1 triggered by external event 5"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev5(&mut self) -> CP1BEXEV5_W<ST2CAP1TRG_SPEC, 7> {
        CP1BEXEV5_W::new(self)
    }
    #[doc = "Bit 8 - Capture 1 triggered by external event 6"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev6(&mut self) -> CP1BEXEV6_W<ST2CAP1TRG_SPEC, 8> {
        CP1BEXEV6_W::new(self)
    }
    #[doc = "Bit 9 - Capture 1 triggered by external event 7"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev7(&mut self) -> CP1BEXEV7_W<ST2CAP1TRG_SPEC, 9> {
        CP1BEXEV7_W::new(self)
    }
    #[doc = "Bit 10 - Capture 1 triggered by external event 8"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev8(&mut self) -> CP1BEXEV8_W<ST2CAP1TRG_SPEC, 10> {
        CP1BEXEV8_W::new(self)
    }
    #[doc = "Bit 11 - Capture 1 triggered by external event 9"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bexev9(&mut self) -> CP1BEXEV9_W<ST2CAP1TRG_SPEC, 11> {
        CP1BEXEV9_W::new(self)
    }
    #[doc = "Bit 12 - Capture 1 triggered by ST0CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0a(&mut self) -> CP1BST0A_W<ST2CAP1TRG_SPEC, 12> {
        CP1BST0A_W::new(self)
    }
    #[doc = "Bit 13 - Capture 1 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0na(&mut self) -> CP1BST0NA_W<ST2CAP1TRG_SPEC, 13> {
        CP1BST0NA_W::new(self)
    }
    #[doc = "Bit 14 - Capture 1 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp0(&mut self) -> CP1BST0CMP0_W<ST2CAP1TRG_SPEC, 14> {
        CP1BST0CMP0_W::new(self)
    }
    #[doc = "Bit 15 - Capture 1 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp1(&mut self) -> CP1BST0CMP1_W<ST2CAP1TRG_SPEC, 15> {
        CP1BST0CMP1_W::new(self)
    }
    #[doc = "Bit 16 - Capture 1 triggered by ST2CH1_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1a(&mut self) -> CP1BST1A_W<ST2CAP1TRG_SPEC, 16> {
        CP1BST1A_W::new(self)
    }
    #[doc = "Bit 17 - Capture 1 triggered by ST2CH1_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1na(&mut self) -> CP1BST1NA_W<ST2CAP1TRG_SPEC, 17> {
        CP1BST1NA_W::new(self)
    }
    #[doc = "Bit 18 - Capture 1 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp0(&mut self) -> CP1BST1CMP0_W<ST2CAP1TRG_SPEC, 18> {
        CP1BST1CMP0_W::new(self)
    }
    #[doc = "Bit 19 - Capture 1 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp1(&mut self) -> CP1BST1CMP1_W<ST2CAP1TRG_SPEC, 19> {
        CP1BST1CMP1_W::new(self)
    }
    #[doc = "Bit 24 - Capture 1 triggered by ST3CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3a(&mut self) -> CP1BST3A_W<ST2CAP1TRG_SPEC, 24> {
        CP1BST3A_W::new(self)
    }
    #[doc = "Bit 25 - Capture 1 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3na(&mut self) -> CP1BST3NA_W<ST2CAP1TRG_SPEC, 25> {
        CP1BST3NA_W::new(self)
    }
    #[doc = "Bit 26 - Capture 1 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3cmp0(&mut self) -> CP1BST3CMP0_W<ST2CAP1TRG_SPEC, 26> {
        CP1BST3CMP0_W::new(self)
    }
    #[doc = "Bit 27 - Capture 1 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst3cmp1(&mut self) -> CP1BST3CMP1_W<ST2CAP1TRG_SPEC, 27> {
        CP1BST3CMP1_W::new(self)
    }
    #[doc = "Bit 28 - Capture 1 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4a(&mut self) -> CP1BST4A_W<ST2CAP1TRG_SPEC, 28> {
        CP1BST4A_W::new(self)
    }
    #[doc = "Bit 29 - Capture 1 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4na(&mut self) -> CP1BST4NA_W<ST2CAP1TRG_SPEC, 29> {
        CP1BST4NA_W::new(self)
    }
    #[doc = "Bit 30 - Capture 1 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp0(&mut self) -> CP1BST4CMP0_W<ST2CAP1TRG_SPEC, 30> {
        CP1BST4CMP0_W::new(self)
    }
    #[doc = "Bit 31 - Capture 1 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp1(&mut self) -> CP1BST4CMP1_W<ST2CAP1TRG_SPEC, 31> {
...
pub struct ST2CAP1TRG_SPEC;
impl crate::RegisterSpec for ST2CAP1TRG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2cap1trg::R`](R) reader structure"]
impl crate::Readable for ST2CAP1TRG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st2cap1trg::W`](W) writer structure"]
impl crate::Writable for ST2CAP1TRG_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2CAP1TRG to value 0"]
impl crate::Resettable for ST2CAP1TRG_SPEC {
