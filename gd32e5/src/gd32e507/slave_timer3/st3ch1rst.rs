...
pub type R = crate::R<ST3CH1RST_SPEC>;
#[doc = "Register `ST3CH1RST` writer"]
pub type W = crate::W<ST3CH1RST_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch1rssev(&mut self) -> CH1RSSEV_W<ST3CH1RST_SPEC, 0> {
        CH1RSSEV_W::new(self)
    }
    #[doc = "Bit 1 - Slave_TIMERx reset event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsrst(&mut self) -> CH1RSRST_W<ST3CH1RST_SPEC, 1> {
        CH1RSRST_W::new(self)
    }
    #[doc = "Bit 2 - Slave_TIMERx period event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsper(&mut self) -> CH1RSPER_W<ST3CH1RST_SPEC, 2> {
        CH1RSPER_W::new(self)
    }
    #[doc = "Bit 3 - Slave_TIMERx compare 0 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rscmp0(&mut self) -> CH1RSCMP0_W<ST3CH1RST_SPEC, 3> {
        CH1RSCMP0_W::new(self)
    }
    #[doc = "Bit 4 - Slave_TIMERx compare 1 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rscmp1(&mut self) -> CH1RSCMP1_W<ST3CH1RST_SPEC, 4> {
        CH1RSCMP1_W::new(self)
    }
    #[doc = "Bit 5 - Slave_TIMERx compare 2 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rscmp2(&mut self) -> CH1RSCMP2_W<ST3CH1RST_SPEC, 5> {
        CH1RSCMP2_W::new(self)
    }
    #[doc = "Bit 6 - Slave_TIMERx compare 3 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rscmp3(&mut self) -> CH1RSCMP3_W<ST3CH1RST_SPEC, 6> {
        CH1RSCMP3_W::new(self)
    }
    #[doc = "Bit 7 - Master_TIMER period event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsmtper(&mut self) -> CH1RSMTPER_W<ST3CH1RST_SPEC, 7> {
        CH1RSMTPER_W::new(self)
    }
    #[doc = "Bit 8 - Master_TIMER compare 0 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsmtcmp0(&mut self) -> CH1RSMTCMP0_W<ST3CH1RST_SPEC, 8> {
        CH1RSMTCMP0_W::new(self)
    }
    #[doc = "Bit 9 - Master_TIMER compare 1 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsmtcmp1(&mut self) -> CH1RSMTCMP1_W<ST3CH1RST_SPEC, 9> {
        CH1RSMTCMP1_W::new(self)
    }
    #[doc = "Bit 10 - Master_TIMER compare 2 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsmtcmp2(&mut self) -> CH1RSMTCMP2_W<ST3CH1RST_SPEC, 10> {
        CH1RSMTCMP2_W::new(self)
    }
    #[doc = "Bit 11 - Master_TIMER compare 3 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsmtcmp3(&mut self) -> CH1RSMTCMP3_W<ST3CH1RST_SPEC, 11> {
        CH1RSMTCMP3_W::new(self)
    }
    #[doc = "Bit 12 - Slave_TIMERx interconnection event 0 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev0(&mut self) -> CH1RSSTEV0_W<ST3CH1RST_SPEC, 12> {
        CH1RSSTEV0_W::new(self)
    }
    #[doc = "Bit 13 - Slave_TIMERx interconnection event 1 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev1(&mut self) -> CH1RSSTEV1_W<ST3CH1RST_SPEC, 13> {
        CH1RSSTEV1_W::new(self)
    }
    #[doc = "Bit 14 - Slave_TIMERx interconnection event 2 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev2(&mut self) -> CH1RSSTEV2_W<ST3CH1RST_SPEC, 14> {
        CH1RSSTEV2_W::new(self)
    }
    #[doc = "Bit 15 - Slave_TIMERx interconnection event 3 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev3(&mut self) -> CH1RSSTEV3_W<ST3CH1RST_SPEC, 15> {
        CH1RSSTEV3_W::new(self)
    }
    #[doc = "Bit 16 - Slave_TIMERx interconnection event 4 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev4(&mut self) -> CH1RSSTEV4_W<ST3CH1RST_SPEC, 16> {
        CH1RSSTEV4_W::new(self)
    }
    #[doc = "Bit 17 - Slave_TIMERx interconnection event 5 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev5(&mut self) -> CH1RSSTEV5_W<ST3CH1RST_SPEC, 17> {
        CH1RSSTEV5_W::new(self)
    }
    #[doc = "Bit 18 - Slave_TIMERx interconnection event 6 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev6(&mut self) -> CH1RSSTEV6_W<ST3CH1RST_SPEC, 18> {
        CH1RSSTEV6_W::new(self)
    }
    #[doc = "Bit 19 - Slave_TIMERx interconnection event 7 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev7(&mut self) -> CH1RSSTEV7_W<ST3CH1RST_SPEC, 19> {
        CH1RSSTEV7_W::new(self)
    }
    #[doc = "Bit 20 - Slave_TIMERx interconnection event 8 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsstev8(&mut self) -> CH1RSSTEV8_W<ST3CH1RST_SPEC, 20> {
        CH1RSSTEV8_W::new(self)
    }
    #[doc = "Bit 21 - External event 0 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev0(&mut self) -> CH1RSEXEV0_W<ST3CH1RST_SPEC, 21> {
        CH1RSEXEV0_W::new(self)
    }
    #[doc = "Bit 22 - External event 1 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev1(&mut self) -> CH1RSEXEV1_W<ST3CH1RST_SPEC, 22> {
        CH1RSEXEV1_W::new(self)
    }
    #[doc = "Bit 23 - External event 2 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev2(&mut self) -> CH1RSEXEV2_W<ST3CH1RST_SPEC, 23> {
        CH1RSEXEV2_W::new(self)
    }
    #[doc = "Bit 24 - External event 3 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev3(&mut self) -> CH1RSEXEV3_W<ST3CH1RST_SPEC, 24> {
        CH1RSEXEV3_W::new(self)
    }
    #[doc = "Bit 25 - External event 4 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev4(&mut self) -> CH1RSEXEV4_W<ST3CH1RST_SPEC, 25> {
        CH1RSEXEV4_W::new(self)
    }
    #[doc = "Bit 26 - External event 5 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev5(&mut self) -> CH1RSEXEV5_W<ST3CH1RST_SPEC, 26> {
        CH1RSEXEV5_W::new(self)
    }
    #[doc = "Bit 27 - External event 6 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev6(&mut self) -> CH1RSEXEV6_W<ST3CH1RST_SPEC, 27> {
        CH1RSEXEV6_W::new(self)
    }
    #[doc = "Bit 28 - External event 7 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev7(&mut self) -> CH1RSEXEV7_W<ST3CH1RST_SPEC, 28> {
        CH1RSEXEV7_W::new(self)
    }
    #[doc = "Bit 29 - External event 8 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev8(&mut self) -> CH1RSEXEV8_W<ST3CH1RST_SPEC, 29> {
        CH1RSEXEV8_W::new(self)
    }
    #[doc = "Bit 30 - External event 9 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsexev9(&mut self) -> CH1RSEXEV9_W<ST3CH1RST_SPEC, 30> {
        CH1RSEXEV9_W::new(self)
    }
    #[doc = "Bit 31 - Update event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1rsup(&mut self) -> CH1RSUP_W<ST3CH1RST_SPEC, 31> {
        CH1RSUP_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMERx channel 1 reset request register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st3ch1rst::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st3ch1rst::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST3CH1RST_SPEC;
impl crate::RegisterSpec for ST3CH1RST_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3ch1rst::R`](R) reader structure"]
impl crate::Readable for ST3CH1RST_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3ch1rst::W`](W) writer structure"]
impl crate::Writable for ST3CH1RST_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3CH1RST to value 0"]
impl crate::Resettable for ST3CH1RST_SPEC {
