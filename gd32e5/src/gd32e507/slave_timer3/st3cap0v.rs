...
pub type R = crate::R<ST3CAP0V_SPEC>;
#[doc = "Register `ST3CAP0V` writer"]
pub type W = crate::W<ST3CAP0V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cap0val(&mut self) -> CAP0VAL_W<ST3CAP0V_SPEC, 0> {
        CAP0VAL_W::new(self)
    }
...
pub struct ST3CAP0V_SPEC;
impl crate::RegisterSpec for ST3CAP0V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3cap0v::R`](R) reader structure"]
impl crate::Readable for ST3CAP0V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3cap0v::W`](W) writer structure"]
impl crate::Writable for ST3CAP0V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3CAP0V to value 0"]
impl crate::Resettable for ST3CAP0V_SPEC {
