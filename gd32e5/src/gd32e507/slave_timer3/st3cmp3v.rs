...
pub type R = crate::R<ST3CMP3V_SPEC>;
#[doc = "Register `ST3CMP3V` writer"]
pub type W = crate::W<ST3CMP3V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp3val(&mut self) -> CMP3VAL_W<ST3CMP3V_SPEC, 0> {
        CMP3VAL_W::new(self)
    }
...
pub struct ST3CMP3V_SPEC;
impl crate::RegisterSpec for ST3CMP3V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3cmp3v::R`](R) reader structure"]
impl crate::Readable for ST3CMP3V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3cmp3v::W`](W) writer structure"]
impl crate::Writable for ST3CMP3V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3CMP3V to value 0"]
impl crate::Resettable for ST3CMP3V_SPEC {
