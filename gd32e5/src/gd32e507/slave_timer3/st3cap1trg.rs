...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0a(&mut self) -> CP1BST0A_W<ST3CAP1TRG_SPEC, 12> {
        CP1BST0A_W::new(self)
    }
    #[doc = "Bit 13 - Capture 1 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0na(&mut self) -> CP1BST0NA_W<ST3CAP1TRG_SPEC, 13> {
        CP1BST0NA_W::new(self)
    }
    #[doc = "Bit 14 - Capture 1 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp0(&mut self) -> CP1BST0CMP0_W<ST3CAP1TRG_SPEC, 14> {
        CP1BST0CMP0_W::new(self)
    }
    #[doc = "Bit 15 - Capture 1 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp1(&mut self) -> CP1BST0CMP1_W<ST3CAP1TRG_SPEC, 15> {
        CP1BST0CMP1_W::new(self)
    }
    #[doc = "Bit 16 - Capture 1 triggered by ST2CH1_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1a(&mut self) -> CP1BST1A_W<ST3CAP1TRG_SPEC, 16> {
        CP1BST1A_W::new(self)
    }
    #[doc = "Bit 17 - Capture 1 triggered by ST2CH1_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1na(&mut self) -> CP1BST1NA_W<ST3CAP1TRG_SPEC, 17> {
        CP1BST1NA_W::new(self)
    }
    #[doc = "Bit 18 - Capture 1 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp0(&mut self) -> CP1BST1CMP0_W<ST3CAP1TRG_SPEC, 18> {
        CP1BST1CMP0_W::new(self)
    }
    #[doc = "Bit 19 - Capture 1 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp1(&mut self) -> CP1BST1CMP1_W<ST3CAP1TRG_SPEC, 19> {
        CP1BST1CMP1_W::new(self)
    }
    #[doc = "Bit 20 - Capture 1 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2a(&mut self) -> CP1BST2A_W<ST3CAP1TRG_SPEC, 20> {
        CP1BST2A_W::new(self)
    }
    #[doc = "Bit 21 - Capture 1 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2na(&mut self) -> CP1BST2NA_W<ST3CAP1TRG_SPEC, 21> {
        CP1BST2NA_W::new(self)
    }
    #[doc = "Bit 22 - Capture 1 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp0(&mut self) -> CP1BST2CMP0_W<ST3CAP1TRG_SPEC, 22> {
        CP1BST2CMP0_W::new(self)
    }
    #[doc = "Bit 23 - Capture 1 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp1(&mut self) -> CP1BST2CMP1_W<ST3CAP1TRG_SPEC, 23> {
        CP1BST2CMP1_W::new(self)
    }
    #[doc = "Bit 28 - Capture 1 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4a(&mut self) -> CP1BST4A_W<ST3CAP1TRG_SPEC, 28> {
        CP1BST4A_W::new(self)
    }
    #[doc = "Bit 29 - Capture 1 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4na(&mut self) -> CP1BST4NA_W<ST3CAP1TRG_SPEC, 29> {
        CP1BST4NA_W::new(self)
    }
    #[doc = "Bit 30 - Capture 1 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp0(&mut self) -> CP1BST4CMP0_W<ST3CAP1TRG_SPEC, 30> {
        CP1BST4CMP0_W::new(self)
    }
    #[doc = "Bit 31 - Capture 1 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp1(&mut self) -> CP1BST4CMP1_W<ST3CAP1TRG_SPEC, 31> {
