...
pub type CAN2_HOLD_R = crate::BitReader;
#[doc = "Field `CAN2_HOLD` writer - CAN2 hold bit"]
pub type CAN2_HOLD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn can2_hold(&self) -> CAN2_HOLD_R {
        CAN2_HOLD_R::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn can2_hold(&mut self) -> CAN2_HOLD_W<CTL0_SPEC, 3> {
        CAN2_HOLD_W::new(self)
    }
    #[doc = "Bit 5 - Trace pin allocation enable"]
    #[inline(always)]
    #[must_use]
