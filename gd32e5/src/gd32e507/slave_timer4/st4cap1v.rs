...
pub type R = crate::R<ST4CAP1V_SPEC>;
#[doc = "Register `ST4CAP1V` writer"]
pub type W = crate::W<ST4CAP1V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cap1val(&mut self) -> CAP1VAL_W<ST4CAP1V_SPEC, 0> {
        CAP1VAL_W::new(self)
    }
...
pub struct ST4CAP1V_SPEC;
impl crate::RegisterSpec for ST4CAP1V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4cap1v::R`](R) reader structure"]
impl crate::Readable for ST4CAP1V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st4cap1v::W`](W) writer structure"]
impl crate::Writable for ST4CAP1V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST4CAP1V to value 0"]
impl crate::Resettable for ST4CAP1V_SPEC {
