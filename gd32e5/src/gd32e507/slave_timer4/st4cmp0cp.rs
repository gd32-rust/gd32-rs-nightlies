...
pub type R = crate::R<ST4CMP0CP_SPEC>;
#[doc = "Register `ST4CMP0CP` writer"]
pub type W = crate::W<ST4CMP0CP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0val(&mut self) -> CMP0VAL_W<ST4CMP0CP_SPEC, 0> {
        CMP0VAL_W::new(self)
    }
    #[doc = "Bits 16:23 - Counter repetition value"]
    #[inline(always)]
    #[must_use]
    pub fn crep(&mut self) -> CREP_W<ST4CMP0CP_SPEC, 16> {
        CREP_W::new(self)
    }
...
pub struct ST4CMP0CP_SPEC;
impl crate::RegisterSpec for ST4CMP0CP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4cmp0cp::R`](R) reader structure"]
impl crate::Readable for ST4CMP0CP_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st4cmp0cp::W`](W) writer structure"]
impl crate::Writable for ST4CMP0CP_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST4CMP0CP to value 0"]
impl crate::Resettable for ST4CMP0CP_SPEC {
