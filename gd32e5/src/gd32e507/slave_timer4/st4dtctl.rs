...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtrcfg(&mut self) -> DtrcfgW<St4dtctlSpec> {
        DtrcfgW::new(self, 0)
    }
    #[doc = "Bit 9 - The sign of falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtrs(&mut self) -> DtrsW<St4dtctlSpec> {
        DtrsW::new(self, 9)
    }
    #[doc = "Bits 10:13 - Dead time generator clock division"]
    #[inline(always)]
    #[must_use]
    pub fn dtgckdiv(&mut self) -> DtgckdivW<St4dtctlSpec> {
        DtgckdivW::new(self, 10)
    }
    #[doc = "Bit 14 - Dead-time rising edge protection for sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtrsprot(&mut self) -> DtrsprotW<St4dtctlSpec> {
        DtrsprotW::new(self, 14)
    }
    #[doc = "Bit 15 - Dead-time rising edge protection for value and sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtrsvprot(&mut self) -> DtrsvprotW<St4dtctlSpec> {
        DtrsvprotW::new(self, 15)
    }
    #[doc = "Bits 16:24 - Falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtfcfg(&mut self) -> DtfcfgW<St4dtctlSpec> {
        DtfcfgW::new(self, 16)
    }
    #[doc = "Bit 25 - The sign of falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtfs(&mut self) -> DtfsW<St4dtctlSpec> {
        DtfsW::new(self, 25)
    }
    #[doc = "Bit 30 - Dead-time falling edge protection for sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtfsprot(&mut self) -> DtfsprotW<St4dtctlSpec> {
        DtfsprotW::new(self, 30)
    }
    #[doc = "Bit 31 - Dead-time falling edge protection for value and sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtfsvprot(&mut self) -> DtfsvprotW<St4dtctlSpec> {
