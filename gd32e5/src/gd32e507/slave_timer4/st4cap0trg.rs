...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0a(&mut self) -> Cp0bst0aW<St4cap0trgSpec> {
        Cp0bst0aW::new(self, 12)
    }
    #[doc = "Bit 13 - Capture 0 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0na(&mut self) -> Cp0bst0naW<St4cap0trgSpec> {
        Cp0bst0naW::new(self, 13)
    }
    #[doc = "Bit 14 - Capture 0 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp0(&mut self) -> Cp0bst0cmp0W<St4cap0trgSpec> {
        Cp0bst0cmp0W::new(self, 14)
    }
    #[doc = "Bit 15 - Capture 0 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp1(&mut self) -> Cp0bst0cmp1W<St4cap0trgSpec> {
        Cp0bst0cmp1W::new(self, 15)
    }
    #[doc = "Bit 16 - Capture 0 triggered by ST2CH1_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1a(&mut self) -> Cp0bst1aW<St4cap0trgSpec> {
        Cp0bst1aW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture 0 triggered by ST2CH1_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1na(&mut self) -> Cp0bst1naW<St4cap0trgSpec> {
        Cp0bst1naW::new(self, 17)
    }
    #[doc = "Bit 18 - Capture 0 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1cmp0(&mut self) -> Cp0bst1cmp0W<St4cap0trgSpec> {
        Cp0bst1cmp0W::new(self, 18)
    }
    #[doc = "Bit 19 - Capture 0 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1cmp1(&mut self) -> Cp0bst1cmp1W<St4cap0trgSpec> {
        Cp0bst1cmp1W::new(self, 19)
    }
    #[doc = "Bit 20 - Capture 0 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2a(&mut self) -> Cp0bst2aW<St4cap0trgSpec> {
        Cp0bst2aW::new(self, 20)
    }
    #[doc = "Bit 21 - Capture 0 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2na(&mut self) -> Cp0bst2naW<St4cap0trgSpec> {
        Cp0bst2naW::new(self, 21)
    }
    #[doc = "Bit 22 - Capture 0 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp0(&mut self) -> Cp0bst2cmp0W<St4cap0trgSpec> {
        Cp0bst2cmp0W::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 0 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp1(&mut self) -> Cp0bst2cmp1W<St4cap0trgSpec> {
        Cp0bst2cmp1W::new(self, 23)
    }
    #[doc = "Bit 24 - Capture 0 triggered by ST3CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3a(&mut self) -> Cp0bst3aW<St4cap0trgSpec> {
        Cp0bst3aW::new(self, 24)
    }
    #[doc = "Bit 25 - Capture 0 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3na(&mut self) -> Cp0bst3naW<St4cap0trgSpec> {
        Cp0bst3naW::new(self, 25)
    }
    #[doc = "Bit 26 - Capture 0 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp0(&mut self) -> Cp0bst3cmp0W<St4cap0trgSpec> {
        Cp0bst3cmp0W::new(self, 26)
    }
    #[doc = "Bit 27 - Capture 0 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp1(&mut self) -> Cp0bst3cmp1W<St4cap0trgSpec> {
