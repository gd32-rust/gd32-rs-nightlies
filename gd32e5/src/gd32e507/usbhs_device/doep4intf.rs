...
pub type R = crate::R<DOEP4INTF_SPEC>;
#[doc = "Register `DOEP4INTF` writer"]
pub type W = crate::W<DOEP4INTF_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<DOEP4INTF_SPEC, 0> {
        TF_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint disabled"]
    #[inline(always)]
    #[must_use]
    pub fn epdis(&mut self) -> EPDIS_W<DOEP4INTF_SPEC, 1> {
        EPDIS_W::new(self)
    }
    #[doc = "Bit 3 - Setup phase finished"]
    #[inline(always)]
    #[must_use]
    pub fn stpf(&mut self) -> STPF_W<DOEP4INTF_SPEC, 3> {
        STPF_W::new(self)
    }
    #[doc = "Bit 4 - Endpoint Rx FIFO overrun"]
    #[inline(always)]
    #[must_use]
    pub fn eprxfovr(&mut self) -> EPRXFOVR_W<DOEP4INTF_SPEC, 4> {
        EPRXFOVR_W::new(self)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets"]
    #[inline(always)]
    #[must_use]
    pub fn btbstp(&mut self) -> BTBSTP_W<DOEP4INTF_SPEC, 6> {
        BTBSTP_W::new(self)
    }
    #[doc = "Bit 14 - NYET handshake is sent"]
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<DOEP4INTF_SPEC, 14> {
        NYET_W::new(self)
    }
...
#[doc = "device out endpoint-4 interrupt flag register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`doep4intf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`doep4intf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DOEP4INTF_SPEC;
impl crate::RegisterSpec for DOEP4INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep4intf::R`](R) reader structure"]
impl crate::Readable for DOEP4INTF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep4intf::W`](W) writer structure"]
impl crate::Writable for DOEP4INTF_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP4INTF to value 0"]
impl crate::Resettable for DOEP4INTF_SPEC {
