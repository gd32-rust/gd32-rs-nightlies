...
pub type R = crate::R<DIEP2DMAADDR_SPEC>;
#[doc = "Register `DIEP2DMAADDR` writer"]
pub type W = crate::W<DIEP2DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DIEP2DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct DIEP2DMAADDR_SPEC;
impl crate::RegisterSpec for DIEP2DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep2dmaaddr::R`](R) reader structure"]
impl crate::Readable for DIEP2DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep2dmaaddr::W`](W) writer structure"]
impl crate::Writable for DIEP2DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP2DMAADDR to value 0"]
impl crate::Resettable for DIEP2DMAADDR_SPEC {
