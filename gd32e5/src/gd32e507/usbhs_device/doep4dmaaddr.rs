...
pub type R = crate::R<DOEP4DMAADDR_SPEC>;
#[doc = "Register `DOEP4DMAADDR` writer"]
pub type W = crate::W<DOEP4DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DOEP4DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct DOEP4DMAADDR_SPEC;
impl crate::RegisterSpec for DOEP4DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep4dmaaddr::R`](R) reader structure"]
impl crate::Readable for DOEP4DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep4dmaaddr::W`](W) writer structure"]
impl crate::Writable for DOEP4DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP4DMAADDR to value 0"]
impl crate::Resettable for DOEP4DMAADDR_SPEC {
