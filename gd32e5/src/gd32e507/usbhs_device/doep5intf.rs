...
pub type R = crate::R<DOEP5INTF_SPEC>;
#[doc = "Register `DOEP5INTF` writer"]
pub type W = crate::W<DOEP5INTF_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<DOEP5INTF_SPEC, 0> {
        TF_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint disabled"]
    #[inline(always)]
    #[must_use]
    pub fn epdis(&mut self) -> EPDIS_W<DOEP5INTF_SPEC, 1> {
        EPDIS_W::new(self)
    }
    #[doc = "Bit 3 - Setup phase finished"]
    #[inline(always)]
    #[must_use]
    pub fn stpf(&mut self) -> STPF_W<DOEP5INTF_SPEC, 3> {
        STPF_W::new(self)
    }
    #[doc = "Bit 4 - Endpoint Rx FIFO overrun"]
    #[inline(always)]
    #[must_use]
    pub fn eprxfovr(&mut self) -> EPRXFOVR_W<DOEP5INTF_SPEC, 4> {
        EPRXFOVR_W::new(self)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets"]
    #[inline(always)]
    #[must_use]
    pub fn btbstp(&mut self) -> BTBSTP_W<DOEP5INTF_SPEC, 6> {
        BTBSTP_W::new(self)
    }
    #[doc = "Bit 14 - NYET handshake is sent"]
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<DOEP5INTF_SPEC, 14> {
        NYET_W::new(self)
    }
...
pub struct DOEP5INTF_SPEC;
impl crate::RegisterSpec for DOEP5INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep5intf::R`](R) reader structure"]
impl crate::Readable for DOEP5INTF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep5intf::W`](W) writer structure"]
impl crate::Writable for DOEP5INTF_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP5INTF to value 0"]
impl crate::Resettable for DOEP5INTF_SPEC {
