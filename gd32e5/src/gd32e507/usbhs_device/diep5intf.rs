...
pub type R = crate::R<DIEP5INTF_SPEC>;
#[doc = "Register `DIEP5INTF` writer"]
pub type W = crate::W<DIEP5INTF_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<DIEP5INTF_SPEC, 0> {
        TF_W::new(self)
    }
    #[doc = "Bit 1 - Endpoint finished"]
    #[inline(always)]
    #[must_use]
    pub fn epdis(&mut self) -> EPDIS_W<DIEP5INTF_SPEC, 1> {
        EPDIS_W::new(self)
    }
    #[doc = "Bit 3 - Control in timeout interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn cito(&mut self) -> CITO_W<DIEP5INTF_SPEC, 3> {
        CITO_W::new(self)
    }
    #[doc = "Bit 4 - Endpoint Tx FIFO underrun"]
    #[inline(always)]
    #[must_use]
    pub fn eptxfud(&mut self) -> EPTXFUD_W<DIEP5INTF_SPEC, 4> {
        EPTXFUD_W::new(self)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective"]
    #[inline(always)]
    #[must_use]
    pub fn iepne(&mut self) -> IEPNE_W<DIEP5INTF_SPEC, 6> {
        IEPNE_W::new(self)
    }
    #[doc = "Bit 13 - NAK handshake sent by USBHS"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<DIEP5INTF_SPEC, 13> {
        NAK_W::new(self)
    }
...
pub struct DIEP5INTF_SPEC;
impl crate::RegisterSpec for DIEP5INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep5intf::R`](R) reader structure"]
impl crate::Readable for DIEP5INTF_SPEC {}
#[doc = "`write(|w| ..)` method takes [`diep5intf::W`](W) writer structure"]
impl crate::Writable for DIEP5INTF_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DIEP5INTF to value 0x80"]
impl crate::Resettable for DIEP5INTF_SPEC {
