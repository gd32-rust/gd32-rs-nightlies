...
pub type R = crate::R<DIEP5TFSTAT_SPEC>;
...
pub struct DIEP5TFSTAT_SPEC;
impl crate::RegisterSpec for DIEP5TFSTAT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diep5tfstat::R`](R) reader structure"]
impl crate::Readable for DIEP5TFSTAT_SPEC {}
#[doc = "`reset()` method sets DIEP5TFSTAT to value 0x0200"]
impl crate::Resettable for DIEP5TFSTAT_SPEC {
