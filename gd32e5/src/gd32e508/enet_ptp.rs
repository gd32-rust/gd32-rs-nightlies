...
pub mod ptp_etl;
#[doc = "PTP_TSF (r) register accessor: Ethernet PTP time stamp flag register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ptp_tsf::R`].  See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`ptp_tsf`]
module"]
pub type PTP_TSF = crate::Reg<ptp_tsf::PTP_TSF_SPEC>;
#[doc = "Ethernet PTP time stamp flag register"]
pub mod ptp_tsf;
#[doc = "PTP_PPSCTL (rw) register accessor: Ethernet PTP PPS control register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ptp_ppsctl::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ptp_ppsctl::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`ptp_ppsctl`]
module"]
pub type PTP_PPSCTL = crate::Reg<ptp_ppsctl::PTP_PPSCTL_SPEC>;
