...
pub type R = crate::R<ST3CAP0TRG_SPEC>;
#[doc = "Register `ST3CAP0TRG` writer"]
pub type W = crate::W<ST3CAP0TRG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bsw(&mut self) -> CP0BSW_W<ST3CAP0TRG_SPEC, 0> {
        CP0BSW_W::new(self)
    }
    #[doc = "Bit 1 - Capture 0 triggered by update event"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bup(&mut self) -> CP0BUP_W<ST3CAP0TRG_SPEC, 1> {
        CP0BUP_W::new(self)
    }
    #[doc = "Bit 2 - Capture 0 triggered by external event 0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev0(&mut self) -> CP0BEXEV0_W<ST3CAP0TRG_SPEC, 2> {
        CP0BEXEV0_W::new(self)
    }
    #[doc = "Bit 3 - Capture 0 triggered by external event 1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev1(&mut self) -> CP0BEXEV1_W<ST3CAP0TRG_SPEC, 3> {
        CP0BEXEV1_W::new(self)
    }
    #[doc = "Bit 4 - Capture 0 triggered by external event 2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev2(&mut self) -> CP0BEXEV2_W<ST3CAP0TRG_SPEC, 4> {
        CP0BEXEV2_W::new(self)
    }
    #[doc = "Bit 5 - Capture 0 triggered by external event 3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev3(&mut self) -> CP0BEXEV3_W<ST3CAP0TRG_SPEC, 5> {
        CP0BEXEV3_W::new(self)
    }
    #[doc = "Bit 6 - Capture 0 triggered by external event 4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev4(&mut self) -> CP0BEXEV4_W<ST3CAP0TRG_SPEC, 6> {
        CP0BEXEV4_W::new(self)
    }
    #[doc = "Bit 7 - Capture 0 triggered by external event 5"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev5(&mut self) -> CP0BEXEV5_W<ST3CAP0TRG_SPEC, 7> {
        CP0BEXEV5_W::new(self)
    }
    #[doc = "Bit 8 - Capture 0 triggered by external event 6"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev6(&mut self) -> CP0BEXEV6_W<ST3CAP0TRG_SPEC, 8> {
        CP0BEXEV6_W::new(self)
    }
    #[doc = "Bit 9 - Capture 0 triggered by external event 7"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev7(&mut self) -> CP0BEXEV7_W<ST3CAP0TRG_SPEC, 9> {
        CP0BEXEV7_W::new(self)
    }
    #[doc = "Bit 10 - Capture 0 triggered by external event 8"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev8(&mut self) -> CP0BEXEV8_W<ST3CAP0TRG_SPEC, 10> {
        CP0BEXEV8_W::new(self)
    }
    #[doc = "Bit 11 - Capture 0 triggered by external event 9"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bexev9(&mut self) -> CP0BEXEV9_W<ST3CAP0TRG_SPEC, 11> {
        CP0BEXEV9_W::new(self)
    }
    #[doc = "Bit 12 - Capture 0 triggered by ST0CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0a(&mut self) -> CP0BST0A_W<ST3CAP0TRG_SPEC, 12> {
        CP0BST0A_W::new(self)
    }
    #[doc = "Bit 13 - Capture 0 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0na(&mut self) -> CP0BST0NA_W<ST3CAP0TRG_SPEC, 13> {
        CP0BST0NA_W::new(self)
    }
    #[doc = "Bit 14 - Capture 0 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp0(&mut self) -> CP0BST0CMP0_W<ST3CAP0TRG_SPEC, 14> {
        CP0BST0CMP0_W::new(self)
    }
    #[doc = "Bit 15 - Capture 0 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp1(&mut self) -> CP0BST0CMP1_W<ST3CAP0TRG_SPEC, 15> {
        CP0BST0CMP1_W::new(self)
    }
    #[doc = "Bit 16 - Capture 0 triggered by ST2CH1_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1a(&mut self) -> CP0BST1A_W<ST3CAP0TRG_SPEC, 16> {
        CP0BST1A_W::new(self)
    }
    #[doc = "Bit 17 - Capture 0 triggered by ST2CH1_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1na(&mut self) -> CP0BST1NA_W<ST3CAP0TRG_SPEC, 17> {
        CP0BST1NA_W::new(self)
    }
    #[doc = "Bit 18 - Capture 0 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1cmp0(&mut self) -> CP0BST1CMP0_W<ST3CAP0TRG_SPEC, 18> {
        CP0BST1CMP0_W::new(self)
    }
    #[doc = "Bit 19 - Capture 0 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst1cmp1(&mut self) -> CP0BST1CMP1_W<ST3CAP0TRG_SPEC, 19> {
        CP0BST1CMP1_W::new(self)
    }
    #[doc = "Bit 20 - Capture 0 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2a(&mut self) -> CP0BST2A_W<ST3CAP0TRG_SPEC, 20> {
        CP0BST2A_W::new(self)
    }
    #[doc = "Bit 21 - Capture 0 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2na(&mut self) -> CP0BST2NA_W<ST3CAP0TRG_SPEC, 21> {
        CP0BST2NA_W::new(self)
    }
    #[doc = "Bit 22 - Capture 0 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp0(&mut self) -> CP0BST2CMP0_W<ST3CAP0TRG_SPEC, 22> {
        CP0BST2CMP0_W::new(self)
    }
    #[doc = "Bit 23 - Capture 0 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp1(&mut self) -> CP0BST2CMP1_W<ST3CAP0TRG_SPEC, 23> {
        CP0BST2CMP1_W::new(self)
    }
    #[doc = "Bit 28 - Capture 0 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4a(&mut self) -> CP0BST4A_W<ST3CAP0TRG_SPEC, 28> {
        CP0BST4A_W::new(self)
    }
    #[doc = "Bit 29 - Capture 0 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4na(&mut self) -> CP0BST4NA_W<ST3CAP0TRG_SPEC, 29> {
        CP0BST4NA_W::new(self)
    }
    #[doc = "Bit 30 - Capture 0 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp0(&mut self) -> CP0BST4CMP0_W<ST3CAP0TRG_SPEC, 30> {
        CP0BST4CMP0_W::new(self)
    }
    #[doc = "Bit 31 - Capture 0 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp1(&mut self) -> CP0BST4CMP1_W<ST3CAP0TRG_SPEC, 31> {
...
pub struct ST3CAP0TRG_SPEC;
impl crate::RegisterSpec for ST3CAP0TRG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3cap0trg::R`](R) reader structure"]
impl crate::Readable for ST3CAP0TRG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3cap0trg::W`](W) writer structure"]
impl crate::Writable for ST3CAP0TRG_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3CAP0TRG to value 0"]
impl crate::Resettable for ST3CAP0TRG_SPEC {
