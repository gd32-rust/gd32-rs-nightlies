...
pub type R = crate::R<ST3CREP_SPEC>;
#[doc = "Register `ST3CREP` writer"]
pub type W = crate::W<ST3CREP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crep(&mut self) -> CREP_W<ST3CREP_SPEC, 0> {
        CREP_W::new(self)
    }
