...
pub type R = crate::R<ST3EXEVFCFG1_SPEC>;
#[doc = "Register `ST3EXEVFCFG1` writer"]
pub type W = crate::W<ST3EXEVFCFG1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn exev5meen(&mut self) -> EXEV5MEEN_W<ST3EXEVFCFG1_SPEC, 0> {
        EXEV5MEEN_W::new(self)
    }
    #[doc = "Bits 1:4 - External event 5 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev5fm(&mut self) -> EXEV5FM_W<ST3EXEVFCFG1_SPEC, 1> {
        EXEV5FM_W::new(self)
    }
    #[doc = "Bit 6 - External event 6 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev6meen(&mut self) -> EXEV6MEEN_W<ST3EXEVFCFG1_SPEC, 6> {
        EXEV6MEEN_W::new(self)
    }
    #[doc = "Bits 7:10 - External event 6 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev6fm(&mut self) -> EXEV6FM_W<ST3EXEVFCFG1_SPEC, 7> {
        EXEV6FM_W::new(self)
    }
    #[doc = "Bit 12 - External event 7 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev7meen(&mut self) -> EXEV7MEEN_W<ST3EXEVFCFG1_SPEC, 12> {
        EXEV7MEEN_W::new(self)
    }
    #[doc = "Bits 13:16 - External event 7 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev7fm(&mut self) -> EXEV7FM_W<ST3EXEVFCFG1_SPEC, 13> {
        EXEV7FM_W::new(self)
    }
    #[doc = "Bit 18 - External event 8 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev8meen(&mut self) -> EXEV8MEEN_W<ST3EXEVFCFG1_SPEC, 18> {
        EXEV8MEEN_W::new(self)
    }
    #[doc = "Bits 19:22 - External event 8 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev8fm(&mut self) -> EXEV8FM_W<ST3EXEVFCFG1_SPEC, 19> {
        EXEV8FM_W::new(self)
    }
    #[doc = "Bit 24 - External event 9 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev9meen(&mut self) -> EXEV9MEEN_W<ST3EXEVFCFG1_SPEC, 24> {
        EXEV9MEEN_W::new(self)
    }
    #[doc = "Bits 25:28 - External event 9 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev9fm(&mut self) -> EXEV9FM_W<ST3EXEVFCFG1_SPEC, 25> {
        EXEV9FM_W::new(self)
    }
...
pub struct ST3EXEVFCFG1_SPEC;
impl crate::RegisterSpec for ST3EXEVFCFG1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3exevfcfg1::R`](R) reader structure"]
impl crate::Readable for ST3EXEVFCFG1_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st3exevfcfg1::W`](W) writer structure"]
impl crate::Writable for ST3EXEVFCFG1_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST3EXEVFCFG1 to value 0"]
impl crate::Resettable for ST3EXEVFCFG1_SPEC {
