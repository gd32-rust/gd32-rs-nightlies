...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0a(&mut self) -> Cp1bst0aW<St3cap1trgSpec> {
        Cp1bst0aW::new(self, 12)
    }
    #[doc = "Bit 13 - Capture 1 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0na(&mut self) -> Cp1bst0naW<St3cap1trgSpec> {
        Cp1bst0naW::new(self, 13)
    }
    #[doc = "Bit 14 - Capture 1 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp0(&mut self) -> Cp1bst0cmp0W<St3cap1trgSpec> {
        Cp1bst0cmp0W::new(self, 14)
    }
    #[doc = "Bit 15 - Capture 1 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst0cmp1(&mut self) -> Cp1bst0cmp1W<St3cap1trgSpec> {
        Cp1bst0cmp1W::new(self, 15)
    }
    #[doc = "Bit 16 - Capture 1 triggered by ST2CH1_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1a(&mut self) -> Cp1bst1aW<St3cap1trgSpec> {
        Cp1bst1aW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture 1 triggered by ST2CH1_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1na(&mut self) -> Cp1bst1naW<St3cap1trgSpec> {
        Cp1bst1naW::new(self, 17)
    }
    #[doc = "Bit 18 - Capture 1 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp0(&mut self) -> Cp1bst1cmp0W<St3cap1trgSpec> {
        Cp1bst1cmp0W::new(self, 18)
    }
    #[doc = "Bit 19 - Capture 1 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst1cmp1(&mut self) -> Cp1bst1cmp1W<St3cap1trgSpec> {
        Cp1bst1cmp1W::new(self, 19)
    }
    #[doc = "Bit 20 - Capture 1 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2a(&mut self) -> Cp1bst2aW<St3cap1trgSpec> {
        Cp1bst2aW::new(self, 20)
    }
    #[doc = "Bit 21 - Capture 1 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2na(&mut self) -> Cp1bst2naW<St3cap1trgSpec> {
        Cp1bst2naW::new(self, 21)
    }
    #[doc = "Bit 22 - Capture 1 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp0(&mut self) -> Cp1bst2cmp0W<St3cap1trgSpec> {
        Cp1bst2cmp0W::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 1 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst2cmp1(&mut self) -> Cp1bst2cmp1W<St3cap1trgSpec> {
        Cp1bst2cmp1W::new(self, 23)
    }
    #[doc = "Bit 28 - Capture 1 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4a(&mut self) -> Cp1bst4aW<St3cap1trgSpec> {
        Cp1bst4aW::new(self, 28)
    }
    #[doc = "Bit 29 - Capture 1 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4na(&mut self) -> Cp1bst4naW<St3cap1trgSpec> {
        Cp1bst4naW::new(self, 29)
    }
    #[doc = "Bit 30 - Capture 1 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp0(&mut self) -> Cp1bst4cmp0W<St3cap1trgSpec> {
        Cp1bst4cmp0W::new(self, 30)
    }
    #[doc = "Bit 31 - Capture 1 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp1bst4cmp1(&mut self) -> Cp1bst4cmp1W<St3cap1trgSpec> {
