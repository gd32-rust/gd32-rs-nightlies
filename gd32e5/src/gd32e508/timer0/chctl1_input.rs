...
pub use super::chctl0_input::CH0CAPFLT_A;
...
pub use super::chctl0_input::CH0CAPFLT_W as CH2CAPFLT_W;
#[doc = "Field `CH3CAPFLT` writer - Channel 3 input capture filter control"]
pub use super::chctl0_input::CH0CAPFLT_W as CH3CAPFLT_W;
#[doc = "Channel 2 input capture prescaler"]
pub use super::chctl0_input::CH0CAPPSC_A;
...
pub use super::chctl0_input::CH0CAPPSC_W as CH2CAPPSC_W;
#[doc = "Field `CH3CAPPSC` writer - Channel 3 input capture prescaler"]
pub use super::chctl0_input::CH0CAPPSC_W as CH3CAPPSC_W;
#[doc = "Channel 2 mode selection"]
pub use super::chctl0_input::CH0MS_A;
...
pub use super::chctl0_input::CH0MS_W as CH2MS_W;
#[doc = "Field `CH3MS` writer - Channel 3 mode selection"]
pub use super::chctl0_input::CH0MS_W as CH3MS_W;
impl R {
