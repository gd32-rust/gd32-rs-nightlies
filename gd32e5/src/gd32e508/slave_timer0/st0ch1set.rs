...
pub type R = crate::R<ST0CH1SET_SPEC>;
#[doc = "Register `ST0CH1SET` writer"]
pub type W = crate::W<ST0CH1SET_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch1ssev(&mut self) -> CH1SSEV_W<ST0CH1SET_SPEC, 0> {
        CH1SSEV_W::new(self)
    }
    #[doc = "Bit 1 - Slave_TIMER0 reset event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1srst(&mut self) -> CH1SRST_W<ST0CH1SET_SPEC, 1> {
        CH1SRST_W::new(self)
    }
    #[doc = "Bit 2 - Slave_TIMER0 period event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sper(&mut self) -> CH1SPER_W<ST0CH1SET_SPEC, 2> {
        CH1SPER_W::new(self)
    }
    #[doc = "Bit 3 - Slave_TIMER0 compare 0 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1scmp0(&mut self) -> CH1SCMP0_W<ST0CH1SET_SPEC, 3> {
        CH1SCMP0_W::new(self)
    }
    #[doc = "Bit 4 - Slave_TIMER0 compare 1 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1scmp1(&mut self) -> CH1SCMP1_W<ST0CH1SET_SPEC, 4> {
        CH1SCMP1_W::new(self)
    }
    #[doc = "Bit 5 - Slave_TIMER0 compare 2 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1scmp2(&mut self) -> CH1SCMP2_W<ST0CH1SET_SPEC, 5> {
        CH1SCMP2_W::new(self)
    }
    #[doc = "Bit 6 - Slave_TIMER0 compare 3 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1scmp3(&mut self) -> CH1SCMP3_W<ST0CH1SET_SPEC, 6> {
        CH1SCMP3_W::new(self)
    }
    #[doc = "Bit 7 - Master_TIMER period event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1smtper(&mut self) -> CH1SMTPER_W<ST0CH1SET_SPEC, 7> {
        CH1SMTPER_W::new(self)
    }
    #[doc = "Bit 8 - Master_TIMER compare 0 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1smtcmp0(&mut self) -> CH1SMTCMP0_W<ST0CH1SET_SPEC, 8> {
        CH1SMTCMP0_W::new(self)
    }
    #[doc = "Bit 9 - Master_TIMER compare 1 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1smtcmp1(&mut self) -> CH1SMTCMP1_W<ST0CH1SET_SPEC, 9> {
        CH1SMTCMP1_W::new(self)
    }
    #[doc = "Bit 10 - Master_TIMER compare 2 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1smtcmp2(&mut self) -> CH1SMTCMP2_W<ST0CH1SET_SPEC, 10> {
        CH1SMTCMP2_W::new(self)
    }
    #[doc = "Bit 11 - Master_TIMER compare 3 event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1smtcmp3(&mut self) -> CH1SMTCMP3_W<ST0CH1SET_SPEC, 11> {
        CH1SMTCMP3_W::new(self)
    }
    #[doc = "Bit 12 - Slave_TIMER0 interconnection event 0 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev0(&mut self) -> CH1SSTEV0_W<ST0CH1SET_SPEC, 12> {
        CH1SSTEV0_W::new(self)
    }
    #[doc = "Bit 13 - Slave_TIMER0 interconnection event 1 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev1(&mut self) -> CH1SSTEV1_W<ST0CH1SET_SPEC, 13> {
        CH1SSTEV1_W::new(self)
    }
    #[doc = "Bit 14 - Slave_TIMER0 interconnection event 2 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev2(&mut self) -> CH1SSTEV2_W<ST0CH1SET_SPEC, 14> {
        CH1SSTEV2_W::new(self)
    }
    #[doc = "Bit 15 - Slave_TIMER0 interconnection event 3 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev3(&mut self) -> CH1SSTEV3_W<ST0CH1SET_SPEC, 15> {
        CH1SSTEV3_W::new(self)
    }
    #[doc = "Bit 16 - Slave_TIMER0 interconnection event 4 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev4(&mut self) -> CH1SSTEV4_W<ST0CH1SET_SPEC, 16> {
        CH1SSTEV4_W::new(self)
    }
    #[doc = "Bit 17 - Slave_TIMER0 interconnection event 5 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev5(&mut self) -> CH1SSTEV5_W<ST0CH1SET_SPEC, 17> {
        CH1SSTEV5_W::new(self)
    }
    #[doc = "Bit 18 - Slave_TIMER0 interconnection event 6 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev6(&mut self) -> CH1SSTEV6_W<ST0CH1SET_SPEC, 18> {
        CH1SSTEV6_W::new(self)
    }
    #[doc = "Bit 19 - Slave_TIMER0 interconnection event 7 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev7(&mut self) -> CH1SSTEV7_W<ST0CH1SET_SPEC, 19> {
        CH1SSTEV7_W::new(self)
    }
    #[doc = "Bit 20 - Slave_TIMER0 interconnection event 8 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sstev8(&mut self) -> CH1SSTEV8_W<ST0CH1SET_SPEC, 20> {
        CH1SSTEV8_W::new(self)
    }
    #[doc = "Bit 21 - External event 0 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev0(&mut self) -> CH1SEXEV0_W<ST0CH1SET_SPEC, 21> {
        CH1SEXEV0_W::new(self)
    }
    #[doc = "Bit 22 - External event 1 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev1(&mut self) -> CH1SEXEV1_W<ST0CH1SET_SPEC, 22> {
        CH1SEXEV1_W::new(self)
    }
    #[doc = "Bit 23 - External event 2 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev2(&mut self) -> CH1SEXEV2_W<ST0CH1SET_SPEC, 23> {
        CH1SEXEV2_W::new(self)
    }
    #[doc = "Bit 24 - External event 3 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev3(&mut self) -> CH1SEXEV3_W<ST0CH1SET_SPEC, 24> {
        CH1SEXEV3_W::new(self)
    }
    #[doc = "Bit 25 - External event 4 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev4(&mut self) -> CH1SEXEV4_W<ST0CH1SET_SPEC, 25> {
        CH1SEXEV4_W::new(self)
    }
    #[doc = "Bit 26 - External event 5 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev5(&mut self) -> CH1SEXEV5_W<ST0CH1SET_SPEC, 26> {
        CH1SEXEV5_W::new(self)
    }
    #[doc = "Bit 27 - External event 6 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev6(&mut self) -> CH1SEXEV6_W<ST0CH1SET_SPEC, 27> {
        CH1SEXEV6_W::new(self)
    }
    #[doc = "Bit 28 - External event 7 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev7(&mut self) -> CH1SEXEV7_W<ST0CH1SET_SPEC, 28> {
        CH1SEXEV7_W::new(self)
    }
    #[doc = "Bit 29 - External event 8 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev8(&mut self) -> CH1SEXEV8_W<ST0CH1SET_SPEC, 29> {
        CH1SEXEV8_W::new(self)
    }
    #[doc = "Bit 30 - External event 9 generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sexev9(&mut self) -> CH1SEXEV9_W<ST0CH1SET_SPEC, 30> {
        CH1SEXEV9_W::new(self)
    }
    #[doc = "Bit 31 - Update event generates channel 1"]
    #[inline(always)]
    #[must_use]
    pub fn ch1sup(&mut self) -> CH1SUP_W<ST0CH1SET_SPEC, 31> {
        CH1SUP_W::new(self)
    }
...
pub struct ST0CH1SET_SPEC;
impl crate::RegisterSpec for ST0CH1SET_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0ch1set::R`](R) reader structure"]
impl crate::Readable for ST0CH1SET_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st0ch1set::W`](W) writer structure"]
impl crate::Writable for ST0CH1SET_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST0CH1SET to value 0"]
impl crate::Resettable for ST0CH1SET_SPEC {
