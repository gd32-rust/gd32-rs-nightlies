...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn exev0meen(&mut self) -> Exev0meenW<St0exevfcfg0Spec> {
        Exev0meenW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External event 0 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev0fm(&mut self) -> Exev0fmW<St0exevfcfg0Spec> {
        Exev0fmW::new(self, 1)
    }
    #[doc = "Bit 6 - External event 1 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev1meen(&mut self) -> Exev1meenW<St0exevfcfg0Spec> {
        Exev1meenW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External event 1 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev1fm(&mut self) -> Exev1fmW<St0exevfcfg0Spec> {
        Exev1fmW::new(self, 7)
    }
    #[doc = "Bit 12 - External event 2 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev2meen(&mut self) -> Exev2meenW<St0exevfcfg0Spec> {
        Exev2meenW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External event 2 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev2fm(&mut self) -> Exev2fmW<St0exevfcfg0Spec> {
        Exev2fmW::new(self, 13)
    }
    #[doc = "Bit 18 - External event 3 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev3meen(&mut self) -> Exev3meenW<St0exevfcfg0Spec> {
        Exev3meenW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External event 3 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev3fm(&mut self) -> Exev3fmW<St0exevfcfg0Spec> {
        Exev3fmW::new(self, 19)
    }
    #[doc = "Bit 24 - External event 4 memorized enable"]
    #[inline(always)]
    #[must_use]
    pub fn exev4meen(&mut self) -> Exev4meenW<St0exevfcfg0Spec> {
        Exev4meenW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External event 4 filter mode"]
    #[inline(always)]
    #[must_use]
    pub fn exev4fm(&mut self) -> Exev4fmW<St0exevfcfg0Spec> {
