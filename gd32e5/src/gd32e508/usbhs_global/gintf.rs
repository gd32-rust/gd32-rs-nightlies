...
pub type LPMIF_R = crate::BitReader;
#[doc = "Field `LPMIF` writer - LPM interrupt flag"]
pub type LPMIF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn lpmif(&self) -> LPMIF_R {
        LPMIF_R::new(((self.bits >> 27) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lpmif(&mut self) -> LPMIF_W<GINTF_SPEC, 27> {
        LPMIF_W::new(self)
    }
    #[doc = "Bit 28 - ID pin status change"]
    #[inline(always)]
