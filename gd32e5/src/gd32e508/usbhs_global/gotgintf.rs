...
pub type IDCHG_R = crate::BitReader;
#[doc = "Field `IDCHG` writer - There is a change in the value of ID input"]
pub type IDCHG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn idchg(&mut self) -> IDCHG_W<GOTGINTF_SPEC, 20> {
        IDCHG_W::new(self)
    }
