...
pub type R = crate::R<OUT1_R12DH_SPEC>;
#[doc = "Register `OUT1_R12DH` writer"]
pub type W = crate::W<OUT1_R12DH_SPEC>;
...
impl R {
    ...
    pub fn out1_dh(&self) -> OUT1_DH_R {
        OUT1_DH_R::new((self.bits & 0x0fff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:11 - DAC_OUT1 12-bit right-aligned data"]
    #[inline(always)]
    #[must_use]
    pub fn out1_dh(&mut self) -> OUT1_DH_W<OUT1_R12DH_SPEC, 0> {
        OUT1_DH_W::new(self)
    }
...
pub struct OUT1_R12DH_SPEC;
impl crate::RegisterSpec for OUT1_R12DH_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`out1_r12dh::R`](R) reader structure"]
impl crate::Readable for OUT1_R12DH_SPEC {}
#[doc = "`write(|w| ..)` method takes [`out1_r12dh::W`](W) writer structure"]
impl crate::Writable for OUT1_R12DH_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets OUT1_R12DH to value 0"]
impl crate::Resettable for OUT1_R12DH_SPEC {
