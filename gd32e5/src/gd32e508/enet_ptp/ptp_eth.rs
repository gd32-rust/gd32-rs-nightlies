...
pub type R = crate::R<PTP_ETH_SPEC>;
#[doc = "Register `PTP_ETH` writer"]
pub type W = crate::W<PTP_ETH_SPEC>;
#[doc = "Field `ETSH` reader - Expected time stamp high"]
pub type ETSH_R = crate::FieldReader<u32>;
#[doc = "Field `ETSH` writer - Expected time stamp high"]
pub type ETSH_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn etsh(&mut self) -> ETSH_W<PTP_ETH_SPEC, 0> {
        ETSH_W::new(self)
    }
