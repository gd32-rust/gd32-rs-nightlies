...
pub type R = crate::R<ST2CREP_SPEC>;
#[doc = "Register `ST2CREP` writer"]
pub type W = crate::W<ST2CREP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crep(&mut self) -> CREP_W<ST2CREP_SPEC, 0> {
        CREP_W::new(self)
    }
...
pub struct ST2CREP_SPEC;
impl crate::RegisterSpec for ST2CREP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2crep::R`](R) reader structure"]
impl crate::Readable for ST2CREP_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st2crep::W`](W) writer structure"]
impl crate::Writable for ST2CREP_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2CREP to value 0"]
impl crate::Resettable for ST2CREP_SPEC {
