...
pub type R = crate::R<ST2CAR_SPEC>;
#[doc = "Register `ST2CAR` writer"]
pub type W = crate::W<ST2CAR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn carl(&mut self) -> CARL_W<ST2CAR_SPEC, 0> {
        CARL_W::new(self)
    }
...
pub struct ST2CAR_SPEC;
impl crate::RegisterSpec for ST2CAR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2car::R`](R) reader structure"]
impl crate::Readable for ST2CAR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st2car::W`](W) writer structure"]
impl crate::Writable for ST2CAR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST2CAR to value 0"]
impl crate::Resettable for ST2CAR_SPEC {
