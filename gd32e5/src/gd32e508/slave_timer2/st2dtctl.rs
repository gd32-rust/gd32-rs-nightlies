...
pub type R = crate::R<ST2DTCTL_SPEC>;
#[doc = "Register `ST2DTCTL` writer"]
pub type W = crate::W<ST2DTCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dtrcfg(&mut self) -> DTRCFG_W<ST2DTCTL_SPEC, 0> {
        DTRCFG_W::new(self)
    }
    #[doc = "Bit 9 - The sign of falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtrs(&mut self) -> DTRS_W<ST2DTCTL_SPEC, 9> {
        DTRS_W::new(self)
    }
    #[doc = "Bits 10:13 - Dead time generator clock division"]
    #[inline(always)]
    #[must_use]
    pub fn dtgckdiv(&mut self) -> DTGCKDIV_W<ST2DTCTL_SPEC, 10> {
        DTGCKDIV_W::new(self)
    }
    #[doc = "Bit 14 - Dead-time rising edge protection for sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtrsprot(&mut self) -> DTRSPROT_W<ST2DTCTL_SPEC, 14> {
        DTRSPROT_W::new(self)
    }
    #[doc = "Bit 15 - Dead-time rising edge protection for value and sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtrsvprot(&mut self) -> DTRSVPROT_W<ST2DTCTL_SPEC, 15> {
        DTRSVPROT_W::new(self)
    }
    #[doc = "Bits 16:24 - Falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtfcfg(&mut self) -> DTFCFG_W<ST2DTCTL_SPEC, 16> {
        DTFCFG_W::new(self)
    }
    #[doc = "Bit 25 - The sign of falling edge dead-time value"]
    #[inline(always)]
    #[must_use]
    pub fn dtfs(&mut self) -> DTFS_W<ST2DTCTL_SPEC, 25> {
        DTFS_W::new(self)
    }
    #[doc = "Bit 30 - Dead-time falling edge protection for sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtfsprot(&mut self) -> DTFSPROT_W<ST2DTCTL_SPEC, 30> {
        DTFSPROT_W::new(self)
    }
    #[doc = "Bit 31 - Dead-time falling edge protection for value and sign"]
    #[inline(always)]
    #[must_use]
    pub fn dtfsvprot(&mut self) -> DTFSVPROT_W<ST2DTCTL_SPEC, 31> {
