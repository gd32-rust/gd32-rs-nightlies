...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0rssev(&mut self) -> Ch0rssevW<St2ch0rstSpec> {
        Ch0rssevW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave_TIMERx reset event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsrst(&mut self) -> Ch0rsrstW<St2ch0rstSpec> {
        Ch0rsrstW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave_TIMERx period event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsper(&mut self) -> Ch0rsperW<St2ch0rstSpec> {
        Ch0rsperW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave_TIMERx compare 0 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp0(&mut self) -> Ch0rscmp0W<St2ch0rstSpec> {
        Ch0rscmp0W::new(self, 3)
    }
    #[doc = "Bit 4 - Slave_TIMERx compare 1 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp1(&mut self) -> Ch0rscmp1W<St2ch0rstSpec> {
        Ch0rscmp1W::new(self, 4)
    }
    #[doc = "Bit 5 - Slave_TIMER1 compare 2 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp2(&mut self) -> Ch0rscmp2W<St2ch0rstSpec> {
        Ch0rscmp2W::new(self, 5)
    }
    #[doc = "Bit 6 - Slave_TIMERx compare 3 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rscmp3(&mut self) -> Ch0rscmp3W<St2ch0rstSpec> {
        Ch0rscmp3W::new(self, 6)
    }
    #[doc = "Bit 7 - Master_TIMER period event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtper(&mut self) -> Ch0rsmtperW<St2ch0rstSpec> {
        Ch0rsmtperW::new(self, 7)
    }
    #[doc = "Bit 8 - Master_TIMER compare 0 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp0(&mut self) -> Ch0rsmtcmp0W<St2ch0rstSpec> {
        Ch0rsmtcmp0W::new(self, 8)
    }
    #[doc = "Bit 9 - Master_TIMER compare 1 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp1(&mut self) -> Ch0rsmtcmp1W<St2ch0rstSpec> {
        Ch0rsmtcmp1W::new(self, 9)
    }
    #[doc = "Bit 10 - Master_TIMER compare 2 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp2(&mut self) -> Ch0rsmtcmp2W<St2ch0rstSpec> {
        Ch0rsmtcmp2W::new(self, 10)
    }
    #[doc = "Bit 11 - Master_TIMER compare 3 event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsmtcmp3(&mut self) -> Ch0rsmtcmp3W<St2ch0rstSpec> {
        Ch0rsmtcmp3W::new(self, 11)
    }
    #[doc = "Bit 12 - Slave_TIMER1 interconnection event 0 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev0(&mut self) -> Ch0rsstev0W<St2ch0rstSpec> {
        Ch0rsstev0W::new(self, 12)
    }
    #[doc = "Bit 13 - Slave_TIMERx interconnection event 1 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev1(&mut self) -> Ch0rsstev1W<St2ch0rstSpec> {
        Ch0rsstev1W::new(self, 13)
    }
    #[doc = "Bit 14 - Slave_TIMERx interconnection event 2 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev2(&mut self) -> Ch0rsstev2W<St2ch0rstSpec> {
        Ch0rsstev2W::new(self, 14)
    }
    #[doc = "Bit 15 - Slave_TIMERx interconnection event 3 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev3(&mut self) -> Ch0rsstev3W<St2ch0rstSpec> {
        Ch0rsstev3W::new(self, 15)
    }
    #[doc = "Bit 16 - Slave_TIMER1 interconnection event 4 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev4(&mut self) -> Ch0rsstev4W<St2ch0rstSpec> {
        Ch0rsstev4W::new(self, 16)
    }
    #[doc = "Bit 17 - Slave_TIMERx interconnection event 5 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev5(&mut self) -> Ch0rsstev5W<St2ch0rstSpec> {
        Ch0rsstev5W::new(self, 17)
    }
    #[doc = "Bit 18 - Slave_TIMERx interconnection event 6 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev6(&mut self) -> Ch0rsstev6W<St2ch0rstSpec> {
        Ch0rsstev6W::new(self, 18)
    }
    #[doc = "Bit 19 - Slave_TIMERx interconnection event 7 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev7(&mut self) -> Ch0rsstev7W<St2ch0rstSpec> {
        Ch0rsstev7W::new(self, 19)
    }
    #[doc = "Bit 20 - Slave_TIMERx interconnection event 8 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsstev8(&mut self) -> Ch0rsstev8W<St2ch0rstSpec> {
        Ch0rsstev8W::new(self, 20)
    }
    #[doc = "Bit 21 - External event 0 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev0(&mut self) -> Ch0rsexev0W<St2ch0rstSpec> {
        Ch0rsexev0W::new(self, 21)
    }
    #[doc = "Bit 22 - External event 1 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev1(&mut self) -> Ch0rsexev1W<St2ch0rstSpec> {
        Ch0rsexev1W::new(self, 22)
    }
    #[doc = "Bit 23 - External event 2 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev2(&mut self) -> Ch0rsexev2W<St2ch0rstSpec> {
        Ch0rsexev2W::new(self, 23)
    }
    #[doc = "Bit 24 - External event 3 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev3(&mut self) -> Ch0rsexev3W<St2ch0rstSpec> {
        Ch0rsexev3W::new(self, 24)
    }
    #[doc = "Bit 25 - External event 4 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev4(&mut self) -> Ch0rsexev4W<St2ch0rstSpec> {
        Ch0rsexev4W::new(self, 25)
    }
    #[doc = "Bit 26 - External event 5 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev5(&mut self) -> Ch0rsexev5W<St2ch0rstSpec> {
        Ch0rsexev5W::new(self, 26)
    }
    #[doc = "Bit 27 - External event 6 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev6(&mut self) -> Ch0rsexev6W<St2ch0rstSpec> {
        Ch0rsexev6W::new(self, 27)
    }
    #[doc = "Bit 28 - External event 7 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev7(&mut self) -> Ch0rsexev7W<St2ch0rstSpec> {
        Ch0rsexev7W::new(self, 28)
    }
    #[doc = "Bit 29 - External event 8 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev8(&mut self) -> Ch0rsexev8W<St2ch0rstSpec> {
        Ch0rsexev8W::new(self, 29)
    }
    #[doc = "Bit 30 - External event 9 generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsexev9(&mut self) -> Ch0rsexev9W<St2ch0rstSpec> {
        Ch0rsexev9W::new(self, 30)
    }
    #[doc = "Bit 31 - Update event generates channel 0"]
    #[inline(always)]
    #[must_use]
    pub fn ch0rsup(&mut self) -> Ch0rsupW<St2ch0rstSpec> {
