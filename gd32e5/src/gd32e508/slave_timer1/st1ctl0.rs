...
pub type R = crate::R<ST1CTL0_SPEC>;
#[doc = "Register `ST1CTL0` writer"]
pub type W = crate::W<ST1CTL0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntckdiv(&mut self) -> CNTCKDIV_W<ST1CTL0_SPEC, 0> {
        CNTCKDIV_W::new(self)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    #[must_use]
    pub fn ctnm(&mut self) -> CTNM_W<ST1CTL0_SPEC, 3> {
        CTNM_W::new(self)
    }
    #[doc = "Bit 4 - Counter reset mode"]
    #[inline(always)]
    #[must_use]
    pub fn cntrstm(&mut self) -> CNTRSTM_W<ST1CTL0_SPEC, 4> {
        CNTRSTM_W::new(self)
    }
    #[doc = "Bit 5 - Half mode"]
    #[inline(always)]
    #[must_use]
    pub fn halfm(&mut self) -> HALFM_W<ST1CTL0_SPEC, 5> {
        HALFM_W::new(self)
    }
    #[doc = "Bit 6 - Balanced mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn blnmen(&mut self) -> BLNMEN_W<ST1CTL0_SPEC, 6> {
        BLNMEN_W::new(self)
    }
    #[doc = "Bit 10 - Synchronization input reset counter"]
    #[inline(always)]
    #[must_use]
    pub fn synirst(&mut self) -> SYNIRST_W<ST1CTL0_SPEC, 10> {
        SYNIRST_W::new(self)
    }
    #[doc = "Bit 11 - Synchronization input start counter"]
    #[inline(always)]
    #[must_use]
    pub fn synistrt(&mut self) -> SYNISTRT_W<ST1CTL0_SPEC, 11> {
        SYNISTRT_W::new(self)
    }
    #[doc = "Bits 12:13 - Compare 1 delayed mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp1m(&mut self) -> DELCMP1M_W<ST1CTL0_SPEC, 12> {
        DELCMP1M_W::new(self)
    }
    #[doc = "Bits 14:15 - Compare 3 delayed mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp3m(&mut self) -> DELCMP3M_W<ST1CTL0_SPEC, 14> {
        DELCMP3M_W::new(self)
    }
    #[doc = "Bit 17 - Update event generated by repetition event"]
    #[inline(always)]
    #[must_use]
    pub fn uprep(&mut self) -> UPREP_W<ST1CTL0_SPEC, 17> {
        UPREP_W::new(self)
    }
    #[doc = "Bit 18 - Update event generated by reset event"]
    #[inline(always)]
    #[must_use]
    pub fn uprst(&mut self) -> UPRST_W<ST1CTL0_SPEC, 18> {
        UPRST_W::new(self)
    }
    #[doc = "Bit 19 - Update by Slave_TIMER0 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst0(&mut self) -> UPBST0_W<ST1CTL0_SPEC, 19> {
        UPBST0_W::new(self)
    }
    #[doc = "Bit 21 - Update by Slave_TIMER2 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst2(&mut self) -> UPBST2_W<ST1CTL0_SPEC, 21> {
        UPBST2_W::new(self)
    }
    #[doc = "Bit 22 - Update by Slave_TIMER3 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst3(&mut self) -> UPBST3_W<ST1CTL0_SPEC, 22> {
        UPBST3_W::new(self)
    }
    #[doc = "Bit 23 - Update by Slave_TIMER4 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst4(&mut self) -> UPBST4_W<ST1CTL0_SPEC, 23> {
        UPBST4_W::new(self)
    }
    #[doc = "Bit 24 - Update by Master_TIMER update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbmt(&mut self) -> UPBMT_W<ST1CTL0_SPEC, 24> {
        UPBMT_W::new(self)
    }
    #[doc = "Bits 25:26 - Trigger source to DAC"]
    #[inline(always)]
    #[must_use]
    pub fn dactrgs(&mut self) -> DACTRGS_W<ST1CTL0_SPEC, 25> {
        DACTRGS_W::new(self)
    }
    #[doc = "Bit 27 - Shadow registers enable"]
    #[inline(always)]
    #[must_use]
    pub fn shwen(&mut self) -> SHWEN_W<ST1CTL0_SPEC, 27> {
        SHWEN_W::new(self)
    }
    #[doc = "Bits 28:31 - Update event selection"]
    #[inline(always)]
    #[must_use]
    pub fn upsel(&mut self) -> UPSEL_W<ST1CTL0_SPEC, 28> {
        UPSEL_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMER1 control register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st1ctl0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st1ctl0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST1CTL0_SPEC;
impl crate::RegisterSpec for ST1CTL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1ctl0::R`](R) reader structure"]
impl crate::Readable for ST1CTL0_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st1ctl0::W`](W) writer structure"]
impl crate::Writable for ST1CTL0_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST1CTL0 to value 0"]
impl crate::Resettable for ST1CTL0_SPEC {
