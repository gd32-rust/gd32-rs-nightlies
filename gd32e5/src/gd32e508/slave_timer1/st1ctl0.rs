...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cntckdiv(&mut self) -> CntckdivW<St1ctl0Spec> {
        CntckdivW::new(self, 0)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    #[must_use]
    pub fn ctnm(&mut self) -> CtnmW<St1ctl0Spec> {
        CtnmW::new(self, 3)
    }
    #[doc = "Bit 4 - Counter reset mode"]
    #[inline(always)]
    #[must_use]
    pub fn cntrstm(&mut self) -> CntrstmW<St1ctl0Spec> {
        CntrstmW::new(self, 4)
    }
    #[doc = "Bit 5 - Half mode"]
    #[inline(always)]
    #[must_use]
    pub fn halfm(&mut self) -> HalfmW<St1ctl0Spec> {
        HalfmW::new(self, 5)
    }
    #[doc = "Bit 6 - Balanced mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn blnmen(&mut self) -> BlnmenW<St1ctl0Spec> {
        BlnmenW::new(self, 6)
    }
    #[doc = "Bit 10 - Synchronization input reset counter"]
    #[inline(always)]
    #[must_use]
    pub fn synirst(&mut self) -> SynirstW<St1ctl0Spec> {
        SynirstW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronization input start counter"]
    #[inline(always)]
    #[must_use]
    pub fn synistrt(&mut self) -> SynistrtW<St1ctl0Spec> {
        SynistrtW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Compare 1 delayed mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp1m(&mut self) -> Delcmp1mW<St1ctl0Spec> {
        Delcmp1mW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Compare 3 delayed mode"]
    #[inline(always)]
    #[must_use]
    pub fn delcmp3m(&mut self) -> Delcmp3mW<St1ctl0Spec> {
        Delcmp3mW::new(self, 14)
    }
    #[doc = "Bit 17 - Update event generated by repetition event"]
    #[inline(always)]
    #[must_use]
    pub fn uprep(&mut self) -> UprepW<St1ctl0Spec> {
        UprepW::new(self, 17)
    }
    #[doc = "Bit 18 - Update event generated by reset event"]
    #[inline(always)]
    #[must_use]
    pub fn uprst(&mut self) -> UprstW<St1ctl0Spec> {
        UprstW::new(self, 18)
    }
    #[doc = "Bit 19 - Update by Slave_TIMER0 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst0(&mut self) -> Upbst0W<St1ctl0Spec> {
        Upbst0W::new(self, 19)
    }
    #[doc = "Bit 21 - Update by Slave_TIMER2 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst2(&mut self) -> Upbst2W<St1ctl0Spec> {
        Upbst2W::new(self, 21)
    }
    #[doc = "Bit 22 - Update by Slave_TIMER3 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst3(&mut self) -> Upbst3W<St1ctl0Spec> {
        Upbst3W::new(self, 22)
    }
    #[doc = "Bit 23 - Update by Slave_TIMER4 update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbst4(&mut self) -> Upbst4W<St1ctl0Spec> {
        Upbst4W::new(self, 23)
    }
    #[doc = "Bit 24 - Update by Master_TIMER update event"]
    #[inline(always)]
    #[must_use]
    pub fn upbmt(&mut self) -> UpbmtW<St1ctl0Spec> {
        UpbmtW::new(self, 24)
    }
    #[doc = "Bits 25:26 - Trigger source to DAC"]
    #[inline(always)]
    #[must_use]
    pub fn dactrgs(&mut self) -> DactrgsW<St1ctl0Spec> {
        DactrgsW::new(self, 25)
    }
    #[doc = "Bit 27 - Shadow registers enable"]
    #[inline(always)]
    #[must_use]
    pub fn shwen(&mut self) -> ShwenW<St1ctl0Spec> {
        ShwenW::new(self, 27)
    }
    #[doc = "Bits 28:31 - Update event selection"]
    #[inline(always)]
    #[must_use]
    pub fn upsel(&mut self) -> UpselW<St1ctl0Spec> {
        UpselW::new(self, 28)
    }
}
