...
pub type R = crate::R<ST1DMAINTEN_SPEC>;
#[doc = "Register `ST1DMAINTEN` writer"]
pub type W = crate::W<ST1DMAINTEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0ie(&mut self) -> CMP0IE_W<ST1DMAINTEN_SPEC, 0> {
        CMP0IE_W::new(self)
    }
    #[doc = "Bit 1 - Compare 1 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1ie(&mut self) -> CMP1IE_W<ST1DMAINTEN_SPEC, 1> {
        CMP1IE_W::new(self)
    }
    #[doc = "Bit 2 - Compare 2 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2ie(&mut self) -> CMP2IE_W<ST1DMAINTEN_SPEC, 2> {
        CMP2IE_W::new(self)
    }
    #[doc = "Bit 3 - Compare 3 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3ie(&mut self) -> CMP3IE_W<ST1DMAINTEN_SPEC, 3> {
        CMP3IE_W::new(self)
    }
    #[doc = "Bit 4 - Repetition interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn repie(&mut self) -> REPIE_W<ST1DMAINTEN_SPEC, 4> {
        REPIE_W::new(self)
    }
    #[doc = "Bit 6 - Update interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn upie(&mut self) -> UPIE_W<ST1DMAINTEN_SPEC, 6> {
        UPIE_W::new(self)
    }
    #[doc = "Bit 7 - Capture 0 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap0ie(&mut self) -> CAP0IE_W<ST1DMAINTEN_SPEC, 7> {
        CAP0IE_W::new(self)
    }
    #[doc = "Bit 8 - Capture 1 interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap1ie(&mut self) -> CAP1IE_W<ST1DMAINTEN_SPEC, 8> {
        CAP1IE_W::new(self)
    }
    #[doc = "Bit 9 - Channel 0 output active interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0oaie(&mut self) -> CH0OAIE_W<ST1DMAINTEN_SPEC, 9> {
        CH0OAIE_W::new(self)
    }
    #[doc = "Bit 10 - Channel 0 output inactive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0onaie(&mut self) -> CH0ONAIE_W<ST1DMAINTEN_SPEC, 10> {
        CH0ONAIE_W::new(self)
    }
    #[doc = "Bit 11 - Channel 1 output active interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1oaie(&mut self) -> CH1OAIE_W<ST1DMAINTEN_SPEC, 11> {
        CH1OAIE_W::new(self)
    }
    #[doc = "Bit 12 - Channel 1 output inactive interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1onaie(&mut self) -> CH1ONAIE_W<ST1DMAINTEN_SPEC, 12> {
        CH1ONAIE_W::new(self)
    }
    #[doc = "Bit 13 - Counter reset interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn rstie(&mut self) -> RSTIE_W<ST1DMAINTEN_SPEC, 13> {
        RSTIE_W::new(self)
    }
    #[doc = "Bit 14 - Delayed IDLE mode entry interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyiie(&mut self) -> DLYIIE_W<ST1DMAINTEN_SPEC, 14> {
        DLYIIE_W::new(self)
    }
    #[doc = "Bit 16 - Compare 0 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp0den(&mut self) -> CMP0DEN_W<ST1DMAINTEN_SPEC, 16> {
        CMP0DEN_W::new(self)
    }
    #[doc = "Bit 17 - Compare 1 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp1den(&mut self) -> CMP1DEN_W<ST1DMAINTEN_SPEC, 17> {
        CMP1DEN_W::new(self)
    }
    #[doc = "Bit 18 - Compare 2 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp2den(&mut self) -> CMP2DEN_W<ST1DMAINTEN_SPEC, 18> {
        CMP2DEN_W::new(self)
    }
    #[doc = "Bit 19 - Compare 3 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cmp3den(&mut self) -> CMP3DEN_W<ST1DMAINTEN_SPEC, 19> {
        CMP3DEN_W::new(self)
    }
    #[doc = "Bit 20 - Repetition DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn repden(&mut self) -> REPDEN_W<ST1DMAINTEN_SPEC, 20> {
        REPDEN_W::new(self)
    }
    #[doc = "Bit 22 - Update DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn upden(&mut self) -> UPDEN_W<ST1DMAINTEN_SPEC, 22> {
        UPDEN_W::new(self)
    }
    #[doc = "Bit 23 - Capture 0 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap0den(&mut self) -> CAP0DEN_W<ST1DMAINTEN_SPEC, 23> {
        CAP0DEN_W::new(self)
    }
    #[doc = "Bit 24 - Capture 1 DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn cap1den(&mut self) -> CAP1DEN_W<ST1DMAINTEN_SPEC, 24> {
        CAP1DEN_W::new(self)
    }
    #[doc = "Bit 25 - Channel 0 output active DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0aden(&mut self) -> CH0ADEN_W<ST1DMAINTEN_SPEC, 25> {
        CH0ADEN_W::new(self)
    }
    #[doc = "Bit 26 - Channel 0 output inactive DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch0onaden(&mut self) -> CH0ONADEN_W<ST1DMAINTEN_SPEC, 26> {
        CH0ONADEN_W::new(self)
    }
    #[doc = "Bit 27 - Channel 1 output active DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1oaden(&mut self) -> CH1OADEN_W<ST1DMAINTEN_SPEC, 27> {
        CH1OADEN_W::new(self)
    }
    #[doc = "Bit 28 - Channel 1 output inactive DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn ch1onaden(&mut self) -> CH1ONADEN_W<ST1DMAINTEN_SPEC, 28> {
        CH1ONADEN_W::new(self)
    }
    #[doc = "Bit 29 - Counter reset DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn rstden(&mut self) -> RSTDEN_W<ST1DMAINTEN_SPEC, 29> {
        RSTDEN_W::new(self)
    }
    #[doc = "Bit 30 - Delayed IDLE mode entry DMA request enable"]
    #[inline(always)]
    #[must_use]
    pub fn dlyiden(&mut self) -> DLYIDEN_W<ST1DMAINTEN_SPEC, 30> {
        DLYIDEN_W::new(self)
    }
...
#[doc = "SHRTIMER Slave_TIMER1 DMA and interrupt enable register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st1dmainten::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`st1dmainten::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST1DMAINTEN_SPEC;
impl crate::RegisterSpec for ST1DMAINTEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1dmainten::R`](R) reader structure"]
impl crate::Readable for ST1DMAINTEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`st1dmainten::W`](W) writer structure"]
impl crate::Writable for ST1DMAINTEN_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ST1DMAINTEN to value 0"]
impl crate::Resettable for ST1DMAINTEN_SPEC {
