...
pub type R = crate::R<ST1INTF_SPEC>;
...
#[doc = "SHRTIMER Slave_TIMER1 interrupt flag register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`st1intf::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ST1INTF_SPEC;
impl crate::RegisterSpec for ST1INTF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1intf::R`](R) reader structure"]
impl crate::Readable for ST1INTF_SPEC {}
#[doc = "`reset()` method sets ST1INTF to value 0"]
impl crate::Resettable for ST1INTF_SPEC {
