...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0a(&mut self) -> CP0BST0A_W<ST1CAP0TRG_SPEC, 12> {
        CP0BST0A_W::new(self)
    }
    #[doc = "Bit 13 - Capture 0 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0na(&mut self) -> CP0BST0NA_W<ST1CAP0TRG_SPEC, 13> {
        CP0BST0NA_W::new(self)
    }
    #[doc = "Bit 14 - Capture 0 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp0(&mut self) -> CP0BST0CMP0_W<ST1CAP0TRG_SPEC, 14> {
        CP0BST0CMP0_W::new(self)
    }
    #[doc = "Bit 15 - Capture 0 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst0cmp1(&mut self) -> CP0BST0CMP1_W<ST1CAP0TRG_SPEC, 15> {
        CP0BST0CMP1_W::new(self)
    }
    #[doc = "Bit 20 - Capture 0 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2a(&mut self) -> CP0BST2A_W<ST1CAP0TRG_SPEC, 20> {
        CP0BST2A_W::new(self)
    }
    #[doc = "Bit 21 - Capture 0 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2na(&mut self) -> CP0BST2NA_W<ST1CAP0TRG_SPEC, 21> {
        CP0BST2NA_W::new(self)
    }
    #[doc = "Bit 22 - Capture 0 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp0(&mut self) -> CP0BST2CMP0_W<ST1CAP0TRG_SPEC, 22> {
        CP0BST2CMP0_W::new(self)
    }
    #[doc = "Bit 23 - Capture 0 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst2cmp1(&mut self) -> CP0BST2CMP1_W<ST1CAP0TRG_SPEC, 23> {
        CP0BST2CMP1_W::new(self)
    }
    #[doc = "Bit 24 - Capture 0 triggered by ST3CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3a(&mut self) -> CP0BST3A_W<ST1CAP0TRG_SPEC, 24> {
        CP0BST3A_W::new(self)
    }
    #[doc = "Bit 25 - Capture 0 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3na(&mut self) -> CP0BST3NA_W<ST1CAP0TRG_SPEC, 25> {
        CP0BST3NA_W::new(self)
    }
    #[doc = "Bit 26 - Capture 0 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp0(&mut self) -> CP0BST3CMP0_W<ST1CAP0TRG_SPEC, 26> {
        CP0BST3CMP0_W::new(self)
    }
    #[doc = "Bit 27 - Capture 0 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst3cmp1(&mut self) -> CP0BST3CMP1_W<ST1CAP0TRG_SPEC, 27> {
        CP0BST3CMP1_W::new(self)
    }
    #[doc = "Bit 28 - Capture 0 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4a(&mut self) -> CP0BST4A_W<ST1CAP0TRG_SPEC, 28> {
        CP0BST4A_W::new(self)
    }
    #[doc = "Bit 29 - Capture 0 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4na(&mut self) -> CP0BST4NA_W<ST1CAP0TRG_SPEC, 29> {
        CP0BST4NA_W::new(self)
    }
    #[doc = "Bit 30 - Capture 0 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp0(&mut self) -> CP0BST4CMP0_W<ST1CAP0TRG_SPEC, 30> {
        CP0BST4CMP0_W::new(self)
    }
    #[doc = "Bit 31 - Capture 0 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    #[must_use]
    pub fn cp0bst4cmp1(&mut self) -> CP0BST4CMP1_W<ST1CAP0TRG_SPEC, 31> {
