...
pub type R = crate::R<HCH6DMAADDR_SPEC>;
#[doc = "Register `HCH6DMAADDR` writer"]
pub type W = crate::W<HCH6DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<HCH6DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct HCH6DMAADDR_SPEC;
impl crate::RegisterSpec for HCH6DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch6dmaaddr::R`](R) reader structure"]
impl crate::Readable for HCH6DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch6dmaaddr::W`](W) writer structure"]
impl crate::Writable for HCH6DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH6DMAADDR to value 0"]
impl crate::Resettable for HCH6DMAADDR_SPEC {
