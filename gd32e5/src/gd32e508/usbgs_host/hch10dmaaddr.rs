...
pub type R = crate::R<HCH10DMAADDR_SPEC>;
#[doc = "Register `HCH10DMAADDR` writer"]
pub type W = crate::W<HCH10DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<HCH10DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct HCH10DMAADDR_SPEC;
impl crate::RegisterSpec for HCH10DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch10dmaaddr::R`](R) reader structure"]
impl crate::Readable for HCH10DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch10dmaaddr::W`](W) writer structure"]
impl crate::Writable for HCH10DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH10DMAADDR to value 0"]
impl crate::Resettable for HCH10DMAADDR_SPEC {
