...
pub type PTEST_R = crate::FieldReader;
#[doc = "Field `PTEST` writer - Port Test control"]
pub type PTEST_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ptest(&self) -> PTEST_R {
        PTEST_R::new(((self.bits >> 13) & 0x0f) as u8)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ptest(&mut self) -> PTEST_W<HPCS_SPEC, 13> {
        PTEST_W::new(self)
    }
