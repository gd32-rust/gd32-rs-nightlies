...
pub type R = crate::R<HCH10LEN_SPEC>;
#[doc = "Register `HCH10LEN` writer"]
pub type W = crate::W<HCH10LEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tlen(&mut self) -> TLEN_W<HCH10LEN_SPEC, 0> {
        TLEN_W::new(self)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pcnt(&mut self) -> PCNT_W<HCH10LEN_SPEC, 19> {
        PCNT_W::new(self)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    #[must_use]
    pub fn dpid(&mut self) -> DPID_W<HCH10LEN_SPEC, 29> {
        DPID_W::new(self)
    }
    #[doc = "Bit 31 - PING token request"]
    #[inline(always)]
    #[must_use]
    pub fn ping(&mut self) -> PING_W<HCH10LEN_SPEC, 31> {
        PING_W::new(self)
    }
...
#[doc = "host channel-10 transfer length register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hch10len::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hch10len::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCH10LEN_SPEC;
impl crate::RegisterSpec for HCH10LEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch10len::R`](R) reader structure"]
impl crate::Readable for HCH10LEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch10len::W`](W) writer structure"]
impl crate::Writable for HCH10LEN_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH10LEN to value 0"]
impl crate::Resettable for HCH10LEN_SPEC {
