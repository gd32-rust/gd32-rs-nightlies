...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tf(&mut self) -> TF_W<HCH3INTF_SPEC, 0> {
        TF_W::new(self)
    }
    #[doc = "Bit 1 - Channel halted"]
    #[inline(always)]
    #[must_use]
    pub fn ch(&mut self) -> CH_W<HCH3INTF_SPEC, 1> {
        CH_W::new(self)
    }
    #[doc = "Bit 2 - DMA Error"]
    #[inline(always)]
    #[must_use]
    pub fn dmaer(&mut self) -> DMAER_W<HCH3INTF_SPEC, 2> {
        DMAER_W::new(self)
    }
    #[doc = "Bit 3 - STALL response received interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<HCH3INTF_SPEC, 3> {
        STALL_W::new(self)
    }
    #[doc = "Bit 4 - NAK response received interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn nak(&mut self) -> NAK_W<HCH3INTF_SPEC, 4> {
        NAK_W::new(self)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn ack(&mut self) -> ACK_W<HCH3INTF_SPEC, 5> {
        ACK_W::new(self)
    }
    #[doc = "Bit 6 - NYET"]
    #[inline(always)]
    #[must_use]
    pub fn nyet(&mut self) -> NYET_W<HCH3INTF_SPEC, 6> {
        NYET_W::new(self)
    }
    #[doc = "Bit 7 - USB bus error"]
    #[inline(always)]
    #[must_use]
    pub fn usber(&mut self) -> USBER_W<HCH3INTF_SPEC, 7> {
        USBER_W::new(self)
    }
    #[doc = "Bit 8 - Babble error"]
    #[inline(always)]
    #[must_use]
    pub fn bber(&mut self) -> BBER_W<HCH3INTF_SPEC, 8> {
        BBER_W::new(self)
    }
    #[doc = "Bit 9 - Request queue overrun"]
    #[inline(always)]
    #[must_use]
    pub fn reqovr(&mut self) -> REQOVR_W<HCH3INTF_SPEC, 9> {
        REQOVR_W::new(self)
    }
    #[doc = "Bit 10 - Data toggle error"]
    #[inline(always)]
    #[must_use]
    pub fn dter(&mut self) -> DTER_W<HCH3INTF_SPEC, 10> {
        DTER_W::new(self)
    }
