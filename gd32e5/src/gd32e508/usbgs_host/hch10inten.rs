...
pub type R = crate::R<HCH10INTEN_SPEC>;
#[doc = "Register `HCH10INTEN` writer"]
pub type W = crate::W<HCH10INTEN_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tfie(&mut self) -> TFIE_W<HCH10INTEN_SPEC, 0> {
        TFIE_W::new(self)
    }
    #[doc = "Bit 1 - Channel halted interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn chie(&mut self) -> CHIE_W<HCH10INTEN_SPEC, 1> {
        CHIE_W::new(self)
    }
    #[doc = "Bit 3 - STALL interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn stallie(&mut self) -> STALLIE_W<HCH10INTEN_SPEC, 3> {
        STALLIE_W::new(self)
    }
    #[doc = "Bit 4 - NAK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn nakie(&mut self) -> NAKIE_W<HCH10INTEN_SPEC, 4> {
        NAKIE_W::new(self)
    }
    #[doc = "Bit 5 - ACK interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn ackie(&mut self) -> ACKIE_W<HCH10INTEN_SPEC, 5> {
        ACKIE_W::new(self)
    }
    #[doc = "Bit 7 - USB bus error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn usberie(&mut self) -> USBERIE_W<HCH10INTEN_SPEC, 7> {
        USBERIE_W::new(self)
    }
    #[doc = "Bit 8 - Babble error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn bberie(&mut self) -> BBERIE_W<HCH10INTEN_SPEC, 8> {
        BBERIE_W::new(self)
    }
    #[doc = "Bit 9 - request queue overrun interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn reqovrie(&mut self) -> REQOVRIE_W<HCH10INTEN_SPEC, 9> {
        REQOVRIE_W::new(self)
    }
    #[doc = "Bit 10 - Data toggle error interrupt enable"]
    #[inline(always)]
    #[must_use]
    pub fn dterie(&mut self) -> DTERIE_W<HCH10INTEN_SPEC, 10> {
        DTERIE_W::new(self)
    }
...
#[doc = "host channel-10 interrupt enable register (HCH10INTEN)\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`hch10inten::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`hch10inten::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HCH10INTEN_SPEC;
impl crate::RegisterSpec for HCH10INTEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hch10inten::R`](R) reader structure"]
impl crate::Readable for HCH10INTEN_SPEC {}
#[doc = "`write(|w| ..)` method takes [`hch10inten::W`](W) writer structure"]
impl crate::Writable for HCH10INTEN_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets HCH10INTEN to value 0"]
impl crate::Resettable for HCH10INTEN_SPEC {
