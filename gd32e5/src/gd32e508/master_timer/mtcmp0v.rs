...
pub type R = crate::R<MTCMP0V_SPEC>;
#[doc = "Register `MTCMP0V` writer"]
pub type W = crate::W<MTCMP0V_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmp0val(&mut self) -> CMP0VAL_W<MTCMP0V_SPEC, 0> {
        CMP0VAL_W::new(self)
    }
...
pub struct MTCMP0V_SPEC;
impl crate::RegisterSpec for MTCMP0V_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mtcmp0v::R`](R) reader structure"]
impl crate::Readable for MTCMP0V_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mtcmp0v::W`](W) writer structure"]
impl crate::Writable for MTCMP0V_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MTCMP0V to value 0"]
impl crate::Resettable for MTCMP0V_SPEC {
