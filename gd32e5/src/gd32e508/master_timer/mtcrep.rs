...
pub type R = crate::R<MTCREP_SPEC>;
#[doc = "Register `MTCREP` writer"]
pub type W = crate::W<MTCREP_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn crep(&mut self) -> CREP_W<MTCREP_SPEC, 0> {
        CREP_W::new(self)
    }
...
pub struct MTCREP_SPEC;
impl crate::RegisterSpec for MTCREP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`mtcrep::R`](R) reader structure"]
impl crate::Readable for MTCREP_SPEC {}
#[doc = "`write(|w| ..)` method takes [`mtcrep::W`](W) writer structure"]
impl crate::Writable for MTCREP_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets MTCREP to value 0"]
impl crate::Resettable for MTCREP_SPEC {
