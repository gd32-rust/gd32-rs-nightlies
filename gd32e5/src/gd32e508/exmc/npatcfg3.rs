...
pub type R = crate::R<NPATCFG3_SPEC>;
#[doc = "Register `NPATCFG3` writer"]
pub type W = crate::W<NPATCFG3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn attset(&mut self) -> ATTSET_W<NPATCFG3_SPEC, 0> {
        ATTSET_W::new(self)
    }
    #[doc = "Bits 8:15 - Attribute memory wait time"]
    #[inline(always)]
    #[must_use]
    pub fn attwait(&mut self) -> ATTWAIT_W<NPATCFG3_SPEC, 8> {
        ATTWAIT_W::new(self)
    }
    #[doc = "Bits 16:23 - Attribute memory hold time"]
    #[inline(always)]
    #[must_use]
    pub fn atthld(&mut self) -> ATTHLD_W<NPATCFG3_SPEC, 16> {
        ATTHLD_W::new(self)
    }
    #[doc = "Bits 24:31 - Attribute memory data bus HiZ time"]
    #[inline(always)]
    #[must_use]
    pub fn atthiz(&mut self) -> ATTHIZ_W<NPATCFG3_SPEC, 24> {
        ATTHIZ_W::new(self)
    }
...
#[doc = "NAND flash/PC card attribute space timing configuration register 3\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`npatcfg3::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`npatcfg3::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
