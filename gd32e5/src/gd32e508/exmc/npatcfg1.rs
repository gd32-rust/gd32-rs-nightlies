...
pub type R = crate::R<NPATCFG1_SPEC>;
#[doc = "Register `NPATCFG1` writer"]
pub type W = crate::W<NPATCFG1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn attset(&mut self) -> ATTSET_W<NPATCFG1_SPEC, 0> {
        ATTSET_W::new(self)
    }
    #[doc = "Bits 8:15 - Attribute memory wait time"]
    #[inline(always)]
    #[must_use]
    pub fn attwait(&mut self) -> ATTWAIT_W<NPATCFG1_SPEC, 8> {
        ATTWAIT_W::new(self)
    }
    #[doc = "Bits 16:23 - Attribute memory hold time"]
    #[inline(always)]
    #[must_use]
    pub fn atthld(&mut self) -> ATTHLD_W<NPATCFG1_SPEC, 16> {
        ATTHLD_W::new(self)
    }
    #[doc = "Bits 24:31 - Attribute memory data bus HiZ time"]
    #[inline(always)]
    #[must_use]
    pub fn atthiz(&mut self) -> ATTHIZ_W<NPATCFG1_SPEC, 24> {
        ATTHIZ_W::new(self)
    }
