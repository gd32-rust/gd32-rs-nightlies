...
pub type R = crate::R<DOEP1DMAADDR_SPEC>;
#[doc = "Register `DOEP1DMAADDR` writer"]
pub type W = crate::W<DOEP1DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DOEP1DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct DOEP1DMAADDR_SPEC;
impl crate::RegisterSpec for DOEP1DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep1dmaaddr::R`](R) reader structure"]
impl crate::Readable for DOEP1DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep1dmaaddr::W`](W) writer structure"]
impl crate::Writable for DOEP1DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP1DMAADDR to value 0"]
impl crate::Resettable for DOEP1DMAADDR_SPEC {
