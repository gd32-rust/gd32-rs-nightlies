...
pub type R = crate::R<DOEP3DMAADDR_SPEC>;
#[doc = "Register `DOEP3DMAADDR` writer"]
pub type W = crate::W<DOEP3DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DOEP3DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct DOEP3DMAADDR_SPEC;
impl crate::RegisterSpec for DOEP3DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep3dmaaddr::R`](R) reader structure"]
impl crate::Readable for DOEP3DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep3dmaaddr::W`](W) writer structure"]
impl crate::Writable for DOEP3DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP3DMAADDR to value 0"]
impl crate::Resettable for DOEP3DMAADDR_SPEC {
