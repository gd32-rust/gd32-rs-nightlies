...
pub type R = crate::R<DOEP5DMAADDR_SPEC>;
#[doc = "Register `DOEP5DMAADDR` writer"]
pub type W = crate::W<DOEP5DMAADDR_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DMAADDR_W<DOEP5DMAADDR_SPEC, 0> {
        DMAADDR_W::new(self)
    }
...
pub struct DOEP5DMAADDR_SPEC;
impl crate::RegisterSpec for DOEP5DMAADDR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`doep5dmaaddr::R`](R) reader structure"]
impl crate::Readable for DOEP5DMAADDR_SPEC {}
#[doc = "`write(|w| ..)` method takes [`doep5dmaaddr::W`](W) writer structure"]
impl crate::Writable for DOEP5DMAADDR_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets DOEP5DMAADDR to value 0"]
impl crate::Resettable for DOEP5DMAADDR_SPEC {
