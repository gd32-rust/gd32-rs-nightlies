...
impl R {
    ...
    #[inline(always)]
    pub fn rten20(&self) -> RTEN20_R {
        RTEN20_R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rten20(&mut self) -> RTEN20_W<RTEN_SPEC, 20> {
        RTEN20_W::new(self)
    }
    #[doc = "Bit 21 - Rising edge trigger enable of line 21"]
    #[inline(always)]
