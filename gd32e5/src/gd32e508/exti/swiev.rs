...
impl R {
    ...
    #[inline(always)]
    pub fn swiev20(&self) -> SWIEV20_R {
        SWIEV20_R::new(((self.bits >> 20) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swiev19(&mut self) -> SWIEV19_W<SWIEV_SPEC, 19> {
        SWIEV19_W::new(self)
    }
    #[doc = "Bit 20 - Interrupt/Event software trigger on line 20"]
    #[inline(always)]
    #[must_use]
    pub fn swiev20(&mut self) -> SWIEV20_W<SWIEV_SPEC, 20> {
        SWIEV20_W::new(self)
    }
    #[doc = "Bit 21 - Interrupt/Event software trigger on line 21"]
    #[inline(always)]
    #[must_use]
    pub fn swiev21(&mut self) -> SWIEV21_W<SWIEV_SPEC, 21> {
        SWIEV21_W::new(self)
    }
