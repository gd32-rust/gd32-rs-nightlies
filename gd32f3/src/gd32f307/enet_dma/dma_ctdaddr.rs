...
pub struct R(crate::R<DMA_CTDADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_CTDADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_CTDADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_CTDADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Field `TDAP` reader - transmit descriptor address pointer"]
pub type TDAP_R = crate::FieldReader<u32, u32>;
impl R {
...
#[doc = "DMA current transmit descriptor address register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_ctdaddr](index.html) module"]
