...
pub type CTC_REMAP_R = crate::FieldReader;
#[doc = "Field `CTC_REMAP` writer - CTC remapping"]
pub type CTC_REMAP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
    ...
    pub fn ctc_remap(&self) -> CTC_REMAP_R {
        CTC_REMAP_R::new(((self.bits >> 11) & 3) as u8)
    }
}
impl W {
    #[doc = "Bit 5 - TIMER8 remapping"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn fsmc_nadv(&mut self) -> FSMC_NADV_W<PCF1_SPEC, 10> {
        FSMC_NADV_W::new(self)
    }
    #[doc = "Bits 11:12 - CTC remapping"]
    #[inline(always)]
    #[must_use]
    pub fn ctc_remap(&mut self) -> CTC_REMAP_W<PCF1_SPEC, 11> {
        CTC_REMAP_W::new(self)
    }
