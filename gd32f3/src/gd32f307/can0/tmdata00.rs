...
pub struct R(crate::R<TMDATA00_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TMDATA00_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TMDATA00_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TMDATA00_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TMDATA00` writer"]
pub struct W(crate::W<TMDATA00_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TMDATA00_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TMDATA00_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TMDATA00_SPEC>) -> Self {
        W(writer)
    }
}
