...
pub struct RegisterBlock {
    ...
    pub ptp_tsf: crate::Reg<ptp_tsf::PTP_TSF_SPEC>,
    #[doc = "0x2c - Ethernet PTP PPS control register"]
    pub ptp_ppsctl: crate::Reg<ptp_ppsctl::PTP_PPSCTL_SPEC>,
}
...
pub mod ptp_etl;
#[doc = "PTP_TSF register accessor: an alias for `Reg<PTP_TSF_SPEC>`"]
pub type PTP_TSF = crate::Reg<ptp_tsf::PTP_TSF_SPEC>;
#[doc = "Ethernet PTP time stamp flag register"]
pub mod ptp_tsf;
#[doc = "PTP_PPSCTL register accessor: an alias for `Reg<PTP_PPSCTL_SPEC>`"]
