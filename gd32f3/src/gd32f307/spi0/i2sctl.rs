...
pub type I2SSEL_W<'a> = crate::BitWriter<'a, u32, I2SCTL_SPEC, I2SSEL_A, 11>;
impl<'a> I2SSEL_W<'a> {
...
pub type I2SEN_W<'a> = crate::BitWriter<'a, u32, I2SCTL_SPEC, I2SEN_A, 10>;
impl<'a> I2SEN_W<'a> {
...
pub type I2SOPMOD_W<'a> = crate::FieldWriterSafe<'a, u32, I2SCTL_SPEC, u8, I2SOPMOD_A, 2, 8>;
impl<'a> I2SOPMOD_W<'a> {
    #[doc = "Slave - transmit"]
    #[inline(always)]
...
pub type PCMSMOD_W<'a> = crate::BitWriter<'a, u32, I2SCTL_SPEC, PCMSMOD_A, 7>;
impl<'a> PCMSMOD_W<'a> {
...
pub type I2SSTD_W<'a> = crate::FieldWriterSafe<'a, u32, I2SCTL_SPEC, u8, I2SSTD_A, 2, 4>;
impl<'a> I2SSTD_W<'a> {
...
pub type CKPL_W<'a> = crate::BitWriter<'a, u32, I2SCTL_SPEC, CKPL_A, 3>;
impl<'a> CKPL_W<'a> {
...
pub type DTLEN_W<'a> = crate::FieldWriter<'a, u32, I2SCTL_SPEC, u8, DTLEN_A, 2, 1>;
impl<'a> DTLEN_W<'a> {
...
pub type CHLEN_W<'a> = crate::BitWriter<'a, u32, I2SCTL_SPEC, CHLEN_A, 0>;
impl<'a> CHLEN_W<'a> {
    #[doc = "16-bit wide"]
    #[inline(always)]
    pub fn sixteen_bit(self) -> &'a mut W {
