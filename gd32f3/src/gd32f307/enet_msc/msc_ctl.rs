...
pub type PMC_W<'a> = crate::BitWriter<'a, u32, MSC_CTL_SPEC, bool, 4>;
#[doc = "Field `AFHPM` reader - Almost full or half preset mode"]
pub type AFHPM_R = crate::BitReader<bool>;
#[doc = "Field `AFHPM` writer - Almost full or half preset mode"]
pub type AFHPM_W<'a> = crate::BitWriter<'a, u32, MSC_CTL_SPEC, bool, 5>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    pub fn pmc(&mut self) -> PMC_W {
        PMC_W::new(self)
    }
    #[doc = "Bit 5 - Almost full or half preset mode"]
    #[inline(always)]
    pub fn afhpm(&mut self) -> AFHPM_W {
        AFHPM_W::new(self)
    }
