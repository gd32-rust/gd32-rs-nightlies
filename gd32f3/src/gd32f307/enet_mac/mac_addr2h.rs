...
impl From<crate::R<MAC_ADDR2H_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MAC_ADDR2H_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MAC_ADDR2H` writer"]
pub struct W(crate::W<MAC_ADDR2H_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MAC_ADDR2H_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    #[doc = "Bits 0:15 - Ethernet MAC address 2 high register"]
    #[inline(always)]
    pub fn addr2h(&mut self) -> ADDR2H_W {
        ADDR2H_W::new(self)
    }
    #[doc = "Bits 24:29 - Mask byte"]
    #[inline(always)]
...
#[doc = "Ethernet MAC address 2 high register (MAC_ADDR2H)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [mac_addr2h](index.html) module"]
pub struct MAC_ADDR2H_SPEC;
impl crate::RegisterSpec for MAC_ADDR2H_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [mac_addr2h::R](R) reader structure"]
impl crate::Readable for MAC_ADDR2H_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [mac_addr2h::W](W) writer structure"]
impl crate::Writable for MAC_ADDR2H_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets MAC_ADDR2H to value 0xffff"]
impl crate::Resettable for MAC_ADDR2H_SPEC {
    #[inline(always)]
