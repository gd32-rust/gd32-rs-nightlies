...
pub struct R(crate::R<SNCTL3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SNCTL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SNCTL3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SNCTL3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SNCTL3` writer"]
pub struct W(crate::W<SNCTL3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SNCTL3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SNCTL3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SNCTL3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SYNCWR_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 19>;
#[doc = "Field `CPS` reader - CRAM page size"]
pub type CPS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CPS` writer - CRAM page size"]
pub type CPS_W<'a> = crate::FieldWriter<'a, u32, SNCTL3_SPEC, u8, u8, 3, 16>;
...
pub type ASYNCWAIT_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 15>;
...
pub type EXMODEN_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 14>;
...
pub type NRWTEN_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 13>;
#[doc = "Field `WREN` reader - Write enable"]
pub type WREN_R = crate::BitReader<bool>;
#[doc = "Field `WREN` writer - Write enable"]
pub type WREN_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 12>;
...
pub type NRWTCFG_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 11>;
...
pub type WRAPEN_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 10>;
...
pub type NRWTPOL_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 9>;
...
pub type SBRSTEN_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 8>;
...
pub type NREN_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 6>;
...
pub type NRW_W<'a> = crate::FieldWriter<'a, u32, SNCTL3_SPEC, u8, u8, 2, 4>;
...
pub type NRTP_W<'a> = crate::FieldWriter<'a, u32, SNCTL3_SPEC, u8, u8, 2, 2>;
...
pub type NRMUX_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 1>;
#[doc = "Field `NRBKEN` reader - NOR bank enable"]
pub type NRBKEN_R = crate::BitReader<bool>;
#[doc = "Field `NRBKEN` writer - NOR bank enable"]
pub type NRBKEN_W<'a> = crate::BitWriter<'a, u32, SNCTL3_SPEC, bool, 0>;
impl R {
...
#[doc = "SRAM/NOR flash control register 3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [snctl3](index.html) module"]
pub struct SNCTL3_SPEC;
impl crate::RegisterSpec for SNCTL3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [snctl3::R](R) reader structure"]
impl crate::Readable for SNCTL3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [snctl3::W](W) writer structure"]
impl crate::Writable for SNCTL3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SNCTL3 to value 0x30d2"]
impl crate::Resettable for SNCTL3_SPEC {
    #[inline(always)]
