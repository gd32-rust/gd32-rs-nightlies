...
pub type PREDV0_LSB_W<'a> = crate::BitWriter<'a, u32, CFG0_SPEC, bool, 17>;
...
pub type USBFSPSC_1_0_R = crate::FieldReader<u8, u8>;
#[doc = "Field `USBFSPSC_1_0` writer - USBFS clock prescaler selection"]
pub type USBFSPSC_1_0_W<'a> = crate::FieldWriter<'a, u32, CFG0_SPEC, u8, u8, 2, 22>;
...
pub type CKOUT0SEL_W<'a> = crate::FieldWriter<'a, u32, CFG0_SPEC, u8, u8, 4, 24>;
...
pub type PLLMF_5_4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PLLMF_5_4` writer - Bit 5 and Bit 4 of PLLMF"]
pub type PLLMF_5_4_W<'a> = crate::FieldWriter<'a, u32, CFG0_SPEC, u8, u8, 2, 29>;
#[doc = "Field `USBFSPSC` reader - Bit 2 of USBFSPSC"]
pub type USBFSPSC_R = crate::BitReader<bool>;
#[doc = "Field `USBFSPSC` writer - Bit 2 of USBFSPSC"]
pub type USBFSPSC_W<'a> = crate::BitWriter<'a, u32, CFG0_SPEC, bool, 31>;
impl R {
    ...
    pub fn usbfspsc_1_0(&self) -> USBFSPSC_1_0_R {
        USBFSPSC_1_0_R::new(((self.bits >> 22) & 3) as u8)
    }
    ...
    pub fn usbfspsc(&self) -> USBFSPSC_R {
        USBFSPSC_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - System clock switch"]
