...
pub type USBFSPSC_1_0_R = crate::FieldReader;
#[doc = "Field `USBFSPSC_1_0` writer - USBFS clock prescaler selection"]
pub type USBFSPSC_1_0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type USBFSPSC_R = crate::BitReader;
#[doc = "Field `USBFSPSC` writer - Bit 2 of USBFSPSC"]
pub type USBFSPSC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbfspsc_1_0(&mut self) -> USBFSPSC_1_0_W<CFG0_SPEC, 22> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbfspsc(&mut self) -> USBFSPSC_W<CFG0_SPEC, 31> {
        USBFSPSC_W::new(self)
    }
