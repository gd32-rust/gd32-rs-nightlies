...
pub type CTC_REMAP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CTC_REMAP` writer - CTC remapping"]
pub type CTC_REMAP_W<'a> = crate::FieldWriter<'a, u32, PCF1_SPEC, u8, u8, 2, 11>;
...
pub type FSMC_NADV_W<'a> = crate::BitWriter<'a, u32, PCF1_SPEC, bool, 10>;
