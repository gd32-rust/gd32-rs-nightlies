...
pub type R = crate::R<NPINTEN1_SPEC>;
#[doc = "Register `NPINTEN1` writer"]
pub type W = crate::W<NPINTEN1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn intrs(&mut self) -> INTRS_W<NPINTEN1_SPEC, 0> {
        INTRS_W::new(self)
    }
    #[doc = "Bit 1 - Interrupt high-level status"]
    #[inline(always)]
    #[must_use]
    pub fn inths(&mut self) -> INTHS_W<NPINTEN1_SPEC, 1> {
        INTHS_W::new(self)
    }
    #[doc = "Bit 2 - Interrupt falling edge status"]
    #[inline(always)]
    #[must_use]
    pub fn intfs(&mut self) -> INTFS_W<NPINTEN1_SPEC, 2> {
        INTFS_W::new(self)
    }
    #[doc = "Bit 3 - Interrupt rising edge detection enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn intren(&mut self) -> INTREN_W<NPINTEN1_SPEC, 3> {
        INTREN_W::new(self)
    }
    #[doc = "Bit 4 - Interrupt high-level detection enable"]
    #[inline(always)]
    #[must_use]
    pub fn inthen(&mut self) -> INTHEN_W<NPINTEN1_SPEC, 4> {
        INTHEN_W::new(self)
    }
    #[doc = "Bit 5 - Interrupt falling edge detection enable"]
    #[inline(always)]
    #[must_use]
    pub fn intfen(&mut self) -> INTFEN_W<NPINTEN1_SPEC, 5> {
        INTFEN_W::new(self)
    }
    #[doc = "Bit 6 - FIFO empty flag"]
    #[inline(always)]
    #[must_use]
    pub fn ffept(&mut self) -> FFEPT_W<NPINTEN1_SPEC, 6> {
        FFEPT_W::new(self)
    }
