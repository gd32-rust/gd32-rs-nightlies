...
pub struct R(crate::R<NPCTL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NPCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NPCTL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NPCTL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `NPCTL2` writer"]
pub struct W(crate::W<NPCTL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NPCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NPCTL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NPCTL2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type NDW_W<'a> = crate::FieldWriter<'a, u32, NPCTL2_SPEC, u8, u8, 2, 4>;
...
pub type NDTP_W<'a> = crate::BitWriter<'a, u32, NPCTL2_SPEC, bool, 3>;
#[doc = "Field `NDBKEN` reader - NAND bank enable"]
pub type NDBKEN_R = crate::BitReader<bool>;
#[doc = "Field `NDBKEN` writer - NAND bank enable"]
pub type NDBKEN_W<'a> = crate::BitWriter<'a, u32, NPCTL2_SPEC, bool, 2>;
...
pub type NDWTEN_W<'a> = crate::BitWriter<'a, u32, NPCTL2_SPEC, bool, 1>;
impl R {
