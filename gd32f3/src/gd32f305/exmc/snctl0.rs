...
pub struct R(crate::R<SNCTL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SNCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SNCTL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SNCTL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SNCTL0` writer"]
pub struct W(crate::W<SNCTL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SNCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SNCTL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SNCTL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SYNCWR_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 19>;
#[doc = "Field `CPS` reader - CRAM page size"]
pub type CPS_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CPS` writer - CRAM page size"]
pub type CPS_W<'a> = crate::FieldWriter<'a, u32, SNCTL0_SPEC, u8, u8, 3, 16>;
...
pub type ASYNCWAIT_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 15>;
...
pub type EXMODEN_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 14>;
...
pub type NRWTEN_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 13>;
#[doc = "Field `WREN` reader - Write enable"]
pub type WREN_R = crate::BitReader<bool>;
#[doc = "Field `WREN` writer - Write enable"]
pub type WREN_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 12>;
...
pub type NRWTCFG_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 11>;
...
pub type WRAPEN_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 10>;
...
pub type NRWTPOL_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 9>;
...
pub type SBRSTEN_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 8>;
...
pub type NREN_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 6>;
...
pub type NRW_W<'a> = crate::FieldWriter<'a, u32, SNCTL0_SPEC, u8, u8, 2, 4>;
...
pub type NRTP_W<'a> = crate::FieldWriter<'a, u32, SNCTL0_SPEC, u8, u8, 2, 2>;
...
pub type NRMUX_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 1>;
#[doc = "Field `NRBKEN` reader - NOR bank enable"]
pub type NRBKEN_R = crate::BitReader<bool>;
#[doc = "Field `NRBKEN` writer - NOR bank enable"]
pub type NRBKEN_W<'a> = crate::BitWriter<'a, u32, SNCTL0_SPEC, bool, 0>;
impl R {
