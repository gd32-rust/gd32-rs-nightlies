...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn db4(&mut self) -> DB4_W<TMDATA11_SPEC, 0> {
        DB4_W::new(self)
    }
    #[doc = "Bits 8:15 - Data byte 5"]
    #[inline(always)]
    #[must_use]
    pub fn db5(&mut self) -> DB5_W<TMDATA11_SPEC, 8> {
        DB5_W::new(self)
    }
    #[doc = "Bits 16:23 - Data byte 6"]
    #[inline(always)]
    #[must_use]
    pub fn db6(&mut self) -> DB6_W<TMDATA11_SPEC, 16> {
        DB6_W::new(self)
    }
    #[doc = "Bits 24:31 - Data byte 7"]
    #[inline(always)]
    #[must_use]
    pub fn db7(&mut self) -> DB7_W<TMDATA11_SPEC, 24> {
        DB7_W::new(self)
    }
