...
pub struct R(crate::R<F25DATA0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<F25DATA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<F25DATA0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<F25DATA0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `F25DATA0` writer"]
pub struct W(crate::W<F25DATA0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<F25DATA0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<F25DATA0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<F25DATA0_SPEC>) -> Self {
        W(writer)
    }
}
