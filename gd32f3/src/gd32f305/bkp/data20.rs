...
pub struct R(crate::R<DATA20_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATA20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATA20_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATA20_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATA20` writer"]
pub struct W(crate::W<DATA20_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA20_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA20_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_W<'a> = crate::FieldWriter<'a, u32, DATA20_SPEC, u16, u16, 16, 0>;
impl R {
