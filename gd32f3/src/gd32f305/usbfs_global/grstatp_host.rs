...
pub struct R(crate::R<GRSTATP_HOST_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GRSTATP_HOST_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GRSTATP_HOST_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GRSTATP_HOST_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Global Receive status pop(Host mode)\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [grstatp_host](index.html) module"]
