...
pub type LDOVS_R = crate::FieldReader;
#[doc = "Field `LDOVS` writer - LDO output voltage select"]
pub type LDOVS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ldlp(&mut self) -> LDLP_W<CTL_SPEC, 10> {
        LDLP_W::new(self)
    }
    #[doc = "Bit 11 - Low-driver mode when use normal power LDO"]
    #[inline(always)]
    #[must_use]
    pub fn ldnp(&mut self) -> LDNP_W<CTL_SPEC, 11> {
        LDNP_W::new(self)
    }
    #[doc = "Bits 14:15 - LDO output voltage select"]
    #[inline(always)]
    #[must_use]
    pub fn ldovs(&mut self) -> LDOVS_W<CTL_SPEC, 14> {
        LDOVS_W::new(self)
    }
    #[doc = "Bit 16 - High-driver mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn hden(&mut self) -> HDEN_W<CTL_SPEC, 16> {
        HDEN_W::new(self)
    }
    #[doc = "Bit 17 - High-driver mode switch"]
    #[inline(always)]
    #[must_use]
    pub fn hds(&mut self) -> HDS_W<CTL_SPEC, 17> {
        HDS_W::new(self)
    }
    #[doc = "Bits 18:19 - Low-driver mode enable in Deep-sleep mode"]
    #[inline(always)]
    #[must_use]
    pub fn lden(&mut self) -> LDEN_W<CTL_SPEC, 18> {
        LDEN_W::new(self)
    }
