...
pub struct R(crate::R<HCH0LEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HCH0LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HCH0LEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HCH0LEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HCH0LEN` writer"]
pub struct W(crate::W<HCH0LEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HCH0LEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HCH0LEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HCH0LEN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TLEN_W<'a> = crate::FieldWriter<'a, u32, HCH0LEN_SPEC, u32, u32, 19, 0>;
#[doc = "Field `PCNT` reader - Packet count"]
pub type PCNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PCNT` writer - Packet count"]
pub type PCNT_W<'a> = crate::FieldWriter<'a, u32, HCH0LEN_SPEC, u16, u16, 10, 19>;
#[doc = "Field `DPID` reader - Data PID"]
pub type DPID_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DPID` writer - Data PID"]
pub type DPID_W<'a> = crate::FieldWriter<'a, u32, HCH0LEN_SPEC, u8, u8, 2, 29>;
impl R {
