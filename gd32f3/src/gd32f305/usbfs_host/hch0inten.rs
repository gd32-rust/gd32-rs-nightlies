...
pub struct R(crate::R<HCH0INTEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HCH0INTEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HCH0INTEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HCH0INTEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `HCH0INTEN` writer"]
pub struct W(crate::W<HCH0INTEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<HCH0INTEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<HCH0INTEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<HCH0INTEN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TFIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 0>;
...
pub type CHIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 1>;
...
pub type STALLIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 3>;
...
pub type NAKIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 4>;
...
pub type ACKIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 5>;
...
pub type USBERIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 7>;
...
pub type BBERIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 8>;
...
pub type REQOVRIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 9>;
...
pub type DTERIE_W<'a> = crate::BitWriter<'a, u32, HCH0INTEN_SPEC, bool, 10>;
impl R {
