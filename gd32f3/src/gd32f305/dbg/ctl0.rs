...
pub type WWDGT_HOLD_R = crate::BitReader<WWDGT_HOLD_A>;
#[doc = "WWDGT hold bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum WWDGT_HOLD_A {
    #[doc = "0: Continue running the watchdog timer as usual"]
    CONTINUE = 0,
    #[doc = "1: Hold the watchdog timer for debug when the core is halted"]
    STOP = 1,
}
impl From<WWDGT_HOLD_A> for bool {
    #[inline(always)]
    fn from(variant: WWDGT_HOLD_A) -> Self {
        variant as u8 != 0
    }
}
impl WWDGT_HOLD_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> WWDGT_HOLD_A {
        match self.bits {
            false => WWDGT_HOLD_A::CONTINUE,
            true => WWDGT_HOLD_A::STOP,
        }
    }
    #[doc = "Continue running the watchdog timer as usual"]
    #[inline(always)]
    pub fn is_continue(&self) -> bool {
        *self == WWDGT_HOLD_A::CONTINUE
    }
    #[doc = "Hold the watchdog timer for debug when the core is halted"]
    #[inline(always)]
    pub fn is_stop(&self) -> bool {
        *self == WWDGT_HOLD_A::STOP
    }
}
#[doc = "Field `WWDGT_HOLD` writer - WWDGT hold bit"]
pub type WWDGT_HOLD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, WWDGT_HOLD_A>;
impl<'a, REG, const O: u8> WWDGT_HOLD_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Continue running the watchdog timer as usual"]
...
pub use WWDGT_HOLD_R as FWDGT_HOLD_R;
#[doc = "Field `FWDGT_HOLD` writer - FWDGT hold bit"]
pub use WWDGT_HOLD_W as FWDGT_HOLD_W;
...
impl R {
    ...
    pub fn wwdgt_hold(&self) -> WWDGT_HOLD_R {
        WWDGT_HOLD_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - FWDGT hold bit"]
    #[inline(always)]
    pub fn fwdgt_hold(&self) -> FWDGT_HOLD_R {
        FWDGT_HOLD_R::new(((self.bits >> 9) & 1) != 0)
    }
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wwdgt_hold(&mut self) -> WWDGT_HOLD_W<CTL0_SPEC, 8> {
        WWDGT_HOLD_W::new(self)
    }
    #[doc = "Bit 9 - FWDGT hold bit"]
    #[inline(always)]
    #[must_use]
    pub fn fwdgt_hold(&mut self) -> FWDGT_HOLD_W<CTL0_SPEC, 9> {
