...
pub type DWM0_W<'a> = crate::FieldWriter<'a, u32, CTL_SPEC, u8, u8, 2, 6>;
...
pub type DWBW0_W<'a> = crate::FieldWriter<'a, u32, CTL_SPEC, u8, u8, 4, 8>;
#[doc = "DAC0 DMA enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DDMAEN0_A {
...
pub type DWM1_W<'a> = crate::FieldWriter<'a, u32, CTL_SPEC, u8, u8, 2, 22>;
...
pub type DWBW1_W<'a> = crate::FieldWriter<'a, u32, CTL_SPEC, u8, u8, 4, 24>;
#[doc = "DAC1 DMA enable"]
