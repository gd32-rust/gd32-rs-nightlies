...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pg(&mut self) -> PG_W<CTL1_SPEC, 0> {
        PG_W::new(self)
    }
    #[doc = "Bit 1 - Main flash page erase for bank0 command bit"]
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PER_W<CTL1_SPEC, 1> {
        PER_W::new(self)
    }
    #[doc = "Bit 2 - Main flash mass erase for bank0 command bit"]
    #[inline(always)]
    #[must_use]
    pub fn mer(&mut self) -> MER_W<CTL1_SPEC, 2> {
        MER_W::new(self)
    }
    #[doc = "Bit 6 - Send erase command to FMC bit"]
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> START_W<CTL1_SPEC, 6> {
        START_W::new(self)
    }
    #[doc = "Bit 7 - FMC_CTL0 lock bit"]
    #[inline(always)]
    #[must_use]
    pub fn lk(&mut self) -> LK_W<CTL1_SPEC, 7> {
        LK_W::new(self)
    }
    #[doc = "Bit 10 - Error interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn errie(&mut self) -> ERRIE_W<CTL1_SPEC, 10> {
        ERRIE_W::new(self)
    }
    #[doc = "Bit 12 - End of operation interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn endie(&mut self) -> ENDIE_W<CTL1_SPEC, 12> {
        ENDIE_W::new(self)
    }
