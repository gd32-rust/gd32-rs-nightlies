...
pub struct R(crate::R<CH1PADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH1PADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH1PADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH1PADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH1PADDR` writer"]
pub struct W(crate::W<CH1PADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH1PADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH1PADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH1PADDR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PADDR_W<'a> = crate::FieldWriter<'a, u32, CH1PADDR_SPEC, u32, u32, 32, 0>;
impl R {
