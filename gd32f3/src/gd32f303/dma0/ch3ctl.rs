...
pub struct R(crate::R<CH3CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH3CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH3CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH3CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH3CTL` writer"]
pub struct W(crate::W<CH3CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH3CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH3CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH3CTL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Channel enable\n\nValue on reset: 0"]
...
pub type CHEN_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, CHEN_A, 0>;
impl<'a> CHEN_W<'a> {
...
pub type FTFIE_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, FTFIE_A, 1>;
impl<'a> FTFIE_W<'a> {
...
pub type HTFIE_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, HTFIE_A, 2>;
impl<'a> HTFIE_W<'a> {
...
pub type ERRIE_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, ERRIE_A, 3>;
impl<'a> ERRIE_W<'a> {
...
pub type DIR_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, DIR_A, 4>;
impl<'a> DIR_W<'a> {
...
pub type CMEN_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, CMEN_A, 5>;
impl<'a> CMEN_W<'a> {
...
pub type PNAGA_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, PNAGA_A, 6>;
impl<'a> PNAGA_W<'a> {
...
pub type PWIDTH_W<'a> = crate::FieldWriter<'a, u32, CH3CTL_SPEC, u8, PWIDTH_A, 2, 8>;
impl<'a> PWIDTH_W<'a> {
    #[doc = "8-bit size"]
    #[inline(always)]
...
pub type PRIO_W<'a> = crate::FieldWriterSafe<'a, u32, CH3CTL_SPEC, u8, PRIO_A, 2, 12>;
impl<'a> PRIO_W<'a> {
    #[doc = "Low priority"]
    #[inline(always)]
...
pub type M2M_W<'a> = crate::BitWriter<'a, u32, CH3CTL_SPEC, M2M_A, 14>;
impl<'a> M2M_W<'a> {
