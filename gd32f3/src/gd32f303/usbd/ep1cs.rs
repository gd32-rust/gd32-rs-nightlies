...
pub struct R(crate::R<EP1CS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP1CS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP1CS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP1CS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EP1CS` writer"]
pub struct W(crate::W<EP1CS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EP1CS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EP1CS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EP1CS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EP_AR_W<'a> = crate::FieldWriter<'a, u32, EP1CS_SPEC, u8, u8, 4, 0>;
...
pub type TX_STA_W<'a> = crate::FieldWriter<'a, u32, EP1CS_SPEC, u8, u8, 2, 4>;
...
pub type TX_DTG_W<'a> = crate::BitWriter<'a, u32, EP1CS_SPEC, bool, 6>;
...
pub type SETUP_W<'a> = crate::BitWriter<'a, u32, EP1CS_SPEC, bool, 11>;
...
pub type RX_STA_W<'a> = crate::FieldWriter<'a, u32, EP1CS_SPEC, u8, u8, 2, 12>;
...
pub type RX_DTG_W<'a> = crate::BitWriter<'a, u32, EP1CS_SPEC, bool, 14>;
...
pub type RX_ST_W<'a> = crate::BitWriter<'a, u32, EP1CS_SPEC, bool, 15>;
impl R {
...
#[doc = "endpoint 1 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ep1cs](index.html) module"]
pub struct EP1CS_SPEC;
impl crate::RegisterSpec for EP1CS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ep1cs::R](R) reader structure"]
impl crate::Readable for EP1CS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ep1cs::W](W) writer structure"]
impl crate::Writable for EP1CS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EP1CS to value 0"]
impl crate::Resettable for EP1CS_SPEC {
    #[inline(always)]
