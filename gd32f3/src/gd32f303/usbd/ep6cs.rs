...
pub struct R(crate::R<EP6CS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP6CS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP6CS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP6CS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EP6CS` writer"]
pub struct W(crate::W<EP6CS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EP6CS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EP6CS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EP6CS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EP_AR_W<'a> = crate::FieldWriter<'a, u32, EP6CS_SPEC, u8, u8, 4, 0>;
...
pub type TX_STA_W<'a> = crate::FieldWriter<'a, u32, EP6CS_SPEC, u8, u8, 2, 4>;
...
pub type TX_DTG_W<'a> = crate::BitWriter<'a, u32, EP6CS_SPEC, bool, 6>;
...
pub type SETUP_W<'a> = crate::BitWriter<'a, u32, EP6CS_SPEC, bool, 11>;
...
pub type RX_STA_W<'a> = crate::FieldWriter<'a, u32, EP6CS_SPEC, u8, u8, 2, 12>;
...
pub type RX_DTG_W<'a> = crate::BitWriter<'a, u32, EP6CS_SPEC, bool, 14>;
...
pub type RX_ST_W<'a> = crate::BitWriter<'a, u32, EP6CS_SPEC, bool, 15>;
impl R {
