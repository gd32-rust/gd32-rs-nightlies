...
pub type CH1CAPFLT_W<'a> = crate::FieldWriter<'a, u32, CHCTL0_INPUT_SPEC, u8, u8, 4, 12>;
...
pub type CH1CAPPSC_W<'a> = crate::FieldWriter<'a, u32, CHCTL0_INPUT_SPEC, u8, u8, 2, 10>;
...
pub type CH1MS_W<'a> = crate::FieldWriter<'a, u32, CHCTL0_INPUT_SPEC, u8, u8, 2, 8>;
