...
pub type LDRF_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LDRF` writer - Low-driver mode ready flag"]
pub type LDRF_W<'a> = crate::FieldWriter<'a, u32, CS_SPEC, u8, u8, 2, 18>;
#[doc = "Field `HDSRF` reader - High-driver switch ready flag"]
pub type HDSRF_R = crate::BitReader<bool>;
#[doc = "Field `HDRF` reader - High-driver ready flag"]
pub type HDRF_R = crate::BitReader<bool>;
#[doc = "Field `LDOVSRF` reader - LDO voltage select ready flag"]
pub type LDOVSRF_R = crate::BitReader<bool>;
#[doc = "Enable WKUP pin\n\nValue on reset: 0"]
...
impl R {
    ...
    pub fn ldovsrf(&self) -> LDOVSRF_R {
        LDOVSRF_R::new(((self.bits >> 14) & 1) != 0)
    }
