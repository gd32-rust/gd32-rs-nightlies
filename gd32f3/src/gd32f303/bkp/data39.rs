...
pub struct R(crate::R<DATA39_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATA39_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATA39_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATA39_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATA39` writer"]
pub struct W(crate::W<DATA39_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA39_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA39_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA39_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_W<'a> = crate::FieldWriter<'a, u32, DATA39_SPEC, u16, u16, 16, 0>;
impl R {
