...
pub struct R(crate::R<IDATA2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<IDATA2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<IDATA2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<IDATA2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Inserted data register 2\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [idata2](index.html) module"]
