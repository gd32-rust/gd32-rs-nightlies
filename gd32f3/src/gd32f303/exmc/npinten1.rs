...
pub struct R(crate::R<NPINTEN1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NPINTEN1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NPINTEN1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NPINTEN1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `NPINTEN1` writer"]
pub struct W(crate::W<NPINTEN1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NPINTEN1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NPINTEN1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NPINTEN1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FFEPT_W<'a> = crate::BitWriter<'a, u32, NPINTEN1_SPEC, bool, 6>;
...
pub type INTFEN_W<'a> = crate::BitWriter<'a, u32, NPINTEN1_SPEC, bool, 5>;
...
pub type INTHEN_W<'a> = crate::BitWriter<'a, u32, NPINTEN1_SPEC, bool, 4>;
...
pub type INTREN_W<'a> = crate::BitWriter<'a, u32, NPINTEN1_SPEC, bool, 3>;
...
pub type INTFS_W<'a> = crate::BitWriter<'a, u32, NPINTEN1_SPEC, bool, 2>;
...
pub type INTHS_W<'a> = crate::BitWriter<'a, u32, NPINTEN1_SPEC, bool, 1>;
...
pub type INTRS_W<'a> = crate::BitWriter<'a, u32, NPINTEN1_SPEC, bool, 0>;
impl R {
