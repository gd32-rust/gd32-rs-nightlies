...
pub mod dacc_r12dh;
#[doc = "DACC_L12DH register accessor: an alias for `Reg<DACC_L12DH_SPEC>`"]
...
pub mod dacc_l12dh;
#[doc = "DACC_R8DH register accessor: an alias for `Reg<DACC_R8DH_SPEC>`"]
...
pub mod dac0_do;
#[doc = "DAC1_DO register accessor: an alias for `Reg<DAC1_DO_SPEC>`"]
