...
pub type OVIE_W<'a> = crate::BitWriter<'a, u32, INTEN_SPEC, bool, 2>;
...
pub type ALRMIE_W<'a> = crate::BitWriter<'a, u32, INTEN_SPEC, bool, 1>;
#[doc = "Field `SCIE` reader - Second interrupt"]
pub type SCIE_R = crate::BitReader<bool>;
#[doc = "Field `SCIE` writer - Second interrupt"]
pub type SCIE_W<'a> = crate::BitWriter<'a, u32, INTEN_SPEC, bool, 0>;
impl R {
