...
pub type SFID_EFID_W<'a> = crate::FieldWriter<'a, u32, TMI0_SPEC, u16, u16, 11, 21>;
...
pub type EFID_W<'a> = crate::FieldWriter<'a, u32, TMI0_SPEC, u32, u32, 18, 3>;
#[doc = "Frame format\n\nValue on reset: 0"]
...
pub type FF_W<'a> = crate::BitWriter<'a, u32, TMI0_SPEC, FF_A, 2>;
impl<'a> FF_W<'a> {
...
pub type FT_W<'a> = crate::BitWriter<'a, u32, TMI0_SPEC, FT_A, 1>;
impl<'a> FT_W<'a> {
    #[doc = "Data frame"]
    #[inline(always)]
...
pub type TEN_W<'a> = crate::BitWriter<'a, u32, TMI0_SPEC, TEN_A, 0>;
impl<'a> TEN_W<'a> {
