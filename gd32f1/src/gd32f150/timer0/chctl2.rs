...
pub use crate::gd32f150::timer0::chctl2::CH0EN_A as CH2NEN_A;
#[doc = "Field `CH2NEN` reader - Channel 2 complementary output enable"]
pub use crate::gd32f150::timer0::chctl2::CH0EN_R as CH2NEN_R;
...
pub type CH2NEN_W<'a> = crate::BitWriter<'a, u16, CHCTL2_SPEC, CH2NEN_A, 10>;
impl<'a> CH2NEN_W<'a> {
...
pub use crate::gd32f150::timer0::chctl2::CH0EN_A as CH1NEN_A;
#[doc = "Field `CH1NEN` reader - Channel 1 complementary output enable"]
pub use crate::gd32f150::timer0::chctl2::CH0EN_R as CH1NEN_R;
...
pub type CH1NEN_W<'a> = crate::BitWriter<'a, u16, CHCTL2_SPEC, CH1NEN_A, 6>;
impl<'a> CH1NEN_W<'a> {
    #[doc = "Channel output is disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
