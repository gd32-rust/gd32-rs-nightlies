...
impl From<crate::R<SEP3_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SEP3_SPEC>> for W {
    #[inline(always)]
...
pub type SUB_ST_W<'a> = crate::BitWriter<'a, u16, SEP3_SPEC, bool, 15>;
...
pub type SUB_STA_W<'a> = crate::FieldWriter<'a, u16, SEP3_SPEC, u8, u8, 2, 12>;
...
pub type SUBPID_ATTR_W<'a> = crate::FieldWriter<'a, u16, SEP3_SPEC, u16, u16, 11, 0>;
impl R {
