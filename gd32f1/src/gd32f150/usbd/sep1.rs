...
pub type R = crate::R<SEP1_SPEC>;
#[doc = "Register `SEP1` writer"]
pub type W = crate::W<SEP1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn subpid_attr(&mut self) -> SUBPID_ATTR_W<SEP1_SPEC, 0> {
        SUBPID_ATTR_W::new(self)
    }
    #[doc = "Bits 12:13 - Status bits, for the handshake of receiving subpid LPM"]
    #[inline(always)]
    #[must_use]
    pub fn sub_sta(&mut self) -> SUB_STA_W<SEP1_SPEC, 12> {
        SUB_STA_W::new(self)
    }
    #[doc = "Bit 15 - Successful Receive for LPM Token"]
    #[inline(always)]
    #[must_use]
    pub fn sub_st(&mut self) -> SUB_ST_W<SEP1_SPEC, 15> {
        SUB_ST_W::new(self)
    }
...
#[doc = "USB sub-endpoint 1 register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sep1::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sep1::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
