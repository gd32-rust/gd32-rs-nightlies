...
pub struct R(crate::R<EP2CS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP2CS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP2CS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP2CS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EP2CS` writer"]
pub struct W(crate::W<EP2CS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EP2CS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EP2CS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EP2CS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EP_AR_W<'a> = crate::FieldWriter<'a, u16, EP2CS_SPEC, u8, u8, 4, 0>;
...
pub type TX_STA_W<'a> = crate::FieldWriter<'a, u16, EP2CS_SPEC, u8, u8, 2, 4>;
...
pub type TX_DTG_W<'a> = crate::BitWriter<'a, u16, EP2CS_SPEC, bool, 6>;
...
pub type TX_ST_W<'a> = crate::BitWriter<'a, u16, EP2CS_SPEC, bool, 7>;
...
pub type EP_KCTL_W<'a> = crate::BitWriter<'a, u16, EP2CS_SPEC, bool, 8>;
...
pub type EP_CTL_W<'a> = crate::FieldWriter<'a, u16, EP2CS_SPEC, u8, u8, 2, 9>;
...
pub type SETUP_W<'a> = crate::BitWriter<'a, u16, EP2CS_SPEC, bool, 11>;
...
pub type RX_STA_W<'a> = crate::FieldWriter<'a, u16, EP2CS_SPEC, u8, u8, 2, 12>;
...
pub type RX_DTG_W<'a> = crate::BitWriter<'a, u16, EP2CS_SPEC, bool, 14>;
...
pub type RX_ST_W<'a> = crate::BitWriter<'a, u16, EP2CS_SPEC, bool, 15>;
impl R {
...
#[doc = "endpoint 2 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ep2cs](index.html) module"]
pub struct EP2CS_SPEC;
impl crate::RegisterSpec for EP2CS_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [ep2cs::R](R) reader structure"]
impl crate::Readable for EP2CS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ep2cs::W](W) writer structure"]
impl crate::Writable for EP2CS_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets EP2CS to value 0"]
impl crate::Resettable for EP2CS_SPEC {
    #[inline(always)]
