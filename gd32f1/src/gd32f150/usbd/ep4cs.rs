...
pub type EP_AR_W<'a> = crate::FieldWriter<'a, u16, EP4CS_SPEC, u8, u8, 4, 0>;
...
pub type TX_STA_W<'a> = crate::FieldWriter<'a, u16, EP4CS_SPEC, u8, u8, 2, 4>;
...
pub type TX_DTG_W<'a> = crate::BitWriter<'a, u16, EP4CS_SPEC, bool, 6>;
...
pub type TX_ST_W<'a> = crate::BitWriter<'a, u16, EP4CS_SPEC, bool, 7>;
...
pub type EP_KCTL_W<'a> = crate::BitWriter<'a, u16, EP4CS_SPEC, bool, 8>;
...
pub type EP_CTL_W<'a> = crate::FieldWriter<'a, u16, EP4CS_SPEC, u8, u8, 2, 9>;
...
pub type SETUP_W<'a> = crate::BitWriter<'a, u16, EP4CS_SPEC, bool, 11>;
...
pub type RX_STA_W<'a> = crate::FieldWriter<'a, u16, EP4CS_SPEC, u8, u8, 2, 12>;
...
pub type RX_DTG_W<'a> = crate::BitWriter<'a, u16, EP4CS_SPEC, bool, 14>;
...
pub type RX_ST_W<'a> = crate::BitWriter<'a, u16, EP4CS_SPEC, bool, 15>;
impl R {
