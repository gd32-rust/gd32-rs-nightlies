...
pub struct R(crate::R<SEP4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SEP4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SEP4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SEP4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SEP4` writer"]
pub struct W(crate::W<SEP4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SEP4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SEP4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SEP4_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SUB_ST_W<'a> = crate::BitWriter<'a, u16, SEP4_SPEC, bool, 15>;
...
pub type SUB_STA_W<'a> = crate::FieldWriter<'a, u16, SEP4_SPEC, u8, u8, 2, 12>;
...
pub type SUBPID_ATTR_W<'a> = crate::FieldWriter<'a, u16, SEP4_SPEC, u16, u16, 11, 0>;
impl R {
...
#[doc = "USB sub-endpoint 4 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sep4](index.html) module"]
pub struct SEP4_SPEC;
impl crate::RegisterSpec for SEP4_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [sep4::R](R) reader structure"]
impl crate::Readable for SEP4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sep4::W](W) writer structure"]
impl crate::Writable for SEP4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SEP4 to value 0"]
impl crate::Resettable for SEP4_SPEC {
    #[inline(always)]
