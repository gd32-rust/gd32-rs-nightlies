...
pub type R = crate::R<SEP0_SPEC>;
#[doc = "Register `SEP0` writer"]
pub type W = crate::W<SEP0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn subpid_attr(&mut self) -> SUBPID_ATTR_W<SEP0_SPEC, 0> {
        SUBPID_ATTR_W::new(self)
    }
    #[doc = "Bits 12:13 - Status bits, for the handshake of receiving subpid LPM"]
    #[inline(always)]
    #[must_use]
    pub fn sub_sta(&mut self) -> SUB_STA_W<SEP0_SPEC, 12> {
        SUB_STA_W::new(self)
    }
    #[doc = "Bit 15 - Successful Receive for LPM Token"]
    #[inline(always)]
    #[must_use]
    pub fn sub_st(&mut self) -> SUB_ST_W<SEP0_SPEC, 15> {
        SUB_ST_W::new(self)
    }
