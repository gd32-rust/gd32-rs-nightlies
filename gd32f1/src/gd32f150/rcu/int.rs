...
pub type IRC14MSTBIF_R = crate::BitReader<IRC14MSTBIFR_A>;
#[doc = "IRC14M stabilization interrupt flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IRC14MSTBIFR_A {
    #[doc = "0: No interrupt generated"]
    NOT_INTERRUPTED = 0,
    #[doc = "1: IRC14M stabilisation interrupt generated"]
    INTERRUPTED = 1,
}
impl From<IRC14MSTBIFR_A> for bool {
    #[inline(always)]
    fn from(variant: IRC14MSTBIFR_A) -> Self {
        variant as u8 != 0
    }
}
impl IRC14MSTBIF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IRC14MSTBIFR_A {
        match self.bits {
            false => IRC14MSTBIFR_A::NOT_INTERRUPTED,
            true => IRC14MSTBIFR_A::INTERRUPTED,
        }
    }
    #[doc = "No interrupt generated"]
    #[inline(always)]
    pub fn is_not_interrupted(&self) -> bool {
        *self == IRC14MSTBIFR_A::NOT_INTERRUPTED
    }
    #[doc = "IRC14M stabilisation interrupt generated"]
    #[inline(always)]
    pub fn is_interrupted(&self) -> bool {
        *self == IRC14MSTBIFR_A::INTERRUPTED
    }
}
...
pub type IRC14MSTBIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, IRC14MSTBIE_A>;
impl<'a, REG, const O: u8> IRC14MSTBIE_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Interrupt disabled"]
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IRC14MSTBICW_AW {
    #[doc = "1: Clear IRC14MSTBIF flag"]
    CLEAR = 1,
}
impl From<IRC14MSTBICW_AW> for bool {
    #[inline(always)]
    fn from(variant: IRC14MSTBICW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IRC14MSTBIC` writer - IRC14M stabilization Interrupt Clear"]
pub type IRC14MSTBIC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, IRC14MSTBICW_AW>;
impl<'a, REG, const O: u8> IRC14MSTBIC_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(IRC14MSTBICW_AW::CLEAR)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irc14mstbie(&mut self) -> IRC14MSTBIE_W<INT_SPEC, 13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irc14mstbic(&mut self) -> IRC14MSTBIC_W<INT_SPEC, 21> {
