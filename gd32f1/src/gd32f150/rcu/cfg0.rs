...
pub type USBDPSC_R = crate::FieldReader<u8, USBDPSC_A>;
impl USBDPSC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    ...
    #[doc = "Checks if the value of the field is `DIV2_5`"]
    #[inline(always)]
...
pub type USBDPSC_W<'a> = crate::FieldWriterSafe<'a, u32, CFG0_SPEC, u8, USBDPSC_A, 2, 22>;
impl<'a> USBDPSC_W<'a> {
...
impl W {
    ...
    #[doc = "Bits 22:23 - USBD clock prescaler selection"]
    #[inline(always)]
    pub fn usbdpsc(&mut self) -> USBDPSC_W {
        USBDPSC_W::new(self)
    }
    #[doc = "Bits 24:26 - CK_OUT Clock Source Selection"]
    #[inline(always)]
