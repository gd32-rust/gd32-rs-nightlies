...
pub use FTEN0_A as FTEN18_A;
#[doc = "Falling edge trigger enable of line 19"]
pub use FTEN0_A as FTEN19_A;
#[doc = "Falling edge trigger enable of line 21"]
pub use FTEN0_A as FTEN21_A;
#[doc = "Falling edge trigger enable of line 22"]
pub use FTEN0_A as FTEN22_A;
...
impl W {
    ...
    #[doc = "Bit 22 - Falling edge trigger enable of line 22"]
    #[inline(always)]
    pub fn ften22(&mut self) -> FTEN22_W {
        FTEN22_W::new(self)
    }
