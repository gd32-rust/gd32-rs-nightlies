...
pub type RSQ16_R = crate::FieldReader;
#[doc = "Field `RSQ16` writer - 16th conversion in regular sequence"]
pub type RSQ16_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type RL_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsq13(&mut self) -> RSQ13_W<RSQ0_SPEC, 0> {
        RSQ13_W::new(self)
    }
    #[doc = "Bits 5:9 - 14th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq14(&mut self) -> RSQ14_W<RSQ0_SPEC, 5> {
        RSQ14_W::new(self)
    }
    #[doc = "Bits 10:14 - 15th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq15(&mut self) -> RSQ15_W<RSQ0_SPEC, 10> {
        RSQ15_W::new(self)
    }
    #[doc = "Bits 15:19 - 16th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq16(&mut self) -> RSQ16_W<RSQ0_SPEC, 15> {
        RSQ16_W::new(self)
    }
    #[doc = "Bits 20:23 - Regular channel group length"]
    #[inline(always)]
