...
pub type DMALST_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, DMALST_A, 12>;
impl<'a> DMALST_W<'a> {
...
pub type DMAON_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, DMAON_A, 11>;
impl<'a> DMAON_W<'a> {
...
pub type BUFIE_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, BUFIE_A, 10>;
impl<'a> BUFIE_W<'a> {
...
pub type EVIE_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, EVIE_A, 9>;
impl<'a> EVIE_W<'a> {
...
pub type ERRIE_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, ERRIE_A, 8>;
impl<'a> ERRIE_W<'a> {
...
pub type I2CCLK_W<'a> = crate::FieldWriter<'a, u16, CTL1_SPEC, u8, u8, 6, 0>;
impl R {
