...
pub type R = crate::R<PHM_SPEC>;
#[doc = "Register `PHM` writer"]
pub type W = crate::W<PHM_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn g0p0(&mut self) -> G0P0_W<PHM_SPEC, 0> {
        G0P0_W::new(self)
    }
    #[doc = "Bit 1 - G0P1 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g0p1(&mut self) -> G0P1_W<PHM_SPEC, 1> {
        G0P1_W::new(self)
    }
    #[doc = "Bit 2 - G0P2 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g0p2(&mut self) -> G0P2_W<PHM_SPEC, 2> {
        G0P2_W::new(self)
    }
    #[doc = "Bit 3 - G0P3 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g0p3(&mut self) -> G0P3_W<PHM_SPEC, 3> {
        G0P3_W::new(self)
    }
    #[doc = "Bit 4 - G1P0 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g1p0(&mut self) -> G1P0_W<PHM_SPEC, 4> {
        G1P0_W::new(self)
    }
    #[doc = "Bit 5 - G1P1 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g1p1(&mut self) -> G1P1_W<PHM_SPEC, 5> {
        G1P1_W::new(self)
    }
    #[doc = "Bit 6 - G1P2 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g1p2(&mut self) -> G1P2_W<PHM_SPEC, 6> {
        G1P2_W::new(self)
    }
    #[doc = "Bit 7 - G1P3 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g1p3(&mut self) -> G1P3_W<PHM_SPEC, 7> {
        G1P3_W::new(self)
    }
    #[doc = "Bit 8 - G2P0 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g2p0(&mut self) -> G2P0_W<PHM_SPEC, 8> {
        G2P0_W::new(self)
    }
    #[doc = "Bit 9 - G2P1 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g2p1(&mut self) -> G2P1_W<PHM_SPEC, 9> {
        G2P1_W::new(self)
    }
    #[doc = "Bit 10 - G2P2 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g2p2(&mut self) -> G2P2_W<PHM_SPEC, 10> {
        G2P2_W::new(self)
    }
    #[doc = "Bit 11 - G2P3 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g2p3(&mut self) -> G2P3_W<PHM_SPEC, 11> {
        G2P3_W::new(self)
    }
    #[doc = "Bit 12 - G3P0 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g3p0(&mut self) -> G3P0_W<PHM_SPEC, 12> {
        G3P0_W::new(self)
    }
    #[doc = "Bit 13 - G3P1 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g3p1(&mut self) -> G3P1_W<PHM_SPEC, 13> {
        G3P1_W::new(self)
    }
    #[doc = "Bit 14 - G3P2 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g3p2(&mut self) -> G3P2_W<PHM_SPEC, 14> {
        G3P2_W::new(self)
    }
    #[doc = "Bit 15 - G3P3 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g3p3(&mut self) -> G3P3_W<PHM_SPEC, 15> {
        G3P3_W::new(self)
    }
    #[doc = "Bit 16 - G4P0 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g4p0(&mut self) -> G4P0_W<PHM_SPEC, 16> {
        G4P0_W::new(self)
    }
    #[doc = "Bit 17 - G4P1 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g4p1(&mut self) -> G4P1_W<PHM_SPEC, 17> {
        G4P1_W::new(self)
    }
    #[doc = "Bit 18 - G4P2 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g4p2(&mut self) -> G4P2_W<PHM_SPEC, 18> {
        G4P2_W::new(self)
    }
    #[doc = "Bit 19 - G4P3 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g4p3(&mut self) -> G4P3_W<PHM_SPEC, 19> {
        G4P3_W::new(self)
    }
    #[doc = "Bit 20 - G5P0 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g5p0(&mut self) -> G5P0_W<PHM_SPEC, 20> {
        G5P0_W::new(self)
    }
    #[doc = "Bit 21 - G5P1 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g5p1(&mut self) -> G5P1_W<PHM_SPEC, 21> {
        G5P1_W::new(self)
    }
    #[doc = "Bit 22 - G5P2 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g5p2(&mut self) -> G5P2_W<PHM_SPEC, 22> {
        G5P2_W::new(self)
    }
    #[doc = "Bit 23 - G5P3 Schmitt trigger hysteresis mode"]
    #[inline(always)]
    #[must_use]
    pub fn g5p3(&mut self) -> G5P3_W<PHM_SPEC, 23> {
        G5P3_W::new(self)
    }
