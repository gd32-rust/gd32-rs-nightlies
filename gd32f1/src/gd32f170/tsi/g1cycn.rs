...
pub struct R(crate::R<G1CYCN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<G1CYCN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<G1CYCN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<G1CYCN_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "I/O group x cycle number register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [g1cycn](index.html) module"]
