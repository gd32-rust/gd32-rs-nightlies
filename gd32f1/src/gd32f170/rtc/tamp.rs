...
pub type TPTS_R = crate::BitReader;
#[doc = "Field `TPTS` writer - Make tamper function used for timestamp function"]
pub type TPTS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PC13VAL_R = crate::BitReader;
#[doc = "Field `PC13VAL` writer - Alarm output type control/PC13 output value"]
pub type PC13VAL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `PC13MDE` reader - PC13 mode"]
pub type PC13MDE_R = crate::BitReader;
#[doc = "Field `PC13MDE` writer - PC13 mode"]
pub type PC13MDE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tp0en(&mut self) -> TP0EN_W<TAMP_SPEC, 0> {
        TP0EN_W::new(self)
    }
    #[doc = "Bit 1 - Tamper 0 event trigger edge for RTC_TAMP0 input"]
    #[inline(always)]
    #[must_use]
    pub fn tp0eg(&mut self) -> TP0EG_W<TAMP_SPEC, 1> {
        TP0EG_W::new(self)
    }
    #[doc = "Bit 2 - Tamper detection interrupt enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn tpts(&mut self) -> TPTS_W<TAMP_SPEC, 7> {
        TPTS_W::new(self)
    }
    #[doc = "Bits 8:10 - Sample frequency of tamper event detection"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pc13val(&mut self) -> PC13VAL_W<TAMP_SPEC, 18> {
        PC13VAL_W::new(self)
    }
    #[doc = "Bit 19 - PC13 mode"]
    #[inline(always)]
    #[must_use]
    pub fn pc13mde(&mut self) -> PC13MDE_W<TAMP_SPEC, 19> {
        PC13MDE_W::new(self)
    }
    #[doc = "Bit 20 - PC14 value"]
    #[inline(always)]
