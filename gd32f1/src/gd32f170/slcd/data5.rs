...
pub struct W(crate::W<DATA5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA5_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SEG_DATA5` reader - Each bit corresponds to one segment to display"]
pub type SEG_DATA5_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SEG_DATA5` writer - Each bit corresponds to one segment to display"]
pub type SEG_DATA5_W<'a> = crate::FieldWriter<'a, u32, DATA5_SPEC, u32, u32, 32, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one segment to display"]
    #[inline(always)]
    pub fn seg_data5(&mut self) -> SEG_DATA5_W {
