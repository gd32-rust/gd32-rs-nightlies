...
pub type SEG_DATA1_R = crate::FieldReader<u32>;
#[doc = "Field `SEG_DATA1` writer - Each bit corresponds to one segment to display"]
pub type SEG_DATA1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
    #[doc = "Bits 0:31 - Each bit corresponds to one segment to display"]
    #[inline(always)]
    pub fn seg_data1(&self) -> SEG_DATA1_R {
        SEG_DATA1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one segment to display"]
    #[inline(always)]
    #[must_use]
    pub fn seg_data1(&mut self) -> SEG_DATA1_W<DATA1_SPEC, 0> {
        SEG_DATA1_W::new(self)
    }
