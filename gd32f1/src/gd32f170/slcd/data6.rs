...
pub struct W(crate::W<DATA6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA6_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SEG_DATA6` reader - Each bit corresponds to one segment to display"]
pub type SEG_DATA6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SEG_DATA6` writer - Each bit corresponds to one segment to display"]
pub type SEG_DATA6_W<'a> = crate::FieldWriter<'a, u32, DATA6_SPEC, u32, u32, 32, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one segment to display"]
    #[inline(always)]
    pub fn seg_data6(&mut self) -> SEG_DATA6_W {
