...
pub struct R(crate::R<TMI2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TMI2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TMI2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TMI2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TMI2` writer"]
pub struct W(crate::W<TMI2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TMI2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TMI2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TMI2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SFID_EFID_W<'a> = crate::FieldWriter<'a, u32, TMI2_SPEC, u16, u16, 11, 21>;
...
pub type EFID_W<'a> = crate::FieldWriter<'a, u32, TMI2_SPEC, u32, u32, 18, 3>;
#[doc = "Frame format\n\nValue on reset: 0"]
...
pub type FF_W<'a> = crate::BitWriter<'a, u32, TMI2_SPEC, FF_A, 2>;
impl<'a> FF_W<'a> {
...
pub type FT_W<'a> = crate::BitWriter<'a, u32, TMI2_SPEC, FT_A, 1>;
impl<'a> FT_W<'a> {
    #[doc = "Data frame"]
    #[inline(always)]
...
pub type TEN_W<'a> = crate::BitWriter<'a, u32, TMI2_SPEC, TEN_A, 0>;
impl<'a> TEN_W<'a> {
