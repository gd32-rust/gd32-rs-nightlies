...
pub struct R(crate::R<F22DATA1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<F22DATA1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<F22DATA1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<F22DATA1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `F22DATA1` writer"]
pub struct W(crate::W<F22DATA1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<F22DATA1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<F22DATA1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<F22DATA1_SPEC>) -> Self {
        W(writer)
    }
}
