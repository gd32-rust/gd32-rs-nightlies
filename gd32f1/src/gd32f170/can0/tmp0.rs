...
pub type DLENC_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 4, O>;
...
pub type TSEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, TSEN_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dlenc(&mut self) -> DLENC_W<TMP0_SPEC, 0> {
        DLENC_W::new(self)
    }
    #[doc = "Bit 8 - Time stamp enable"]
    #[inline(always)]
    #[must_use]
    pub fn tsen(&mut self) -> TSEN_W<TMP0_SPEC, 8> {
        TSEN_W::new(self)
    }
    #[doc = "Bits 16:31 - Time stamp"]
    #[inline(always)]
    #[must_use]
    pub fn ts(&mut self) -> TS_W<TMP0_SPEC, 16> {
        TS_W::new(self)
    }
