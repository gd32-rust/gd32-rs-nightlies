...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsq7(&mut self) -> RSQ7_W<RSQ1_SPEC, 0> {
        RSQ7_W::new(self)
    }
    #[doc = "Bits 5:9 - 8th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq8(&mut self) -> RSQ8_W<RSQ1_SPEC, 5> {
        RSQ8_W::new(self)
    }
    #[doc = "Bits 10:14 - 9th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq9(&mut self) -> RSQ9_W<RSQ1_SPEC, 10> {
        RSQ9_W::new(self)
    }
    #[doc = "Bits 15:19 - 10th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq10(&mut self) -> RSQ10_W<RSQ1_SPEC, 15> {
        RSQ10_W::new(self)
    }
    #[doc = "Bits 20:24 - 11th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq11(&mut self) -> RSQ11_W<RSQ1_SPEC, 20> {
        RSQ11_W::new(self)
    }
    #[doc = "Bits 25:29 - 12th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq12(&mut self) -> RSQ12_W<RSQ1_SPEC, 25> {
        RSQ12_W::new(self)
    }
