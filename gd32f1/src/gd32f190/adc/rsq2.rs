...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rsq1(&mut self) -> RSQ1_W<RSQ2_SPEC, 0> {
        RSQ1_W::new(self)
    }
    #[doc = "Bits 5:9 - 2nd conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq2(&mut self) -> RSQ2_W<RSQ2_SPEC, 5> {
        RSQ2_W::new(self)
    }
    #[doc = "Bits 10:14 - 3rd conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq3(&mut self) -> RSQ3_W<RSQ2_SPEC, 10> {
        RSQ3_W::new(self)
    }
    #[doc = "Bits 15:19 - 4th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq4(&mut self) -> RSQ4_W<RSQ2_SPEC, 15> {
        RSQ4_W::new(self)
    }
    #[doc = "Bits 20:24 - 5th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq5(&mut self) -> RSQ5_W<RSQ2_SPEC, 20> {
        RSQ5_W::new(self)
    }
    #[doc = "Bits 25:29 - 6th conversion in regular sequence"]
    #[inline(always)]
    #[must_use]
    pub fn rsq6(&mut self) -> RSQ6_W<RSQ2_SPEC, 25> {
        RSQ6_W::new(self)
    }
