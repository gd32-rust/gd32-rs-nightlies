...
pub type SWRCST_R = crate::BitReader<SWRCSTR_A>;
...
impl From<SWRCSTR_A> for bool {
    #[inline(always)]
    fn from(variant: SWRCSTR_A) -> Self {
        variant as u8 != 0
    }
}
impl SWRCST_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SWRCSTR_A {
        match self.bits {
            false => SWRCSTR_A::STARTED,
            true => SWRCSTR_A::NOT_STARTED,
        }
    }
    #[doc = "Reset state"]
    #[inline(always)]
    pub fn is_started(&self) -> bool {
        *self == SWRCSTR_A::STARTED
    }
    #[doc = "Starting conversion of regular channels"]
    #[inline(always)]
    pub fn is_not_started(&self) -> bool {
        *self == SWRCSTR_A::NOT_STARTED
    }
}
#[doc = "Start on regular channel\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl From<SWRCSTW_AW> for bool {
    #[inline(always)]
    fn from(variant: SWRCSTW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SWRCST` writer - Start on regular channel"]
pub type SWRCST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, SWRCSTW_AW>;
impl<'a, REG, const O: u8> SWRCST_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
...
pub type VBATEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, VBATEN_A>;
impl<'a, REG, const O: u8> VBATEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "VBAT channel disabled"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vbaten(&mut self) -> VBATEN_W<CTL1_SPEC, 24> {
        VBATEN_W::new(self)
    }
