...
pub type TBEIE_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, TBEIE_A, 7>;
impl<'a> TBEIE_W<'a> {
...
pub type RBNEIE_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, RBNEIE_A, 6>;
impl<'a> RBNEIE_W<'a> {
...
pub type ERRIE_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, ERRIE_A, 5>;
impl<'a> ERRIE_W<'a> {
...
pub type NSSDRV_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, NSSDRV_A, 2>;
impl<'a> NSSDRV_W<'a> {
...
pub type DMATEN_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, DMATEN_A, 1>;
impl<'a> DMATEN_W<'a> {
...
pub type DMAREN_W<'a> = crate::BitWriter<'a, u16, CTL1_SPEC, DMAREN_A, 0>;
impl<'a> DMAREN_W<'a> {
