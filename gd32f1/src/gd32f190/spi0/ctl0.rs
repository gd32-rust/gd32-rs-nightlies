...
pub type BDEN_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, BDEN_A, 15>;
impl<'a> BDEN_W<'a> {
...
pub type BDOEN_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, BDOEN_A, 14>;
impl<'a> BDOEN_W<'a> {
...
pub type CRCEN_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, CRCEN_A, 13>;
impl<'a> CRCEN_W<'a> {
...
pub type CRCNT_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, CRCNT_A, 12>;
impl<'a> CRCNT_W<'a> {
...
pub type FF16_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, FF16_A, 11>;
impl<'a> FF16_W<'a> {
...
pub type RO_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, RO_A, 10>;
impl<'a> RO_W<'a> {
...
pub type SWNSSEN_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, SWNSSEN_A, 9>;
impl<'a> SWNSSEN_W<'a> {
...
pub type SWNSS_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, SWNSS_A, 8>;
impl<'a> SWNSS_W<'a> {
...
pub type LF_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, LF_A, 7>;
impl<'a> LF_W<'a> {
...
pub type SPIEN_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, SPIEN_A, 6>;
impl<'a> SPIEN_W<'a> {
...
pub type PSC_W<'a> = crate::FieldWriterSafe<'a, u16, CTL0_SPEC, u8, PSC_A, 3, 3>;
impl<'a> PSC_W<'a> {
    #[doc = "PCLK / 2"]
    #[inline(always)]
...
pub type MSTMOD_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, MSTMOD_A, 2>;
impl<'a> MSTMOD_W<'a> {
...
pub type CKPL_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, CKPL_A, 1>;
impl<'a> CKPL_W<'a> {
...
pub type CKPH_W<'a> = crate::BitWriter<'a, u16, CTL0_SPEC, CKPH_A, 0>;
impl<'a> CKPH_W<'a> {
