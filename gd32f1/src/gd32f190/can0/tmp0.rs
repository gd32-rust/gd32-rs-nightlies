...
pub type TS_W<'a> = crate::FieldWriterSafe<'a, u32, TMP0_SPEC, u16, u16, 16, 16>;
...
pub type TSEN_W<'a> = crate::BitWriter<'a, u32, TMP0_SPEC, TSEN_A, 8>;
impl<'a> TSEN_W<'a> {
...
pub type DLENC_W<'a> = crate::FieldWriterSafe<'a, u32, TMP0_SPEC, u8, u8, 4, 0>;
impl R {
