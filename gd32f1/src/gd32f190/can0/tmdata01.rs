...
pub struct R(crate::R<TMDATA01_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TMDATA01_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TMDATA01_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TMDATA01_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TMDATA01` writer"]
pub struct W(crate::W<TMDATA01_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TMDATA01_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TMDATA01_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TMDATA01_SPEC>) -> Self {
        W(writer)
    }
}
