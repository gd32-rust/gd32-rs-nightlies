...
pub type SEG_DATA1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SEG_DATA1` writer - Each bit corresponds to one segment to display"]
pub type SEG_DATA1_W<'a> = crate::FieldWriter<'a, u32, DATA1_SPEC, u32, u32, 32, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one segment to display"]
    #[inline(always)]
    pub fn seg_data1(&mut self) -> SEG_DATA1_W {
