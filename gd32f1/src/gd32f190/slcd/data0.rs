...
pub type SEG_DATA0_R = crate::FieldReader<u32>;
#[doc = "Field `SEG_DATA0` writer - Each bit corresponds to one segment to display"]
pub type SEG_DATA0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn seg_data0(&mut self) -> SEG_DATA0_W<DATA0_SPEC, 0> {
