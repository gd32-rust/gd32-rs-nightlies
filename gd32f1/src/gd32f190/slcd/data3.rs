...
pub type SEG_DATA3_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SEG_DATA3` writer - Each bit corresponds to one segment to display"]
pub type SEG_DATA3_W<'a> = crate::FieldWriter<'a, u32, DATA3_SPEC, u32, u32, 32, 0>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Each bit corresponds to one segment to display"]
    #[inline(always)]
    pub fn seg_data3(&mut self) -> SEG_DATA3_W {
