...
pub type SMBALT_W<'a> = crate::BitWriter<'a, u16, STAT0_SPEC, SMBALT_A, 15>;
impl<'a> SMBALT_W<'a> {
...
pub type SMBTO_W<'a> = crate::BitWriter<'a, u16, STAT0_SPEC, SMBTO_A, 14>;
impl<'a> SMBTO_W<'a> {
...
pub type PECERR_W<'a> = crate::BitWriter<'a, u16, STAT0_SPEC, PECERR_A, 12>;
impl<'a> PECERR_W<'a> {
    #[doc = "No PEC error"]
    #[inline(always)]
...
pub type OUERR_W<'a> = crate::BitWriter<'a, u16, STAT0_SPEC, OUERR_A, 11>;
impl<'a> OUERR_W<'a> {
...
pub type AERR_W<'a> = crate::BitWriter<'a, u16, STAT0_SPEC, AERR_A, 10>;
impl<'a> AERR_W<'a> {
...
pub type LOSTARB_W<'a> = crate::BitWriter<'a, u16, STAT0_SPEC, LOSTARB_A, 9>;
impl<'a> LOSTARB_W<'a> {
...
pub type BERR_W<'a> = crate::BitWriter<'a, u16, STAT0_SPEC, BERR_A, 8>;
impl<'a> BERR_W<'a> {
