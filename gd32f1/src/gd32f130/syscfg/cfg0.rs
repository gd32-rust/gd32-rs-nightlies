...
impl PB9_HCCE_R {
    ...
    pub fn variant(&self) -> PB9_HCCE_A {
        match self.bits {
            false => PB9_HCCE_A::LOWCURRENT,
            true => PB9_HCCE_A::HIGHCURRENT,
        }
    }
    #[doc = "Checks if the value of the field is `LOWCURRENT`"]
    #[inline(always)]
    pub fn is_low_current(&self) -> bool {
        *self == PB9_HCCE_A::LOWCURRENT
    }
    #[doc = "Checks if the value of the field is `HIGHCURRENT`"]
    #[inline(always)]
    pub fn is_high_current(&self) -> bool {
        *self == PB9_HCCE_A::HIGHCURRENT
    }
}
#[doc = "Field `PB9_HCCE` writer - PB9 pin high current capability enable"]
pub type PB9_HCCE_W<'a> = crate::BitWriter<'a, u32, CFG0_SPEC, PB9_HCCE_A, 19>;
impl<'a> PB9_HCCE_W<'a> {
    #[doc = "High current capability is disabled"]
    #[inline(always)]
    pub fn low_current(self) -> &'a mut W {
        self.variant(PB9_HCCE_A::LOWCURRENT)
    }
    #[doc = "High current capability is enabled, and speed control is bypassed"]
    #[inline(always)]
    pub fn high_current(self) -> &'a mut W {
        self.variant(PB9_HCCE_A::HIGHCURRENT)
    }
}
