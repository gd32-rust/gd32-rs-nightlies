...
pub type ETP_W<'a> = crate::BitWriter<'a, u16, SMCFG_SPEC, ETP_A, 15>;
impl<'a> ETP_W<'a> {
...
pub type SMC1_W<'a> = crate::BitWriter<'a, u16, SMCFG_SPEC, SMC1_A, 14>;
impl<'a> SMC1_W<'a> {
...
pub type ETPSC_W<'a> = crate::FieldWriterSafe<'a, u16, SMCFG_SPEC, u8, ETPSC_A, 2, 12>;
impl<'a> ETPSC_W<'a> {
...
pub type ETFC_W<'a> = crate::FieldWriterSafe<'a, u16, SMCFG_SPEC, u8, ETFC_A, 4, 8>;
impl<'a> ETFC_W<'a> {
...
impl OCRC_R {
    ...
    #[doc = "Checks if the value of the field is `ETIF`"]
    #[inline(always)]
...
pub type OCRC_W<'a> = crate::BitWriter<'a, u16, SMCFG_SPEC, OCRC_A, 3>;
impl<'a> OCRC_W<'a> {
...
pub type SMC_W<'a> = crate::FieldWriterSafe<'a, u16, SMCFG_SPEC, u8, SMC_A, 3, 0>;
impl<'a> SMC_W<'a> {
