...
pub type MCKOEN_W<'a> = crate::BitWriter<'a, u16, I2SPSC_SPEC, MCKOEN_A, 9>;
impl<'a> MCKOEN_W<'a> {
...
pub type OF_W<'a> = crate::BitWriter<'a, u16, I2SPSC_SPEC, OF_A, 8>;
impl<'a> OF_W<'a> {
...
pub type DIV_W<'a> = crate::FieldWriter<'a, u16, I2SPSC_SPEC, u8, u8, 8, 0>;
impl R {
