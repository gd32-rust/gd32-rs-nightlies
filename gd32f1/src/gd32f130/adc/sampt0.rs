...
#[doc = "Channel 18 sample time selection"]
pub use SPT10_A as SPT18_A;
...
impl R {
    ...
    #[inline(always)]
    pub fn spt18(&self) -> SPT18_R {
        SPT18_R::new(((self.bits >> 24) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:2 - Channel 10 sample time selection"]
