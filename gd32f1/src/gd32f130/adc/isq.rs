...
pub type ISQ4_R = crate::FieldReader;
#[doc = "Field `ISQ4` writer - 4th conversion in injected sequence"]
pub type ISQ4_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type IL_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn isq1(&mut self) -> ISQ1_W<ISQ_SPEC, 0> {
        ISQ1_W::new(self)
    }
    #[doc = "Bits 5:9 - 2nd conversion in injected sequence"]
    #[inline(always)]
    #[must_use]
    pub fn isq2(&mut self) -> ISQ2_W<ISQ_SPEC, 5> {
        ISQ2_W::new(self)
    }
    #[doc = "Bits 10:14 - 3rd conversion in injected sequence"]
    #[inline(always)]
    #[must_use]
    pub fn isq3(&mut self) -> ISQ3_W<ISQ_SPEC, 10> {
        ISQ3_W::new(self)
    }
    #[doc = "Bits 15:19 - 4th conversion in injected sequence"]
    #[inline(always)]
    #[must_use]
    pub fn isq4(&mut self) -> ISQ4_W<ISQ_SPEC, 15> {
        ISQ4_W::new(self)
    }
    #[doc = "Bits 20:21 - Inserted channel group length"]
    #[inline(always)]
