...
pub type RSQ12_W<'a> = crate::FieldWriter<'a, u32, RSQ1_SPEC, u8, u8, 5, 25>;
...
pub type RSQ11_W<'a> = crate::FieldWriter<'a, u32, RSQ1_SPEC, u8, u8, 5, 20>;
...
pub type RSQ10_W<'a> = crate::FieldWriter<'a, u32, RSQ1_SPEC, u8, u8, 5, 15>;
...
pub type RSQ9_W<'a> = crate::FieldWriter<'a, u32, RSQ1_SPEC, u8, u8, 5, 10>;
...
pub type RSQ8_W<'a> = crate::FieldWriter<'a, u32, RSQ1_SPEC, u8, u8, 5, 5>;
...
pub type RSQ7_W<'a> = crate::FieldWriter<'a, u32, RSQ1_SPEC, u8, u8, 5, 0>;
impl R {
    #[doc = "Bits 25:29 - 12th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq12(&self) -> RSQ12_R {
        RSQ12_R::new(((self.bits >> 25) & 0x1f) as u8)
    }
