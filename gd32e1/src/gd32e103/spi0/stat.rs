...
pub type FERR_R = crate::BitReader<FERRR_A>;
#[doc = "Format Error\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FERRR_A {
...
impl From<FERRR_A> for bool {
    #[inline(always)]
    fn from(variant: FERRR_A) -> Self {
        variant as u8 != 0
    }
}
impl FERR_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> FERRR_A {
        match self.bits {
            false => FERRR_A::NO_ERROR,
            true => FERRR_A::ERROR,
        }
    }
    #[doc = "No format error"]
...
impl From<FERRW_AW> for bool {
    #[inline(always)]
    fn from(variant: FERRW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FERR` writer - Format Error"]
pub type FERR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, FERRW_AW>;
impl<'a, REG, const O: u8> FERR_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
