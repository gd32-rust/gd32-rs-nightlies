...
pub type R = crate::R<SNCTL_SPEC>;
#[doc = "Register `SNCTL` writer"]
pub type W = crate::W<SNCTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nrbken(&mut self) -> NRBKEN_W<SNCTL_SPEC, 0> {
        NRBKEN_W::new(self)
    }
    #[doc = "Bit 1 - NOR region memory address/data multiplexing"]
    #[inline(always)]
    #[must_use]
    pub fn nrmux(&mut self) -> NRMUX_W<SNCTL_SPEC, 1> {
        NRMUX_W::new(self)
    }
    #[doc = "Bits 2:3 - NOR region memory type"]
    #[inline(always)]
    #[must_use]
    pub fn nrtp(&mut self) -> NRTP_W<SNCTL_SPEC, 2> {
        NRTP_W::new(self)
    }
    #[doc = "Bits 4:5 - NOR region memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn nrw(&mut self) -> NRW_W<SNCTL_SPEC, 4> {
        NRW_W::new(self)
    }
    #[doc = "Bit 6 - NOR Flash access enable"]
    #[inline(always)]
    #[must_use]
    pub fn nren(&mut self) -> NREN_W<SNCTL_SPEC, 6> {
        NREN_W::new(self)
    }
    #[doc = "Bit 8 - synchronous burst enable"]
    #[inline(always)]
    #[must_use]
    pub fn sbrsten(&mut self) -> SBRSTEN_W<SNCTL_SPEC, 8> {
        SBRSTEN_W::new(self)
    }
    #[doc = "Bit 9 - NWAIT signal polarity"]
    #[inline(always)]
    #[must_use]
    pub fn nrwtpol(&mut self) -> NRWTPOL_W<SNCTL_SPEC, 9> {
        NRWTPOL_W::new(self)
    }
    #[doc = "Bit 10 - wrapped burst mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn wrapen(&mut self) -> WRAPEN_W<SNCTL_SPEC, 10> {
        WRAPEN_W::new(self)
    }
    #[doc = "Bit 11 - NWAIT signal configuration"]
    #[inline(always)]
    #[must_use]
    pub fn nrwtcfg(&mut self) -> NRWTCFG_W<SNCTL_SPEC, 11> {
        NRWTCFG_W::new(self)
    }
    #[doc = "Bit 12 - write enable"]
    #[inline(always)]
    #[must_use]
    pub fn wren(&mut self) -> WREN_W<SNCTL_SPEC, 12> {
        WREN_W::new(self)
    }
    #[doc = "Bit 13 - NWAIT signal enable"]
    #[inline(always)]
    #[must_use]
    pub fn nrwten(&mut self) -> NRWTEN_W<SNCTL_SPEC, 13> {
        NRWTEN_W::new(self)
    }
    #[doc = "Bit 14 - extended mode enable"]
    #[inline(always)]
    #[must_use]
    pub fn exmoden(&mut self) -> EXMODEN_W<SNCTL_SPEC, 14> {
        EXMODEN_W::new(self)
    }
    #[doc = "Bit 15 - asynchronous wait"]
    #[inline(always)]
    #[must_use]
    pub fn asyncwait(&mut self) -> ASYNCWAIT_W<SNCTL_SPEC, 15> {
        ASYNCWAIT_W::new(self)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    #[must_use]
    pub fn cps(&mut self) -> CPS_W<SNCTL_SPEC, 16> {
        CPS_W::new(self)
    }
    #[doc = "Bit 19 - synchronous write"]
    #[inline(always)]
    #[must_use]
    pub fn syncwr(&mut self) -> SYNCWR_W<SNCTL_SPEC, 19> {
        SYNCWR_W::new(self)
    }
...
pub struct SNCTL_SPEC;
impl crate::RegisterSpec for SNCTL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`snctl::R`](R) reader structure"]
impl crate::Readable for SNCTL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`snctl::W`](W) writer structure"]
impl crate::Writable for SNCTL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SNCTL to value 0x30db"]
impl crate::Resettable for SNCTL_SPEC {
