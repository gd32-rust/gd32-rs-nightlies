...
pub type R = crate::R<SNTCFG_SPEC>;
#[doc = "Register `SNTCFG` writer"]
pub type W = crate::W<SNTCFG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aset(&mut self) -> ASET_W<SNTCFG_SPEC, 0> {
        ASET_W::new(self)
    }
    #[doc = "Bits 4:7 - address hold time"]
    #[inline(always)]
    #[must_use]
    pub fn ahld(&mut self) -> AHLD_W<SNTCFG_SPEC, 4> {
        AHLD_W::new(self)
    }
    #[doc = "Bits 8:15 - data setup time"]
    #[inline(always)]
    #[must_use]
    pub fn dset(&mut self) -> DSET_W<SNTCFG_SPEC, 8> {
        DSET_W::new(self)
    }
    #[doc = "Bits 16:19 - bus latency"]
    #[inline(always)]
    #[must_use]
    pub fn buslat(&mut self) -> BUSLAT_W<SNTCFG_SPEC, 16> {
        BUSLAT_W::new(self)
    }
    #[doc = "Bits 20:23 - synchronous clock divide ratio"]
    #[inline(always)]
    #[must_use]
    pub fn ckdiv(&mut self) -> CKDIV_W<SNTCFG_SPEC, 20> {
        CKDIV_W::new(self)
    }
    #[doc = "Bits 24:27 - data latency for NOR Flash"]
    #[inline(always)]
    #[must_use]
    pub fn dlat(&mut self) -> DLAT_W<SNTCFG_SPEC, 24> {
        DLAT_W::new(self)
    }
    #[doc = "Bits 28:29 - asynchronous access mode"]
    #[inline(always)]
    #[must_use]
    pub fn asyncmod(&mut self) -> ASYNCMOD_W<SNTCFG_SPEC, 28> {
        ASYNCMOD_W::new(self)
    }
...
pub struct SNTCFG_SPEC;
impl crate::RegisterSpec for SNTCFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`sntcfg::R`](R) reader structure"]
impl crate::Readable for SNTCFG_SPEC {}
#[doc = "`write(|w| ..)` method takes [`sntcfg::W`](W) writer structure"]
impl crate::Writable for SNTCFG_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SNTCFG to value 0x0fff_ffff"]
impl crate::Resettable for SNTCFG_SPEC {
