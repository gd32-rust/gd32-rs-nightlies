...
impl ADCPSC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<ADCPSC_A> {
        match self.bits {
            0 => Some(ADCPSC_A::DIV2),
            1 => Some(ADCPSC_A::DIV4),
            2 => Some(ADCPSC_A::DIV6),
            3 => Some(ADCPSC_A::DIV8),
            _ => None,
        }
    }
...
pub type ADCPSC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 3, O, ADCPSC_A>;
...
pub type USBFSPSC_R = crate::FieldReader<USBFSPSC_A>;
...
impl From<USBFSPSC_A> for u8 {
    #[inline(always)]
    fn from(variant: USBFSPSC_A) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for USBFSPSC_A {
    type Ux = u8;
}
impl USBFSPSC_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> USBFSPSC_A {
        match self.bits {
            0 => USBFSPSC_A::DIV1_5,
            1 => USBFSPSC_A::DIV1,
            2 => USBFSPSC_A::DIV2_5,
    ...
    pub fn is_div1_5(&self) -> bool {
        *self == USBFSPSC_A::DIV1_5
    }
    #[doc = "PLL clock is not divided"]
    #[inline(always)]
    pub fn is_div1(&self) -> bool {
        *self == USBFSPSC_A::DIV1
    }
    #[doc = "PLL clock is divided by 2.5"]
    #[inline(always)]
    pub fn is_div2_5(&self) -> bool {
        *self == USBFSPSC_A::DIV2_5
    }
    #[doc = "PLL clock is divided by 2"]
    #[inline(always)]
    pub fn is_div2(&self) -> bool {
        *self == USBFSPSC_A::DIV2
    }
}
#[doc = "Field `USBFSPSC` writer - USBFS clock prescaler selection"]
pub type USBFSPSC_W<'a, REG, const O: u8> = crate::FieldWriterSafe<'a, REG, 2, O, USBFSPSC_A>;
impl<'a, REG, const O: u8> USBFSPSC_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
    ...
    pub fn div1_5(self) -> &'a mut crate::W<REG> {
        self.variant(USBFSPSC_A::DIV1_5)
    }
    #[doc = "PLL clock is not divided"]
    #[inline(always)]
    pub fn div1(self) -> &'a mut crate::W<REG> {
        self.variant(USBFSPSC_A::DIV1)
    }
    #[doc = "PLL clock is divided by 2.5"]
    #[inline(always)]
    pub fn div2_5(self) -> &'a mut crate::W<REG> {
        self.variant(USBFSPSC_A::DIV2_5)
    }
    #[doc = "PLL clock is divided by 2"]
    #[inline(always)]
    pub fn div2(self) -> &'a mut crate::W<REG> {
        self.variant(USBFSPSC_A::DIV2)
    }
}
...
impl CKOUTSEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<CKOUTSEL_A> {
        match self.bits {
            0 => Some(CKOUTSEL_A::NONE),
            1 => Some(CKOUTSEL_A::IRC14M),
            2 => Some(CKOUTSEL_A::LSI40K),
            3 => Some(CKOUTSEL_A::LXTAL),
            4 => Some(CKOUTSEL_A::SYSCLK),
            5 => Some(CKOUTSEL_A::IRC8M),
            6 => Some(CKOUTSEL_A::HXTAL),
            7 => Some(CKOUTSEL_A::PLL),
            _ => None,
        }
    }
...
pub type CKOUTSEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O, CKOUTSEL_A>;
...
pub type PLLMF_MSB_R = crate::FieldReader<PLLMF_MSB_A>;
...
impl From<PLLMF_MSB_A> for u8 {
    #[inline(always)]
    fn from(variant: PLLMF_MSB_A) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for PLLMF_MSB_A {
    type Ux = u8;
}
impl PLLMF_MSB_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<PLLMF_MSB_A> {
        match self.bits {
            0 => Some(PLLMF_MSB_A::NONE),
            1 => Some(PLLMF_MSB_A::PLUS15),
            _ => None,
        }
    }
...
pub type PLLMF_MSB_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O, PLLMF_MSB_A>;
...
pub type USBFSPSC_3_R = crate::BitReader;
#[doc = "Field `USBFSPSC_3` writer - Bit 2 of USBFSPSC"]
pub type USBFSPSC_3_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
    ...
    pub fn adcpsc(&self) -> ADCPSC_R {
        ADCPSC_R::new(((self.bits >> 14) & 7) as u8)
    }
    ...
    pub fn ckoutsel(&self) -> CKOUTSEL_R {
        CKOUTSEL_R::new(((self.bits >> 24) & 0x0f) as u8)
    }
    #[doc = "Bits 29:30 - Bit 5 and Bit 4 of PLLMF"]
    #[inline(always)]
    pub fn pllmf_msb(&self) -> PLLMF_MSB_R {
        PLLMF_MSB_R::new(((self.bits >> 29) & 3) as u8)
    }
    #[doc = "Bit 31 - Bit 2 of USBFSPSC"]
    #[inline(always)]
    pub fn usbfspsc_3(&self) -> USBFSPSC_3_R {
        USBFSPSC_3_R::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - System clock switch"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn pllmf_msb(&mut self) -> PLLMF_MSB_W<CFG0_SPEC, 29> {
        PLLMF_MSB_W::new(self)
    }
    #[doc = "Bit 31 - Bit 2 of USBFSPSC"]
    #[inline(always)]
    #[must_use]
    pub fn usbfspsc_3(&mut self) -> USBFSPSC_3_W<CFG0_SPEC, 31> {
        USBFSPSC_3_W::new(self)
    }
