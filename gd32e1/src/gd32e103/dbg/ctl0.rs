...
impl TRACE_IOEN_R {
    ...
    pub fn variant(&self) -> TRACE_IOEN_A {
        match self.bits {
            false => TRACE_IOEN_A::DISABLE,
            true => TRACE_IOEN_A::ENABLE,
        }
    }
    #[doc = "Disable trace pin allocation"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == TRACE_IOEN_A::DISABLE
    }
    #[doc = "Enable trace pin allocation"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == TRACE_IOEN_A::ENABLE
    }
}
#[doc = "Field `TRACE_IOEN` writer - Trace pin allocation enable"]
pub type TRACE_IOEN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, TRACE_IOEN_A>;
impl<'a, REG, const O: u8> TRACE_IOEN_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disable trace pin allocation"]
    ...
    pub fn disable(self) -> &'a mut crate::W<REG> {
        self.variant(TRACE_IOEN_A::DISABLE)
    }
    #[doc = "Enable trace pin allocation"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut crate::W<REG> {
        self.variant(TRACE_IOEN_A::ENABLE)
    }
}
