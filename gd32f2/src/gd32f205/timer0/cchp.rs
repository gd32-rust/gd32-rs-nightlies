...
pub type POEN_W<'a> = crate::BitWriter<'a, u32, CCHP_SPEC, POEN_A, 15>;
impl<'a> POEN_W<'a> {
...
pub type OAEN_W<'a> = crate::BitWriter<'a, u32, CCHP_SPEC, OAEN_A, 14>;
impl<'a> OAEN_W<'a> {
...
pub type BRKP_W<'a> = crate::BitWriter<'a, u32, CCHP_SPEC, BRKP_A, 13>;
impl<'a> BRKP_W<'a> {
...
pub type BRKEN_W<'a> = crate::BitWriter<'a, u32, CCHP_SPEC, BRKEN_A, 12>;
impl<'a> BRKEN_W<'a> {
...
pub type ROS_W<'a> = crate::BitWriter<'a, u32, CCHP_SPEC, ROS_A, 11>;
impl<'a> ROS_W<'a> {
...
pub type IOS_W<'a> = crate::BitWriter<'a, u32, CCHP_SPEC, IOS_A, 10>;
impl<'a> IOS_W<'a> {
...
pub type PROT_W<'a> = crate::FieldWriterSafe<'a, u32, CCHP_SPEC, u8, PROT_A, 2, 8>;
impl<'a> PROT_W<'a> {
...
pub type DTCFG_W<'a> = crate::FieldWriterSafe<'a, u32, CCHP_SPEC, u8, u8, 8, 0>;
impl R {
