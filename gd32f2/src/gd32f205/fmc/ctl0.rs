...
pub type ENDIE_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, ENDIE_A, 12>;
impl<'a> ENDIE_W<'a> {
...
pub type ERRIE_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, ERRIE_A, 10>;
impl<'a> ERRIE_W<'a> {
...
pub type OBWEN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, OBWEN_AW, 9>;
impl<'a> OBWEN_W<'a> {
...
pub type LK_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, LK_AW, 7>;
impl<'a> LK_W<'a> {
...
pub type START_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, START_A, 6>;
impl<'a> START_W<'a> {
...
pub type OBER_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, OBER_A, 5>;
impl<'a> OBER_W<'a> {
...
pub type OBPG_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, OBPG_A, 4>;
impl<'a> OBPG_W<'a> {
...
pub type MER_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, MER_A, 2>;
impl<'a> MER_W<'a> {
...
pub type PER_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, PER_A, 1>;
impl<'a> PER_W<'a> {
...
pub type PG_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, PG_A, 0>;
impl<'a> PG_W<'a> {
