...
pub type TXDTVAL_R = crate::BitReader<bool>;
#[doc = "Field `RXDTVAL` reader - Data is valid in receive FIFO"]
pub type RXDTVAL_R = crate::BitReader<bool>;
...
pub type ATAEND_R = crate::BitReader<bool>;
impl R {
