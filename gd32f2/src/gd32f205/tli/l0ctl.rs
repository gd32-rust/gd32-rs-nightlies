...
pub struct R(crate::R<L0CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L0CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L0CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L0CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L0CTL` writer"]
pub struct W(crate::W<L0CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L0CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L0CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L0CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type LUTEN_W<'a> = crate::BitWriter<'a, u32, L0CTL_SPEC, bool, 4>;
...
pub type CKEYEN_W<'a> = crate::BitWriter<'a, u32, L0CTL_SPEC, bool, 1>;
#[doc = "Field `LEN` reader - Layer enable"]
pub type LEN_R = crate::BitReader<bool>;
#[doc = "Field `LEN` writer - Layer enable"]
pub type LEN_W<'a> = crate::BitWriter<'a, u32, L0CTL_SPEC, bool, 0>;
impl R {
