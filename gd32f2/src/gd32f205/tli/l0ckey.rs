...
pub type R = crate::R<L0CKEY_SPEC>;
#[doc = "Register `L0CKEY` writer"]
pub type W = crate::W<L0CKEY_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ckeyb(&mut self) -> CKEYB_W<L0CKEY_SPEC, 0> {
        CKEYB_W::new(self)
    }
    #[doc = "Bits 8:15 - Color Key Green"]
    #[inline(always)]
    #[must_use]
    pub fn ckeyg(&mut self) -> CKEYG_W<L0CKEY_SPEC, 8> {
        CKEYG_W::new(self)
    }
    #[doc = "Bits 16:23 - Color Key Red"]
    #[inline(always)]
    #[must_use]
    pub fn ckeyr(&mut self) -> CKEYR_W<L0CKEY_SPEC, 16> {
        CKEYR_W::new(self)
    }
