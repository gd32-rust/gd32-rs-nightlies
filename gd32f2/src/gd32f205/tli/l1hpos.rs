...
pub struct R(crate::R<L1HPOS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1HPOS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1HPOS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1HPOS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1HPOS` writer"]
pub struct W(crate::W<L1HPOS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1HPOS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1HPOS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1HPOS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WLP_W<'a> = crate::FieldWriter<'a, u32, L1HPOS_SPEC, u16, u16, 12, 0>;
...
pub type WRP_W<'a> = crate::FieldWriter<'a, u32, L1HPOS_SPEC, u16, u16, 12, 16>;
impl R {
