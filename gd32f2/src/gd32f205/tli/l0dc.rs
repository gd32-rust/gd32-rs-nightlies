...
pub struct R(crate::R<L0DC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L0DC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L0DC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L0DC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L0DC` writer"]
pub struct W(crate::W<L0DC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L0DC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L0DC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L0DC_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DCA_W<'a> = crate::FieldWriter<'a, u32, L0DC_SPEC, u8, u8, 8, 24>;
...
pub type DCR_W<'a> = crate::FieldWriter<'a, u32, L0DC_SPEC, u8, u8, 8, 16>;
...
pub type DCG_W<'a> = crate::FieldWriter<'a, u32, L0DC_SPEC, u8, u8, 8, 8>;
...
pub type DCB_W<'a> = crate::FieldWriter<'a, u32, L0DC_SPEC, u8, u8, 8, 0>;
impl R {
...
#[doc = "Layer 0 default color register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [l0dc](index.html) module"]
pub struct L0DC_SPEC;
impl crate::RegisterSpec for L0DC_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [l0dc::R](R) reader structure"]
impl crate::Readable for L0DC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [l0dc::W](W) writer structure"]
impl crate::Writable for L0DC_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets L0DC to value 0"]
impl crate::Resettable for L0DC_SPEC {
    #[inline(always)]
