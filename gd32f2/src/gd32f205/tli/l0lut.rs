...
pub struct W(crate::W<L0LUT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L0LUT_SPEC>;
    #[inline(always)]
...
impl From<crate::W<L0LUT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L0LUT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TADD` writer - Look Up Table Write Address"]
pub type TADD_W<'a> = crate::FieldWriter<'a, u32, L0LUT_SPEC, u8, u8, 8, 24>;
#[doc = "Field `TR` writer - Red Channel of a LUT entry"]
pub type TR_W<'a> = crate::FieldWriter<'a, u32, L0LUT_SPEC, u8, u8, 8, 16>;
#[doc = "Field `TG` writer - Green channel of a LUT entry"]
pub type TG_W<'a> = crate::FieldWriter<'a, u32, L0LUT_SPEC, u8, u8, 8, 8>;
#[doc = "Field `TB` writer - Blue channel of a LUT entry"]
pub type TB_W<'a> = crate::FieldWriter<'a, u32, L0LUT_SPEC, u8, u8, 8, 0>;
impl W {
