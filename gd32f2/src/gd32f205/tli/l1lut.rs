...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tb(&mut self) -> TB_W<L1LUT_SPEC, 0> {
        TB_W::new(self)
    }
    #[doc = "Bits 8:15 - Green channel of a LUT entry"]
    #[inline(always)]
    #[must_use]
    pub fn tg(&mut self) -> TG_W<L1LUT_SPEC, 8> {
        TG_W::new(self)
    }
    #[doc = "Bits 16:23 - Red channel of a LUT entry"]
    #[inline(always)]
    #[must_use]
    pub fn tr(&mut self) -> TR_W<L1LUT_SPEC, 16> {
        TR_W::new(self)
    }
    #[doc = "Bits 24:31 - Look Up Table Write Address"]
    #[inline(always)]
    #[must_use]
    pub fn tadd(&mut self) -> TADD_W<L1LUT_SPEC, 24> {
        TADD_W::new(self)
    }
