...
pub type PTP_PPS_REMAP_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 30>;
#[doc = "Field `TIMER1ITR0_REMAP` reader - TIMER1 internal trigger 0 remapping"]
pub type TIMER1ITR0_REMAP_R = crate::BitReader<bool>;
#[doc = "Field `TIMER1ITR0_REMAP` writer - TIMER1 internal trigger 0 remapping"]
pub type TIMER1ITR0_REMAP_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 29>;
...
pub type SPI2_REMAP_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 28>;
...
pub type ENET_PHY_SEL_R = crate::BitReader<bool>;
#[doc = "Field `ENET_PHY_SEL` writer - Ethernet MII or RMII PHY selection"]
pub type ENET_PHY_SEL_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 23>;
...
pub type CAN1_REMAP_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 22>;
#[doc = "Field `ENET_REMAP` reader - Ethernet MAC I/O remapping"]
pub type ENET_REMAP_R = crate::BitReader<bool>;
#[doc = "Field `ENET_REMAP` writer - Ethernet MAC I/O remapping"]
pub type ENET_REMAP_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 21>;
...
pub type ADC1_ETRGINS_REMAP_R = crate::BitReader<bool>;
#[doc = "Field `ADC1_ETRGINS_REMAP` writer - ADC 1 external trigger inserted conversion remapping"]
pub type ADC1_ETRGINS_REMAP_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 19>;
...
pub type ADC0_ETRGINS_REMAP_R = crate::BitReader<bool>;
#[doc = "Field `ADC0_ETRGINS_REMAP` writer - ADC 0 external trigger inserted conversion remapping"]
pub type ADC0_ETRGINS_REMAP_W<'a> = crate::BitWriter<'a, u32, PCF0_SPEC, bool, 17>;
...
pub type CAN0_REMAP_W<'a> = crate::FieldWriter<'a, u32, PCF0_SPEC, u8, u8, 2, 13>;
...
impl R {
    ...
    #[inline(always)]
    pub fn adc1_etrgins_remap(&self) -> ADC1_ETRGINS_REMAP_R {
        ADC1_ETRGINS_REMAP_R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn adc0_etrgins_remap(&self) -> ADC0_ETRGINS_REMAP_R {
        ADC0_ETRGINS_REMAP_R::new(((self.bits >> 17) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 29 - TIMER1 internal trigger 0 remapping"]
    #[inline(always)]
    pub fn timer1itr0_remap(&mut self) -> TIMER1ITR0_REMAP_W {
    ...
    #[doc = "Bit 23 - Ethernet MII or RMII PHY selection"]
    #[inline(always)]
    pub fn enet_phy_sel(&mut self) -> ENET_PHY_SEL_W {
    ...
    #[doc = "Bit 21 - Ethernet MAC I/O remapping"]
    #[inline(always)]
    pub fn enet_remap(&mut self) -> ENET_REMAP_W {
    ...
    #[doc = "Bit 19 - ADC 1 external trigger inserted conversion remapping"]
    #[inline(always)]
    pub fn adc1_etrgins_remap(&mut self) -> ADC1_ETRGINS_REMAP_W {
        ADC1_ETRGINS_REMAP_W::new(self)
    }
    #[doc = "Bit 18 - ADC 0 external trigger regular conversion remapping"]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - ADC 0 external trigger inserted conversion remapping"]
    #[inline(always)]
    pub fn adc0_etrgins_remap(&mut self) -> ADC0_ETRGINS_REMAP_W {
        ADC0_ETRGINS_REMAP_W::new(self)
    }
    #[doc = "Bit 16 - TIMER4 channel3 internal remapping"]
    #[inline(always)]
