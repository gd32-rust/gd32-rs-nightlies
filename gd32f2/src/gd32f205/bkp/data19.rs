...
pub struct R(crate::R<DATA19_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATA19_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATA19_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATA19_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATA19` writer"]
pub struct W(crate::W<DATA19_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA19_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA19_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA19_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_W<'a> = crate::FieldWriter<'a, u32, DATA19_SPEC, u16, u16, 16, 0>;
impl R {
