...
pub type R = crate::R<MAC_ADDR2H_SPEC>;
#[doc = "Register `MAC_ADDR2H` writer"]
pub type W = crate::W<MAC_ADDR2H_SPEC>;
#[doc = "Field `ADDR2H` reader - Ethernet MAC address 2 high register"]
pub type ADDR2H_R = crate::FieldReader<u16>;
#[doc = "Field `ADDR2H` writer - Ethernet MAC address 2 high register"]
pub type ADDR2H_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn addr2h(&mut self) -> ADDR2H_W<MAC_ADDR2H_SPEC, 0> {
        ADDR2H_W::new(self)
    }
    #[doc = "Bits 24:29 - Mask byte"]
    #[inline(always)]
    #[must_use]
    pub fn mb(&mut self) -> MB_W<MAC_ADDR2H_SPEC, 24> {
        MB_W::new(self)
    }
    #[doc = "Bit 30 - Source address filter"]
    #[inline(always)]
    #[must_use]
    pub fn saf(&mut self) -> SAF_W<MAC_ADDR2H_SPEC, 30> {
        SAF_W::new(self)
    }
    #[doc = "Bit 31 - Address filter enable"]
    #[inline(always)]
    #[must_use]
    pub fn afe(&mut self) -> AFE_W<MAC_ADDR2H_SPEC, 31> {
        AFE_W::new(self)
    }
