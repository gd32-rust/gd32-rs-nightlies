...
pub type DS_W<'a> = crate::FieldWriter<'a, u32, DCFG_SPEC, u8, u8, 2, 0>;
...
pub type NZLSOH_W<'a> = crate::BitWriter<'a, u32, DCFG_SPEC, bool, 2>;
#[doc = "Field `DAR` reader - Device address"]
pub type DAR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DAR` writer - Device address"]
pub type DAR_W<'a> = crate::FieldWriter<'a, u32, DCFG_SPEC, u8, u8, 7, 4>;
...
pub type EOPFT_W<'a> = crate::FieldWriter<'a, u32, DCFG_SPEC, u8, u8, 2, 11>;
impl R {
