...
pub type SRESET_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, SRESET_A, 15>;
impl<'a> SRESET_W<'a> {
...
pub type SALT_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, SALT_A, 13>;
impl<'a> SALT_W<'a> {
...
pub type PECTRANS_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, PECTRANS_A, 12>;
impl<'a> PECTRANS_W<'a> {
    #[doc = "No PEC transfer"]
    #[inline(always)]
...
pub type POAP_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, POAP_A, 11>;
impl<'a> POAP_W<'a> {
...
pub type ACKEN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, ACKEN_A, 10>;
impl<'a> ACKEN_W<'a> {
...
pub type STOP_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, STOP_A, 9>;
impl<'a> STOP_W<'a> {
...
pub type START_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, START_A, 8>;
impl<'a> START_W<'a> {
...
pub type SS_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, SS_A, 7>;
impl<'a> SS_W<'a> {
...
pub type GCEN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, GCEN_A, 6>;
impl<'a> GCEN_W<'a> {
...
pub type PECEN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, PECEN_A, 5>;
impl<'a> PECEN_W<'a> {
...
pub type ARPEN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, ARPEN_A, 4>;
impl<'a> ARPEN_W<'a> {
    #[doc = "ARP disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type SMBSEL_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, SMBSEL_A, 3>;
impl<'a> SMBSEL_W<'a> {
    #[doc = "SMBus Device"]
    #[inline(always)]
...
pub type SMBEN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, SMBEN_A, 1>;
impl<'a> SMBEN_W<'a> {
    #[doc = "I2C Mode"]
    #[inline(always)]
...
pub type I2CEN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, I2CEN_A, 0>;
impl<'a> I2CEN_W<'a> {
