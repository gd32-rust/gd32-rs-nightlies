...
pub type GINTEN_W<'a> = crate::BitWriter<'a, u32, GAHBCS_SPEC, bool, 0>;
#[doc = "Field `TXFTH` reader - Tx FIFO threshold"]
pub type TXFTH_R = crate::BitReader<bool>;
#[doc = "Field `TXFTH` writer - Tx FIFO threshold"]
pub type TXFTH_W<'a> = crate::BitWriter<'a, u32, GAHBCS_SPEC, bool, 7>;
...
pub type PTXFTH_W<'a> = crate::BitWriter<'a, u32, GAHBCS_SPEC, bool, 8>;
impl R {
