...
pub type TOC_W<'a> = crate::FieldWriter<'a, u32, GUSBCS_SPEC, u8, u8, 3, 0>;
#[doc = "Field `FSSTS` reader - Full speed serial transceiver select"]
pub type FSSTS_R = crate::BitReader<bool>;
...
pub type SRPCEN_W<'a> = crate::BitWriter<'a, u32, GUSBCS_SPEC, bool, 8>;
...
impl R {
    ...
    #[inline(always)]
    pub fn fssts(&self) -> FSSTS_R {
        FSSTS_R::new(((self.bits >> 7) & 1) != 0)
    }
