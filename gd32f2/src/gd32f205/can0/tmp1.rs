...
pub struct R(crate::R<TMP1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TMP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TMP1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TMP1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TMP1` writer"]
pub struct W(crate::W<TMP1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TMP1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TMP1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TMP1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TS_W<'a> = crate::FieldWriterSafe<'a, u32, TMP1_SPEC, u16, u16, 16, 16>;
...
pub type TSEN_W<'a> = crate::BitWriter<'a, u32, TMP1_SPEC, TSEN_A, 8>;
impl<'a> TSEN_W<'a> {
...
pub type DLENC_W<'a> = crate::FieldWriterSafe<'a, u32, TMP1_SPEC, u8, u8, 4, 0>;
impl R {
