...
impl From<crate::R<SNWTCFG0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SNWTCFG0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SNWTCFG0` writer"]
pub struct W(crate::W<SNWTCFG0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SNWTCFG0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SNWTCFG0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SNWTCFG0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type WASYNCMOD_W<'a> = crate::FieldWriter<'a, u32, SNWTCFG0_SPEC, u8, u8, 2, 28>;
...
pub type DLAT_W<'a> = crate::FieldWriter<'a, u32, SNWTCFG0_SPEC, u8, u8, 4, 24>;
...
pub type WASET_W<'a> = crate::FieldWriter<'a, u32, SNWTCFG0_SPEC, u8, u8, 4, 0>;
impl R {
