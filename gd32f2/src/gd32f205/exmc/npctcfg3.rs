...
pub type COMHIZ_W<'a> = crate::FieldWriter<'a, u32, NPCTCFG3_SPEC, u8, u8, 8, 24>;
...
pub type COMHLD_W<'a> = crate::FieldWriter<'a, u32, NPCTCFG3_SPEC, u8, u8, 8, 16>;
...
pub type COMWAIT_W<'a> = crate::FieldWriter<'a, u32, NPCTCFG3_SPEC, u8, u8, 8, 8>;
...
pub type COMSET_W<'a> = crate::FieldWriter<'a, u32, NPCTCFG3_SPEC, u8, u8, 8, 0>;
impl R {
