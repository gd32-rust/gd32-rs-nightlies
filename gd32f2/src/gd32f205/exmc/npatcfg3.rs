...
pub type ATTHIZ_W<'a> = crate::FieldWriter<'a, u32, NPATCFG3_SPEC, u8, u8, 8, 24>;
...
pub type ATTHLD_W<'a> = crate::FieldWriter<'a, u32, NPATCFG3_SPEC, u8, u8, 8, 16>;
...
pub type ATTWAIT_W<'a> = crate::FieldWriter<'a, u32, NPATCFG3_SPEC, u8, u8, 8, 8>;
...
pub type ATTSET_W<'a> = crate::FieldWriter<'a, u32, NPATCFG3_SPEC, u8, u8, 8, 0>;
impl R {
