...
pub type IO23_DRV_W<'a> = crate::BitWriter<'a, u32, QCTL_SPEC, IO23_DRV_A, 2>;
impl<'a> IO23_DRV_W<'a> {
...
pub type QRD_W<'a> = crate::BitWriter<'a, u32, QCTL_SPEC, QRD_A, 1>;
impl<'a> QRD_W<'a> {
...
pub type QMOD_W<'a> = crate::BitWriter<'a, u32, QCTL_SPEC, QMOD_A, 0>;
impl<'a> QMOD_W<'a> {
