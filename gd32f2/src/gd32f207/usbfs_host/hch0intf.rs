...
pub type NAK_W<'a> = crate::BitWriter<'a, u32, HCH0INTF_SPEC, bool, 4>;
...
pub type REQOVR_W<'a> = crate::BitWriter<'a, u32, HCH0INTF_SPEC, bool, 9>;
#[doc = "Field `DTER` reader - Data toggle error"]
pub type DTER_R = crate::BitReader<bool>;
#[doc = "Field `DTER` writer - Data toggle error"]
pub type DTER_W<'a> = crate::BitWriter<'a, u32, HCH0INTF_SPEC, bool, 10>;
impl R {
