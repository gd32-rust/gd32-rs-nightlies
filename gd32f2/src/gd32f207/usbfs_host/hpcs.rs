...
pub type PCD_W<'a> = crate::BitWriter<'a, u32, HPCS_SPEC, bool, 1>;
#[doc = "Field `PE` reader - Port enable"]
pub type PE_R = crate::BitReader<bool>;
#[doc = "Field `PE` writer - Port enable"]
pub type PE_W<'a> = crate::BitWriter<'a, u32, HPCS_SPEC, bool, 2>;
...
pub type PEDC_W<'a> = crate::BitWriter<'a, u32, HPCS_SPEC, bool, 3>;
...
pub type PP_W<'a> = crate::BitWriter<'a, u32, HPCS_SPEC, bool, 12>;
...
impl R {
    ...
    #[inline(always)]
    pub fn pocc(&self) -> POCC_R {
        POCC_R::new(((self.bits >> 5) & 1) != 0)
    }
