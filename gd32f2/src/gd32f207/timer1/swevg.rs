...
pub type TRGG_W<'a> = crate::BitWriter<'a, u32, SWEVG_SPEC, TRGG_AW, 6>;
impl<'a> TRGG_W<'a> {
...
pub use crate::gd32f207::timer0::swevg::CH0G_AW as CH3G_AW;
#[doc = "Field `CH3G` writer - Channel 3 capture or compare event generation"]
pub type CH3G_W<'a> = crate::BitWriter<'a, u32, SWEVG_SPEC, CH3G_AW, 4>;
impl<'a> CH3G_W<'a> {
...
pub use crate::gd32f207::timer0::swevg::CH0G_AW as CH2G_AW;
#[doc = "Field `CH2G` writer - Channel 2 capture or compare event generation"]
pub type CH2G_W<'a> = crate::BitWriter<'a, u32, SWEVG_SPEC, CH2G_AW, 3>;
impl<'a> CH2G_W<'a> {
    #[doc = "Generate a capture or compare event"]
    #[inline(always)]
    pub fn capture_compare(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::swevg::CH0G_AW as CH1G_AW;
#[doc = "Field `CH1G` writer - Channel 1 capture or compare event generation"]
pub type CH1G_W<'a> = crate::BitWriter<'a, u32, SWEVG_SPEC, CH1G_AW, 2>;
impl<'a> CH1G_W<'a> {
    #[doc = "Generate a capture or compare event"]
    #[inline(always)]
    pub fn capture_compare(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::swevg::CH0G_AW;
#[doc = "Field `CH0G` writer - Channel 0 capture or compare event generation"]
pub type CH0G_W<'a> = crate::BitWriter<'a, u32, SWEVG_SPEC, CH0G_AW, 1>;
impl<'a> CH0G_W<'a> {
    #[doc = "Generate a capture or compare event"]
    #[inline(always)]
    pub fn capture_compare(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::swevg::UPG_AW;
