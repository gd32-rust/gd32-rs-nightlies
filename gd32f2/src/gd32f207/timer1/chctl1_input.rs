...
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPFLT_A as CH3CAPFLT_A;
#[doc = "Field `CH3CAPFLT` reader - Channel 3 input capture filter control"]
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPFLT_R as CH3CAPFLT_R;
#[doc = "Field `CH3CAPFLT` writer - Channel 3 input capture filter control"]
pub type CH3CAPFLT_W<'a> =
    crate::FieldWriterSafe<'a, u32, CHCTL1_INPUT_SPEC, u8, CH3CAPFLT_A, 4, 12>;
...
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPPSC_A as CH3CAPPSC_A;
#[doc = "Field `CH3CAPPSC` reader - Channel 3 input capture prescaler"]
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPPSC_R as CH3CAPPSC_R;
#[doc = "Field `CH3CAPPSC` writer - Channel 3 input capture prescaler"]
pub type CH3CAPPSC_W<'a> =
    crate::FieldWriterSafe<'a, u32, CHCTL1_INPUT_SPEC, u8, CH3CAPPSC_A, 2, 10>;
...
pub use crate::gd32f207::timer0::chctl0_input::CH0MS_A as CH3MS_A;
#[doc = "Field `CH3MS` reader - Channel 3 mode selection"]
pub use crate::gd32f207::timer0::chctl0_input::CH0MS_R as CH3MS_R;
#[doc = "Field `CH3MS` writer - Channel 3 mode selection"]
pub type CH3MS_W<'a> = crate::FieldWriterSafe<'a, u32, CHCTL1_INPUT_SPEC, u8, CH3MS_A, 2, 8>;
impl<'a> CH3MS_W<'a> {
...
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPFLT_A as CH2CAPFLT_A;
#[doc = "Field `CH2CAPFLT` reader - Channel 2 input capture filter control"]
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPFLT_R as CH2CAPFLT_R;
#[doc = "Field `CH2CAPFLT` writer - Channel 2 input capture filter control"]
pub type CH2CAPFLT_W<'a> =
    crate::FieldWriterSafe<'a, u32, CHCTL1_INPUT_SPEC, u8, CH2CAPFLT_A, 4, 4>;
...
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPPSC_A as CH2CAPPSC_A;
#[doc = "Field `CH2CAPPSC` reader - Channel 2 input capture prescaler"]
pub use crate::gd32f207::timer0::chctl0_input::CH0CAPPSC_R as CH2CAPPSC_R;
#[doc = "Field `CH2CAPPSC` writer - Channel 2 input capture prescaler"]
pub type CH2CAPPSC_W<'a> =
    crate::FieldWriterSafe<'a, u32, CHCTL1_INPUT_SPEC, u8, CH2CAPPSC_A, 2, 2>;
...
pub use crate::gd32f207::timer0::chctl0_input::CH0MS_A as CH2MS_A;
#[doc = "Field `CH2MS` reader - Channel 2 mode selection"]
pub use crate::gd32f207::timer0::chctl0_input::CH0MS_R as CH2MS_R;
#[doc = "Field `CH2MS` writer - Channel 2 mode selection"]
pub type CH2MS_W<'a> = crate::FieldWriterSafe<'a, u32, CHCTL1_INPUT_SPEC, u8, CH2MS_A, 2, 0>;
impl<'a> CH2MS_W<'a> {
    #[doc = "Channel is configured as output"]
    #[inline(always)]
    pub fn output(self) -> &'a mut W {
