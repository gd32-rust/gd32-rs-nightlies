...
pub use crate::gd32f207::timer0::intf::CH0OF_A as CH3OF_A;
#[doc = "Field `CH3OF` reader - Channel 3 over capture flag"]
pub use crate::gd32f207::timer0::intf::CH0OF_R as CH3OF_R;
#[doc = "Field `CH3OF` writer - Channel 3 over capture flag"]
pub type CH3OF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH3OF_A, 12>;
impl<'a> CH3OF_W<'a> {
...
pub use crate::gd32f207::timer0::intf::CH0OF_A as CH2OF_A;
#[doc = "Field `CH2OF` reader - Channel 2 over capture flag"]
pub use crate::gd32f207::timer0::intf::CH0OF_R as CH2OF_R;
#[doc = "Field `CH2OF` writer - Channel 2 over capture flag"]
pub type CH2OF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH2OF_A, 11>;
impl<'a> CH2OF_W<'a> {
    #[doc = "No over capture occurred"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::intf::CH0OF_A as CH1OF_A;
#[doc = "Field `CH1OF` reader - Channel 1 over capture flag"]
pub use crate::gd32f207::timer0::intf::CH0OF_R as CH1OF_R;
#[doc = "Field `CH1OF` writer - Channel 1 over capture flag"]
pub type CH1OF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH1OF_A, 10>;
impl<'a> CH1OF_W<'a> {
    #[doc = "No over capture occurred"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::intf::CH0OF_A;
#[doc = "Field `CH0OF` reader - Channel 0 over capture flag"]
pub use crate::gd32f207::timer0::intf::CH0OF_R;
#[doc = "Field `CH0OF` writer - Channel 0 over capture flag"]
pub type CH0OF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH0OF_A, 9>;
impl<'a> CH0OF_W<'a> {
    #[doc = "No over capture occurred"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
pub type TRGIF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, TRGIF_A, 6>;
impl<'a> TRGIF_W<'a> {
...
pub use crate::gd32f207::timer0::intf::CH0IF_A as CH3IF_A;
#[doc = "Field `CH3IF` reader - Channel 3 capture/compare interrupt enable"]
pub use crate::gd32f207::timer0::intf::CH0IF_R as CH3IF_R;
#[doc = "Field `CH3IF` writer - Channel 3 capture/compare interrupt enable"]
pub type CH3IF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH3IF_A, 4>;
impl<'a> CH3IF_W<'a> {
...
pub use crate::gd32f207::timer0::intf::CH0IF_A as CH2IF_A;
#[doc = "Field `CH2IF` reader - Channel 2 capture/compare interrupt enable"]
pub use crate::gd32f207::timer0::intf::CH0IF_R as CH2IF_R;
#[doc = "Field `CH2IF` writer - Channel 2 capture/compare interrupt enable"]
pub type CH2IF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH2IF_A, 3>;
impl<'a> CH2IF_W<'a> {
    #[doc = "No capture or compare interrupt occurred"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::intf::CH0IF_A as CH1IF_A;
#[doc = "Field `CH1IF` reader - Channel 1 capture/compare interrupt flag"]
pub use crate::gd32f207::timer0::intf::CH0IF_R as CH1IF_R;
#[doc = "Field `CH1IF` writer - Channel 1 capture/compare interrupt flag"]
pub type CH1IF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH1IF_A, 2>;
impl<'a> CH1IF_W<'a> {
    #[doc = "No capture or compare interrupt occurred"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::intf::CH0IF_A;
#[doc = "Field `CH0IF` reader - Channel 0 capture/compare interrupt flag"]
pub use crate::gd32f207::timer0::intf::CH0IF_R;
#[doc = "Field `CH0IF` writer - Channel 0 capture/compare interrupt flag"]
pub type CH0IF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CH0IF_A, 1>;
impl<'a> CH0IF_W<'a> {
    #[doc = "No capture or compare interrupt occurred"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
pub use crate::gd32f207::timer0::intf::UPIF_A;
#[doc = "Field `UPIF` reader - Update interrupt flag"]
pub use crate::gd32f207::timer0::intf::UPIF_R;
#[doc = "Field `UPIF` writer - Update interrupt flag"]
pub type UPIF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, UPIF_A, 0>;
impl<'a> UPIF_W<'a> {
