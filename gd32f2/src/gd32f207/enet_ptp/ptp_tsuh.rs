...
pub type R = crate::R<PTP_TSUH_SPEC>;
#[doc = "Register `PTP_TSUH` writer"]
pub type W = crate::W<PTP_TSUH_SPEC>;
#[doc = "Field `TMSUS` reader - Time stamp update second"]
pub type TMSUS_R = crate::FieldReader<u32>;
#[doc = "Field `TMSUS` writer - Time stamp update second"]
pub type TMSUS_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 32, O, u32>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tmsus(&mut self) -> TMSUS_W<PTP_TSUH_SPEC, 0> {
        TMSUS_W::new(self)
    }
