...
pub type CCIE_W<'a> = crate::BitWriter<'a, u32, INTEN_SPEC, bool, 1>;
#[doc = "Field `DIIE` reader - Data input interrupt enable"]
pub type DIIE_R = crate::BitReader<bool>;
#[doc = "Field `DIIE` writer - Data input interrupt enable"]
pub type DIIE_W<'a> = crate::BitWriter<'a, u32, INTEN_SPEC, bool, 0>;
impl R {
