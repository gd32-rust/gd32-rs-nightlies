...
pub struct R(crate::R<DATA12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATA12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATA12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATA12_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATA12` writer"]
pub struct W(crate::W<DATA12_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA12_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA12_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_W<'a> = crate::FieldWriter<'a, u32, DATA12_SPEC, u16, u16, 16, 0>;
impl R {
