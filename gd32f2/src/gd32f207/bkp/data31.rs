...
pub struct R(crate::R<DATA31_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DATA31_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DATA31_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DATA31_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DATA31` writer"]
pub struct W(crate::W<DATA31_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DATA31_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DATA31_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DATA31_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA_W<'a> = crate::FieldWriter<'a, u32, DATA31_SPEC, u16, u16, 16, 0>;
impl R {
