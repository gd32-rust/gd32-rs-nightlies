...
pub type MPL_W<'a> = crate::FieldWriter<'a, u32, DIEP0CTL_SPEC, u8, u8, 2, 0>;
...
pub type EPD_W<'a> = crate::BitWriter<'a, u32, DIEP0CTL_SPEC, bool, 30>;
#[doc = "Field `EPEN` reader - Endpoint enable"]
pub type EPEN_R = crate::BitReader<bool>;
#[doc = "Field `EPEN` writer - Endpoint enable"]
pub type EPEN_W<'a> = crate::BitWriter<'a, u32, DIEP0CTL_SPEC, bool, 31>;
impl R {
