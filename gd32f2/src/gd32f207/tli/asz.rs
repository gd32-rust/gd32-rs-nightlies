...
pub struct R(crate::R<ASZ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ASZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ASZ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ASZ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ASZ` writer"]
pub struct W(crate::W<ASZ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ASZ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl W {
    #[doc = "Bits 0:11 - Size of the vertical active area width plus back porch and synchronous pulse"]
    #[inline(always)]
    pub fn vasz(&mut self) -> VASZ_W {
        VASZ_W::new(self)
    }
    #[doc = "Bits 16:27 - Size of the horizontal active area width plus back porch and synchronous pulse"]
    #[inline(always)]
    pub fn hasz(&mut self) -> HASZ_W {
        HASZ_W::new(self)
    }
