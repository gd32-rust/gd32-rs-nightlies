...
pub type R = crate::R<L0DC_SPEC>;
#[doc = "Register `L0DC` writer"]
pub type W = crate::W<L0DC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dcb(&mut self) -> DCB_W<L0DC_SPEC, 0> {
        DCB_W::new(self)
    }
    #[doc = "Bits 8:15 - The default color green"]
    #[inline(always)]
    #[must_use]
    pub fn dcg(&mut self) -> DCG_W<L0DC_SPEC, 8> {
        DCG_W::new(self)
    }
    #[doc = "Bits 16:23 - The default color red"]
    #[inline(always)]
    #[must_use]
    pub fn dcr(&mut self) -> DCR_W<L0DC_SPEC, 16> {
        DCR_W::new(self)
    }
    #[doc = "Bits 24:31 - The default color ALPHA"]
    #[inline(always)]
    #[must_use]
    pub fn dca(&mut self) -> DCA_W<L0DC_SPEC, 24> {
        DCA_W::new(self)
    }
