...
pub struct R(crate::R<L1SA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1SA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1SA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1SA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1SA` writer"]
pub struct W(crate::W<L1SA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1SA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1SA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1SA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SA_W<'a> = crate::FieldWriter<'a, u32, L1SA_SPEC, u8, u8, 8, 0>;
impl R {
