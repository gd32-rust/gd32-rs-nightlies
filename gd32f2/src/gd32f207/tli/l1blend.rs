...
pub struct R(crate::R<L1BLEND_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<L1BLEND_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<L1BLEND_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<L1BLEND_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `L1BLEND` writer"]
pub struct W(crate::W<L1BLEND_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<L1BLEND_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<L1BLEND_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<L1BLEND_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ACF1_W<'a> = crate::FieldWriter<'a, u32, L1BLEND_SPEC, u8, u8, 3, 8>;
...
pub type ACF2_W<'a> = crate::FieldWriter<'a, u32, L1BLEND_SPEC, u8, u8, 3, 0>;
impl R {
