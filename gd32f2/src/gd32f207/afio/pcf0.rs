...
pub type ADC0_ETRGINS_REMAP_R = crate::BitReader;
#[doc = "Field `ADC0_ETRGINS_REMAP` writer - ADC 0 external trigger inserted conversion remapping"]
pub type ADC0_ETRGINS_REMAP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ADC1_ETRGINS_REMAP_R = crate::BitReader;
#[doc = "Field `ADC1_ETRGINS_REMAP` writer - ADC 1 external trigger inserted conversion remapping"]
pub type ADC1_ETRGINS_REMAP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc0_etrgins_remap(&mut self) -> ADC0_ETRGINS_REMAP_W<PCF0_SPEC, 17> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc1_etrgins_remap(&mut self) -> ADC1_ETRGINS_REMAP_W<PCF0_SPEC, 19> {
