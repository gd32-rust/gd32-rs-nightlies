#![doc = "Peripheral access API for GD32F207 microcontrollers (generated using svd2rust v0.24.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl CAU {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const cau::RegisterBlock = 0x5006_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
unsafe impl Send for HAU {}
impl HAU {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const hau::RegisterBlock = 0x5006_0400 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
    pub const fn ptr() -> *const hau::RegisterBlock {
        Self::PTR
    }
}
impl Deref for HAU {
    type Target = hau::RegisterBlock;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        unsafe { &*Self::PTR }
    }
