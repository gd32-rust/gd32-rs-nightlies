...
pub type OINTEN_R = crate::BitReader<bool>;
#[doc = "Field `OINTEN` writer - Out FIFO interrupt enable"]
pub type OINTEN_W<'a> = crate::BitWriter<'a, u32, INTEN_SPEC, bool, 1>;
#[doc = "Field `IINTEN` reader - In FIFO interrupt enable"]
pub type IINTEN_R = crate::BitReader<bool>;
#[doc = "Field `IINTEN` writer - In FIFO interrupt enable"]
pub type IINTEN_W<'a> = crate::BitWriter<'a, u32, INTEN_SPEC, bool, 0>;
impl R {
...
impl W {
    #[doc = "Bit 1 - Out FIFO interrupt enable"]
    #[inline(always)]
    pub fn ointen(&mut self) -> OINTEN_W {
        OINTEN_W::new(self)
    }
    #[doc = "Bit 0 - In FIFO interrupt enable"]
    #[inline(always)]
    pub fn iinten(&mut self) -> IINTEN_W {
        IINTEN_W::new(self)
    }
