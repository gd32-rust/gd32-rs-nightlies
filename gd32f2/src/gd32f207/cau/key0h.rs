...
pub struct W(crate::W<KEY0H_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<KEY0H_SPEC>;
    #[inline(always)]
...
impl From<crate::W<KEY0H_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<KEY0H_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `KEY0H` writer - Key for DES,TDES,AES"]
pub type KEY0H_W<'a> = crate::FieldWriter<'a, u32, KEY0H_SPEC, u32, u32, 32, 0>;
impl W {
    #[doc = "Bits 0:31 - Key for DES,TDES,AES"]
    #[inline(always)]
    pub fn key0h(&mut self) -> KEY0H_W {
        KEY0H_W::new(self)
    }
...
#[doc = "CAU key register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [key0h](index.html) module"]
