...
impl From<PLL1EN_A> for bool {
    #[inline(always)]
    fn from(variant: PLL1EN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PLL1EN` reader - PLL1 enable"]
pub type PLL1EN_R = crate::BitReader<PLL1EN_A>;
impl PLL1EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PLL1EN_A {
        match self.bits {
            false => PLL1EN_A::OFF,
            true => PLL1EN_A::ON,
        }
...
pub type PLL1EN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, PLL1EN_A, 26>;
impl<'a> PLL1EN_W<'a> {
    #[doc = "PLL1 Off"]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(PLL1EN_A::OFF)
    }
    #[doc = "PLL1 On"]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(PLL1EN_A::ON)
    }
}
#[doc = "PLL1 Clock Stabilization Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PLL1STB_A {
    #[doc = "0: PLL1 is not stable"]
    NOTREADY = 0,
    #[doc = "1: PLL1 is stable"]
    READY = 1,
}
impl From<PLL1STB_A> for bool {
    #[inline(always)]
    fn from(variant: PLL1STB_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PLL1STB` reader - PLL1 Clock Stabilization Flag"]
pub type PLL1STB_R = crate::BitReader<PLL1STB_A>;
impl PLL1STB_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PLL1STB_A {
        match self.bits {
            false => PLL1STB_A::NOTREADY,
            true => PLL1STB_A::READY,
        }
    }
    #[doc = "Checks if the value of the field is `NOTREADY`"]
    #[inline(always)]
    pub fn is_not_ready(&self) -> bool {
        *self == PLL1STB_A::NOTREADY
    }
    #[doc = "Checks if the value of the field is `READY`"]
    #[inline(always)]
    pub fn is_ready(&self) -> bool {
        *self == PLL1STB_A::READY
    }
}
#[doc = "PLL2 enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
impl From<PLL2EN_A> for bool {
    #[inline(always)]
    fn from(variant: PLL2EN_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PLL2EN` reader - PLL2 enable"]
pub type PLL2EN_R = crate::BitReader<PLL2EN_A>;
impl PLL2EN_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PLL2EN_A {
        match self.bits {
            false => PLL2EN_A::OFF,
            true => PLL2EN_A::ON,
        }
...
pub type PLL2EN_W<'a> = crate::BitWriter<'a, u32, CTL0_SPEC, PLL2EN_A, 28>;
impl<'a> PLL2EN_W<'a> {
    #[doc = "PLL2 Off"]
    #[inline(always)]
    pub fn off(self) -> &'a mut W {
        self.variant(PLL2EN_A::OFF)
    }
    #[doc = "PLL2 On"]
    #[inline(always)]
    pub fn on(self) -> &'a mut W {
        self.variant(PLL2EN_A::ON)
    }
}
#[doc = "PLL2 Clock Stabilization Flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum PLL2STB_A {
    #[doc = "0: PLL2 is not stable"]
    NOTREADY = 0,
    #[doc = "1: PLL2 is stable"]
    READY = 1,
}
impl From<PLL2STB_A> for bool {
    #[inline(always)]
    fn from(variant: PLL2STB_A) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PLL2STB` reader - PLL2 Clock Stabilization Flag"]
pub type PLL2STB_R = crate::BitReader<PLL2STB_A>;
impl PLL2STB_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> PLL2STB_A {
        match self.bits {
            false => PLL2STB_A::NOTREADY,
            true => PLL2STB_A::READY,
        }
    }
    #[doc = "Checks if the value of the field is `NOTREADY`"]
    #[inline(always)]
    pub fn is_not_ready(&self) -> bool {
        *self == PLL2STB_A::NOTREADY
    }
    #[doc = "Checks if the value of the field is `READY`"]
    #[inline(always)]
    pub fn is_ready(&self) -> bool {
        *self == PLL2STB_A::READY
    }
}
impl R {
