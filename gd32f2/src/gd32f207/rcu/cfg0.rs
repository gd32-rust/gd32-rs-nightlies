...
pub type USBFSPSC_W<'a> = crate::FieldWriter<'a, u32, CFG0_SPEC, u8, u8, 2, 22>;
...
pub type CKOUTSEL_W<'a> = crate::FieldWriter<'a, u32, CFG0_SPEC, u8, CKOUTSEL_A, 4, 24>;
impl<'a> CKOUTSEL_W<'a> {
...
pub type PLLMF_MSB_W<'a> = crate::BitWriter<'a, u32, CFG0_SPEC, PLLMF_MSB_A, 29>;
...
impl ADCPSC_R {
    ...
    pub fn variant(&self) -> Option<ADCPSC_A> {
        match self.bits {
            4 => Some(ADCPSC_A::DIV12),
            5 => Some(ADCPSC_A::DIV16),
...
pub type ADCPSC_W<'a> = crate::FieldWriter<'a, u32, CFG0_SPEC, u8, ADCPSC_A, 3, 14>;
impl<'a> ADCPSC_W<'a> {
    #[doc = "CK_APB2 divided by 12"]
    #[inline(always)]
    pub fn div12(self) -> &'a mut W {
        self.variant(ADCPSC_A::DIV12)
    }
    #[doc = "CK_APB2 divided by 16"]
    #[inline(always)]
    pub fn div16(self) -> &'a mut W {
        self.variant(ADCPSC_A::DIV16)
    }
...
impl R {
    ...
    pub fn pllmf_msb(&self) -> PLLMF_MSB_R {
        PLLMF_MSB_R::new(((self.bits >> 29) & 1) != 0)
    }
