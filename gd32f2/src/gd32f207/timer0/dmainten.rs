...
pub type CMTDEN_W<'a> = crate::BitWriter<'a, u32, DMAINTEN_SPEC, CMTDEN_A, 13>;
impl<'a> CMTDEN_W<'a> {
...
pub type BRKIE_W<'a> = crate::BitWriter<'a, u32, DMAINTEN_SPEC, BRKIE_A, 7>;
impl<'a> BRKIE_W<'a> {
...
pub type CMTIE_W<'a> = crate::BitWriter<'a, u32, DMAINTEN_SPEC, CMTIE_A, 5>;
impl<'a> CMTIE_W<'a> {
