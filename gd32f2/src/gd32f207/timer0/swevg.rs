...
pub type BRKG_W<'a> = crate::BitWriter<'a, u32, SWEVG_SPEC, BRKG_AW, 7>;
impl<'a> BRKG_W<'a> {
...
pub type CMTG_W<'a> = crate::BitWriter<'a, u32, SWEVG_SPEC, CMTG_AW, 5>;
impl<'a> CMTG_W<'a> {
