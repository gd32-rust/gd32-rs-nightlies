...
pub type BRKIF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, BRKIF_A, 7>;
impl<'a> BRKIF_W<'a> {
...
pub type CMTIF_W<'a> = crate::BitWriter<'a, u32, INTF_SPEC, CMTIF_A, 5>;
impl<'a> CMTIF_W<'a> {
...
#[doc = "Channel 3 capture/compare interrupt flag"]
pub use CH0IF_A as CH3IF_A;
#[doc = "Channel 2 capture/compare interrupt flag"]
