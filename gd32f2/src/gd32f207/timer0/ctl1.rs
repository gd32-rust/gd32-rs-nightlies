...
pub use crate::gd32f207::timer0::ctl1::ISO0_A as ISO1_A;
#[doc = "Field `ISO1` reader - Idle state of channel 1 output"]
pub use crate::gd32f207::timer0::ctl1::ISO0_R as ISO1_R;
...
pub type ISO1_W<'a> = crate::BitWriter<'a, u32, CTL1_SPEC, ISO1_A, 10>;
impl<'a> ISO1_W<'a> {
...
pub type ISO0N_W<'a> = crate::BitWriter<'a, u32, CTL1_SPEC, ISO0N_A, 9>;
impl<'a> ISO0N_W<'a> {
...
pub type ISO0_W<'a> = crate::BitWriter<'a, u32, CTL1_SPEC, ISO0_A, 8>;
impl<'a> ISO0_W<'a> {
    #[doc = "CHn_O=0 (after a dead-time if CHn_ON is implemented) when POEN=0"]
    #[inline(always)]
    pub fn low(self) -> &'a mut W {
...
pub type TI0S_W<'a> = crate::BitWriter<'a, u32, CTL1_SPEC, TI0S_A, 7>;
impl<'a> TI0S_W<'a> {
...
pub type MMC_W<'a> = crate::FieldWriterSafe<'a, u32, CTL1_SPEC, u8, MMC_A, 3, 4>;
impl<'a> MMC_W<'a> {
...
pub type DMAS_W<'a> = crate::BitWriter<'a, u32, CTL1_SPEC, DMAS_A, 3>;
impl<'a> DMAS_W<'a> {
...
pub type CCUC_W<'a> = crate::BitWriter<'a, u32, CTL1_SPEC, CCUC_A, 2>;
impl<'a> CCUC_W<'a> {
...
pub type CCSE_W<'a> = crate::BitWriter<'a, u32, CTL1_SPEC, CCSE_A, 0>;
impl<'a> CCSE_W<'a> {
