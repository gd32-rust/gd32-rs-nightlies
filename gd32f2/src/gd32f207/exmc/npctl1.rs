...
pub type R = crate::R<NPCTL1_SPEC>;
#[doc = "Register `NPCTL1` writer"]
pub type W = crate::W<NPCTL1_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ndwten(&mut self) -> NDWTEN_W<NPCTL1_SPEC, 1> {
        NDWTEN_W::new(self)
    }
    #[doc = "Bit 2 - NAND bank enable"]
    #[inline(always)]
    #[must_use]
    pub fn ndbken(&mut self) -> NDBKEN_W<NPCTL1_SPEC, 2> {
        NDBKEN_W::new(self)
    }
    #[doc = "Bit 3 - NAND bank memory type"]
    #[inline(always)]
    #[must_use]
    pub fn ndtp(&mut self) -> NDTP_W<NPCTL1_SPEC, 3> {
        NDTP_W::new(self)
    }
    #[doc = "Bits 4:5 - NAND bank memory data bus width"]
    #[inline(always)]
    #[must_use]
    pub fn ndw(&mut self) -> NDW_W<NPCTL1_SPEC, 4> {
        NDW_W::new(self)
    }
    #[doc = "Bit 6 - ECC enable"]
    #[inline(always)]
    #[must_use]
    pub fn eccen(&mut self) -> ECCEN_W<NPCTL1_SPEC, 6> {
        ECCEN_W::new(self)
    }
    #[doc = "Bits 9:12 - CLE to RE delay"]
    #[inline(always)]
    #[must_use]
    pub fn ctr(&mut self) -> CTR_W<NPCTL1_SPEC, 9> {
        CTR_W::new(self)
    }
    #[doc = "Bits 13:16 - ALE to RE delay"]
    #[inline(always)]
    #[must_use]
    pub fn atr(&mut self) -> ATR_W<NPCTL1_SPEC, 13> {
        ATR_W::new(self)
    }
    #[doc = "Bits 17:19 - ECC size"]
    #[inline(always)]
    #[must_use]
    pub fn eccsz(&mut self) -> ECCSZ_W<NPCTL1_SPEC, 17> {
        ECCSZ_W::new(self)
    }
