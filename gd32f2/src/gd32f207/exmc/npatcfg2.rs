...
pub struct R(crate::R<NPATCFG2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NPATCFG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NPATCFG2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NPATCFG2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `NPATCFG2` writer"]
pub struct W(crate::W<NPATCFG2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NPATCFG2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NPATCFG2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NPATCFG2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ATTHIZ_W<'a> = crate::FieldWriter<'a, u32, NPATCFG2_SPEC, u8, u8, 8, 24>;
...
pub type ATTHLD_W<'a> = crate::FieldWriter<'a, u32, NPATCFG2_SPEC, u8, u8, 8, 16>;
...
pub type ATTWAIT_W<'a> = crate::FieldWriter<'a, u32, NPATCFG2_SPEC, u8, u8, 8, 8>;
...
pub type ATTSET_W<'a> = crate::FieldWriter<'a, u32, NPATCFG2_SPEC, u8, u8, 8, 0>;
impl R {
