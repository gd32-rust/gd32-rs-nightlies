...
pub type R = crate::R<SNWTCFG0_SPEC>;
#[doc = "Register `SNWTCFG0` writer"]
pub type W = crate::W<SNWTCFG0_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn waset(&mut self) -> WASET_W<SNWTCFG0_SPEC, 0> {
        WASET_W::new(self)
    }
    #[doc = "Bits 4:7 - Address hold time"]
    #[inline(always)]
    #[must_use]
    pub fn wahld(&mut self) -> WAHLD_W<SNWTCFG0_SPEC, 4> {
        WAHLD_W::new(self)
    }
    #[doc = "Bits 8:15 - Data setup time"]
    #[inline(always)]
    #[must_use]
    pub fn wdset(&mut self) -> WDSET_W<SNWTCFG0_SPEC, 8> {
        WDSET_W::new(self)
    }
    #[doc = "Bits 20:23 - Synchronous clock divide ratio"]
    #[inline(always)]
    #[must_use]
    pub fn ckdiv(&mut self) -> CKDIV_W<SNWTCFG0_SPEC, 20> {
        CKDIV_W::new(self)
    }
    #[doc = "Bits 24:27 - Data latency for NOR Flash"]
    #[inline(always)]
    #[must_use]
    pub fn dlat(&mut self) -> DLAT_W<SNWTCFG0_SPEC, 24> {
        DLAT_W::new(self)
    }
    #[doc = "Bits 28:29 - Asynchronous access mode"]
    #[inline(always)]
    #[must_use]
    pub fn wasyncmod(&mut self) -> WASYNCMOD_W<SNWTCFG0_SPEC, 28> {
