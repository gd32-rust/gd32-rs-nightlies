...
pub type R = crate::R<SNWTCFG2_SPEC>;
#[doc = "Register `SNWTCFG2` writer"]
pub type W = crate::W<SNWTCFG2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn waset(&mut self) -> WASET_W<SNWTCFG2_SPEC, 0> {
        WASET_W::new(self)
    }
    #[doc = "Bits 4:7 - Address hold time"]
    #[inline(always)]
    #[must_use]
    pub fn wahld(&mut self) -> WAHLD_W<SNWTCFG2_SPEC, 4> {
        WAHLD_W::new(self)
    }
    #[doc = "Bits 8:15 - Data setup time"]
    #[inline(always)]
    #[must_use]
    pub fn wdset(&mut self) -> WDSET_W<SNWTCFG2_SPEC, 8> {
        WDSET_W::new(self)
    }
    #[doc = "Bits 20:23 - Synchronous clock divide ratio"]
    #[inline(always)]
    #[must_use]
    pub fn ckdiv(&mut self) -> CKDIV_W<SNWTCFG2_SPEC, 20> {
        CKDIV_W::new(self)
    }
    #[doc = "Bits 24:27 - Data latency for NOR Flash"]
    #[inline(always)]
    #[must_use]
    pub fn dlat(&mut self) -> DLAT_W<SNWTCFG2_SPEC, 24> {
        DLAT_W::new(self)
    }
    #[doc = "Bits 28:29 - Asynchronous access mode"]
    #[inline(always)]
    #[must_use]
    pub fn wasyncmod(&mut self) -> WASYNCMOD_W<SNWTCFG2_SPEC, 28> {
...
#[doc = "SRAM/NOR flash write timing configuration register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`snwtcfg2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`snwtcfg2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
