...
pub type R = crate::R<SNTCFG3_SPEC>;
#[doc = "Register `SNTCFG3` writer"]
pub type W = crate::W<SNTCFG3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aset(&mut self) -> ASET_W<SNTCFG3_SPEC, 0> {
        ASET_W::new(self)
    }
    #[doc = "Bits 4:7 - Address hold time"]
    #[inline(always)]
    #[must_use]
    pub fn ahld(&mut self) -> AHLD_W<SNTCFG3_SPEC, 4> {
        AHLD_W::new(self)
    }
    #[doc = "Bits 8:15 - Data setup time"]
    #[inline(always)]
    #[must_use]
    pub fn dset(&mut self) -> DSET_W<SNTCFG3_SPEC, 8> {
        DSET_W::new(self)
    }
    #[doc = "Bits 16:19 - Bus latency"]
    #[inline(always)]
    #[must_use]
    pub fn buslat(&mut self) -> BUSLAT_W<SNTCFG3_SPEC, 16> {
        BUSLAT_W::new(self)
    }
    #[doc = "Bits 20:23 - Synchronous clock divide ratio"]
    #[inline(always)]
    #[must_use]
    pub fn ckdiv(&mut self) -> CKDIV_W<SNTCFG3_SPEC, 20> {
        CKDIV_W::new(self)
    }
    #[doc = "Bits 24:27 - Data latency for NOR Flash"]
    #[inline(always)]
    #[must_use]
    pub fn dlat(&mut self) -> DLAT_W<SNTCFG3_SPEC, 24> {
        DLAT_W::new(self)
    }
    #[doc = "Bits 28:29 - Asynchronous access mode"]
    #[inline(always)]
    #[must_use]
    pub fn asyncmod(&mut self) -> ASYNCMOD_W<SNTCFG3_SPEC, 28> {
        ASYNCMOD_W::new(self)
    }
