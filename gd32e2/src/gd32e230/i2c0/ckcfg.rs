...
pub type FAST_W<'a> = crate::BitWriter<'a, u32, CKCFG_SPEC, FAST_A, 15>;
impl<'a> FAST_W<'a> {
...
pub type DTCY_W<'a> = crate::BitWriter<'a, u32, CKCFG_SPEC, DTCY_A, 14>;
impl<'a> DTCY_W<'a> {
...
pub type CLKC_W<'a> = crate::FieldWriterSafe<'a, u32, CKCFG_SPEC, u16, u16, 12, 0>;
impl R {
