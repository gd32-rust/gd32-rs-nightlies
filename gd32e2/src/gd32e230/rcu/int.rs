...
pub type IRC28MSTBIF_R = crate::BitReader<IRC28MSTBIFR_A>;
#[doc = "IRC28M stabilization interrupt flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IRC28MSTBIFR_A {
    #[doc = "0: No interrupt generated"]
    NOT_INTERRUPTED = 0,
    #[doc = "1: IRC14M stabilisation interrupt generated"]
    INTERRUPTED = 1,
}
impl From<IRC28MSTBIFR_A> for bool {
    #[inline(always)]
    fn from(variant: IRC28MSTBIFR_A) -> Self {
        variant as u8 != 0
    }
}
impl IRC28MSTBIF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IRC28MSTBIFR_A {
        match self.bits {
            false => IRC28MSTBIFR_A::NOT_INTERRUPTED,
            true => IRC28MSTBIFR_A::INTERRUPTED,
        }
    }
    #[doc = "No interrupt generated"]
    #[inline(always)]
    pub fn is_not_interrupted(&self) -> bool {
        *self == IRC28MSTBIFR_A::NOT_INTERRUPTED
    }
    #[doc = "IRC14M stabilisation interrupt generated"]
    #[inline(always)]
    pub fn is_interrupted(&self) -> bool {
        *self == IRC28MSTBIFR_A::INTERRUPTED
    }
}
...
pub type IRC28MSTBIE_R = crate::BitReader<IRC28MSTBIE_A>;
#[doc = "IRC28M Stabilization Interrupt Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IRC28MSTBIE_A {
    #[doc = "0: Interrupt disabled"]
    DISABLED = 0,
    #[doc = "1: Interrupt enabled"]
    ENABLED = 1,
}
impl From<IRC28MSTBIE_A> for bool {
    #[inline(always)]
    fn from(variant: IRC28MSTBIE_A) -> Self {
        variant as u8 != 0
    }
}
impl IRC28MSTBIE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> IRC28MSTBIE_A {
        match self.bits {
            false => IRC28MSTBIE_A::DISABLED,
            true => IRC28MSTBIE_A::ENABLED,
        }
    }
    #[doc = "Interrupt disabled"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == IRC28MSTBIE_A::DISABLED
    }
    #[doc = "Interrupt enabled"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == IRC28MSTBIE_A::ENABLED
    }
}
#[doc = "Field `IRC28MSTBIE` writer - IRC28M Stabilization Interrupt Enable"]
pub type IRC28MSTBIE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, IRC28MSTBIE_A>;
impl<'a, REG, const O: u8> IRC28MSTBIE_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Interrupt disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(IRC28MSTBIE_A::DISABLED)
    }
    #[doc = "Interrupt enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(IRC28MSTBIE_A::ENABLED)
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum IRC28MSTBICW_AW {
    #[doc = "1: Clear IRC28MSTBIF flag"]
    CLEAR = 1,
}
impl From<IRC28MSTBICW_AW> for bool {
    #[inline(always)]
    fn from(variant: IRC28MSTBICW_AW) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IRC28MSTBIC` writer - IRC28M stabilization Interrupt Clear"]
pub type IRC28MSTBIC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, IRC28MSTBICW_AW>;
impl<'a, REG, const O: u8> IRC28MSTBIC_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(IRC28MSTBICW_AW::CLEAR)
    }
}
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irc28mstbie(&mut self) -> IRC28MSTBIE_W<INT_SPEC, 13> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn irc28mstbic(&mut self) -> IRC28MSTBIC_W<INT_SPEC, 21> {
