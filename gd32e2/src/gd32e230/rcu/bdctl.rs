...
pub type BKPRST_W<'a> = crate::BitWriter<'a, u32, BDCTL_SPEC, bool, 16>;
#[doc = "Field `RTCEN` reader - RTC clock enable"]
pub type RTCEN_R = crate::BitReader<bool>;
#[doc = "Field `RTCEN` writer - RTC clock enable"]
pub type RTCEN_W<'a> = crate::BitWriter<'a, u32, BDCTL_SPEC, bool, 15>;
...
pub type RTCSRC_W<'a> = crate::FieldWriter<'a, u32, BDCTL_SPEC, u8, u8, 2, 8>;
#[doc = "Field `LXTALDRI` reader - LXTAL drive capability"]
pub type LXTALDRI_R = crate::FieldReader<u8, u8>;
#[doc = "Field `LXTALDRI` writer - LXTAL drive capability"]
pub type LXTALDRI_W<'a> = crate::FieldWriter<'a, u32, BDCTL_SPEC, u8, u8, 2, 3>;
...
pub type LXTALBPS_W<'a> = crate::BitWriter<'a, u32, BDCTL_SPEC, bool, 2>;
...
pub type LXTALEN_W<'a> = crate::BitWriter<'a, u32, BDCTL_SPEC, bool, 0>;
impl R {
