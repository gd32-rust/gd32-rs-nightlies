...
pub type CFGCMPRST_R = crate::BitReader<CFGCMPRST_A>;
#[doc = "System configuration and comparator reset\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum CFGCMPRST_A {
    #[doc = "1: Reset the selected module"]
    RESET = 1,
}
impl From<CFGCMPRST_A> for bool {
    #[inline(always)]
    fn from(variant: CFGCMPRST_A) -> Self {
        variant as u8 != 0
    }
}
impl CFGCMPRST_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> Option<CFGCMPRST_A> {
        match self.bits {
            true => Some(CFGCMPRST_A::RESET),
            _ => None,
        }
    }
    ...
    pub fn is_reset(&self) -> bool {
        *self == CFGCMPRST_A::RESET
    }
}
#[doc = "Field `CFGCMPRST` writer - System configuration and comparator reset"]
pub type CFGCMPRST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, CFGCMPRST_A>;
impl<'a, REG, const O: u8> CFGCMPRST_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cfgcmprst(&mut self) -> CFGCMPRST_W<APB2RST_SPEC, 0> {
