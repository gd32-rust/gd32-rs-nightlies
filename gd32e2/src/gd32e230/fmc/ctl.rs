...
pub type OBRLD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, OBRLD_A>;
impl<'a, REG, const O: u8> OBRLD_W<'a, REG, O>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Force option bytes reload and reset"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pg(&mut self) -> PG_W<CTL_SPEC, 0> {
        PG_W::new(self)
    }
    #[doc = "Bit 1 - Main flash page erase for bank0 command bit"]
    #[inline(always)]
    #[must_use]
    pub fn per(&mut self) -> PER_W<CTL_SPEC, 1> {
        PER_W::new(self)
    }
    #[doc = "Bit 2 - Main flash mass erase for bank0 command bit"]
    #[inline(always)]
    #[must_use]
    pub fn mer(&mut self) -> MER_W<CTL_SPEC, 2> {
        MER_W::new(self)
    }
    #[doc = "Bit 4 - Option bytes program command bit"]
    #[inline(always)]
    #[must_use]
    pub fn obpg(&mut self) -> OBPG_W<CTL_SPEC, 4> {
        OBPG_W::new(self)
    }
    #[doc = "Bit 5 - Option bytes erase command bit"]
    #[inline(always)]
    #[must_use]
    pub fn ober(&mut self) -> OBER_W<CTL_SPEC, 5> {
        OBER_W::new(self)
    }
    #[doc = "Bit 6 - Send erase command to FMC bit"]
    #[inline(always)]
    #[must_use]
    pub fn start(&mut self) -> START_W<CTL_SPEC, 6> {
        START_W::new(self)
    }
    #[doc = "Bit 7 - FMC_CTL lock bit"]
    #[inline(always)]
    #[must_use]
    pub fn lk(&mut self) -> LK_W<CTL_SPEC, 7> {
        LK_W::new(self)
    }
    #[doc = "Bit 9 - Option byte erase/program enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn obwen(&mut self) -> OBWEN_W<CTL_SPEC, 9> {
        OBWEN_W::new(self)
    }
    #[doc = "Bit 10 - Error interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn errie(&mut self) -> ERRIE_W<CTL_SPEC, 10> {
        ERRIE_W::new(self)
    }
    #[doc = "Bit 12 - End of operation interrupt enable bit"]
    #[inline(always)]
    #[must_use]
    pub fn endie(&mut self) -> ENDIE_W<CTL_SPEC, 12> {
        ENDIE_W::new(self)
    }
    #[doc = "Bit 13 - Option byte reload bit"]
    #[inline(always)]
    #[must_use]
    pub fn obrld(&mut self) -> OBRLD_W<CTL_SPEC, 13> {
        OBRLD_W::new(self)
    }
