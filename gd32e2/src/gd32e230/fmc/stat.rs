...
pub type ENDF_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, ENDF_AW, 5>;
impl<'a> ENDF_W<'a> {
    #[doc = "Clears flag"]
    #[inline(always)]
...
pub type WPERR_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, WPERR_AW, 4>;
impl<'a> WPERR_W<'a> {
    #[doc = "Clears flag"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
...
pub type PGAERR_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 3>;
...
pub type PGERR_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, PGERR_AW, 2>;
impl<'a> PGERR_W<'a> {
    #[doc = "Clears flag"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut W {
