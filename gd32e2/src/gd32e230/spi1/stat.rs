...
pub type FERR_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 8>;
...
pub type CRCERR_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, bool, 4>;
...
impl R {
    ...
    pub fn txlvl(&self) -> TXLVL_R {
        TXLVL_R::new(((self.bits >> 11) & 3) as u8)
    }
    #[doc = "Bits 9:10 - Rx FIFO level"]
    #[inline(always)]
    pub fn rxlvl(&self) -> RXLVL_R {
        RXLVL_R::new(((self.bits >> 9) & 3) as u8)
    }
